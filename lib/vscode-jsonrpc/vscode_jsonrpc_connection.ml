    ...
    module Types =
      struct
        ...
        and ('R, 'E) _HandlerResult =
          ('R, 'E ResponseError.t_1, 'R Promise.t,
            ('R, 'E ResponseError.t_1) union2 Promise.t,
            'E ResponseError.t_1 Promise.t) union5
            ...
            fun (__E_of_js : Ojs.t -> __E) ->
              fun (x33 : Ojs.t) ->
                union5_of_js __R_of_js
                  (fun (x35 : Ojs.t) -> ResponseError.t_1_of_js __E_of_js x35)
                     ...
                     Promise.t_of_js
                       (fun (x40 : Ojs.t) ->
                          union2_of_js __R_of_js
                            (fun (x42 : Ojs.t) ->
                               ResponseError.t_1_of_js __E_of_js x42) x40)
                       x39)
                  (fun (x44 : Ojs.t) ->
                     Promise.t_of_js
                       (fun (x45 : Ojs.t) ->
                          ResponseError.t_1_of_js __E_of_js x45) x44) x33
        and _HandlerResult_to_js :
          ...
          fun (__R_to_js : __R -> Ojs.t) ->
            fun (__E_to_js : __E -> Ojs.t) ->
              fun
                (x19 :
                  (__R, __E ResponseError.t_1, __R Promise.t,
                    (__R, __E ResponseError.t_1) union2 Promise.t,
                    __E ResponseError.t_1 Promise.t) union5)
                ->
                union5_to_js __R_to_js
                  (fun (x21 : __E ResponseError.t_1) ->
                     ResponseError.t_1_to_js __E_to_js x21)
                  (fun (x23 : __R Promise.t) -> Promise.t_to_js __R_to_js x23)
                  (fun (x25 : (__R, __E ResponseError.t_1) union2 Promise.t)
                     ->
                     Promise.t_to_js
                       (fun (x26 : (__R, __E ResponseError.t_1) union2) ->
                          union2_to_js __R_to_js
                            (fun (x28 : __E ResponseError.t_1) ->
                               ResponseError.t_1_to_js __E_to_js x28) x26)
                       x25)
                  (fun (x30 : __E ResponseError.t_1 Promise.t) ->
                     Promise.t_to_js
                       (fun (x31 : __E ResponseError.t_1) ->
                          ResponseError.t_1_to_js __E_to_js x31) x30) x19
      ...
      t ->
        method_:string ->
          params:(untyped_object, any) or_array or_undefined ->
            token:CancellationToken.t -> (any, any) _HandlerResult)
      =
      fun (x123 : t) ->
        fun ~method_:(x117 : string) ->
          fun ~params:(x118 : (untyped_object, any) or_array or_undefined) ->
            fun ~token:(x122 : CancellationToken.t) ->
                   ...
                   [|(Ojs.string_to_js x117);(or_undefined_to_js
                                                (fun
                                                   ...
                                                   or_array_to_js
                                                     ...
                                                     any_to_js x119) x118);(
                     CancellationToken.t_to_js x122)|])
  end
...
module RequestHandler0 =
  struct
    ...
    let (apply :
      ('R, 'E) t -> token:CancellationToken.t -> ('R, 'E) _HandlerResult) =
      fun (x147 : ('R, 'E) t) ->
        fun ~token:(x146 : CancellationToken.t) ->
          _HandlerResult_of_js Obj.magic Obj.magic
            (Ojs.apply (t_to_js Obj.magic Obj.magic x147)
               [|(CancellationToken.t_to_js x146)|])
  end
module RequestHandler =
  struct
    ...
    let (apply :
      ('P, 'R, 'E) t ->
        params:'P -> token:CancellationToken.t -> ('R, 'E) _HandlerResult)
      =
      fun (x162 : ('P, 'R, 'E) t) ->
        fun ~params:(x160 : 'P) ->
          fun ~token:(x161 : CancellationToken.t) ->
            _HandlerResult_of_js Obj.magic Obj.magic
              (Ojs.apply (t_to_js Obj.magic Obj.magic Obj.magic x162)
                 [|(Obj.magic x160);(CancellationToken.t_to_js x161)|])
  end
module RequestHandler1 =
  struct
    ...
    let (apply :
      ('P1, 'R, 'E) t ->
        p1:'P1 -> token:CancellationToken.t -> ('R, 'E) _HandlerResult)
      =
      fun (x178 : ('P1, 'R, 'E) t) ->
        fun ~p1:(x176 : 'P1) ->
          fun ~token:(x177 : CancellationToken.t) ->
            _HandlerResult_of_js Obj.magic Obj.magic
              (Ojs.apply (t_to_js Obj.magic Obj.magic Obj.magic x178)
                 [|(Obj.magic x176);(CancellationToken.t_to_js x177)|])
  end
module RequestHandler2 =
  struct
    ...
    let (apply :
      ('P1, 'P2, 'R, 'E) t ->
        p1:'P1 ->
          p2:'P2 -> token:CancellationToken.t -> ('R, 'E) _HandlerResult)
      =
      fun (x197 : ('P1, 'P2, 'R, 'E) t) ->
        fun ~p1:(x194 : 'P1) ->
          fun ~p2:(x195 : 'P2) ->
            fun ~token:(x196 : CancellationToken.t) ->
              _HandlerResult_of_js Obj.magic Obj.magic
                (Ojs.apply
                   (t_to_js Obj.magic Obj.magic Obj.magic Obj.magic x197)
                   [|(Obj.magic x194);(Obj.magic x195);(CancellationToken.t_to_js
                                                          x196)|])
  end
  ...
  struct
    ...
    let (apply :
      ('P1, 'P2, 'P3, 'R, 'E) t ->
        p1:'P1 ->
          p2:'P2 ->
            p3:'P3 -> token:CancellationToken.t -> ('R, 'E) _HandlerResult)
      =
      fun (x220 : ('P1, 'P2, 'P3, 'R, 'E) t) ->
        fun ~p1:(x216 : 'P1) ->
          fun ~p2:(x217 : 'P2) ->
            fun ~p3:(x218 : 'P3) ->
              fun ~token:(x219 : CancellationToken.t) ->
                _HandlerResult_of_js Obj.magic Obj.magic
                  (Ojs.apply
                     (t_to_js Obj.magic Obj.magic Obj.magic Obj.magic
                        Obj.magic x220)
                     [|(Obj.magic x216);(Obj.magic x217);(Obj.magic x218);(
                       CancellationToken.t_to_js x219)|])
  end
    ...
    let (apply :
      ('P1, 'P2, 'P3, 'P4, 'R, 'E) t ->
        p1:'P1 ->
          p2:'P2 ->
            p3:'P3 ->
              p4:'P4 -> token:CancellationToken.t -> ('R, 'E) _HandlerResult)
      =
      fun (x247 : ('P1, 'P2, 'P3, 'P4, 'R, 'E) t) ->
        fun ~p1:(x242 : 'P1) ->
          fun ~p2:(x243 : 'P2) ->
            fun ~p3:(x244 : 'P3) ->
              fun ~p4:(x245 : 'P4) ->
                fun ~token:(x246 : CancellationToken.t) ->
                  _HandlerResult_of_js Obj.magic Obj.magic
                    (Ojs.apply
                       (t_to_js Obj.magic Obj.magic Obj.magic Obj.magic
                          Obj.magic Obj.magic x247)
                       [|(Obj.magic x242);(Obj.magic x243);(Obj.magic x244);(
                         Obj.magic x245);(CancellationToken.t_to_js x246)|])
  end
        ...
        p1:'P1 ->
          p2:'P2 ->
            p3:'P3 ->
              p4:'P4 ->
                p5:'P5 ->
                  token:CancellationToken.t -> ('R, 'E) _HandlerResult)
      =
        ...
        fun ~p1:(x272 : 'P1) ->
          fun ~p2:(x273 : 'P2) ->
            fun ~p3:(x274 : 'P3) ->
              fun ~p4:(x275 : 'P4) ->
                fun ~p5:(x276 : 'P5) ->
                  fun ~token:(x277 : CancellationToken.t) ->
                    _HandlerResult_of_js Obj.magic Obj.magic
                      (Ojs.apply
                         (t_to_js Obj.magic Obj.magic Obj.magic Obj.magic
                            Obj.magic Obj.magic Obj.magic x278)
                         [|(Obj.magic x272);(Obj.magic x273);(Obj.magic x274);(
                           Obj.magic x275);(Obj.magic x276);(CancellationToken.t_to_js
                                                               x277)|])
  end
          ...
          fun ~p2:(x307 : 'P2) ->
            fun ~p3:(x308 : 'P3) ->
              fun ~p4:(x309 : 'P4) ->
                fun ~p5:(x310 : 'P5) ->
                  fun ~p6:(x311 : 'P6) ->
                    fun ~token:(x312 : CancellationToken.t) ->
                      _HandlerResult_of_js Obj.magic Obj.magic
                        (Ojs.apply
                           (t_to_js Obj.magic Obj.magic Obj.magic Obj.magic
                           ...
                           [|(Obj.magic x306);(Obj.magic x307);(Obj.magic
                             ...
                             CancellationToken.t_to_js x312)|])
  end
            ...
            fun ~p3:(x346 : 'P3) ->
              fun ~p4:(x347 : 'P4) ->
                fun ~p5:(x348 : 'P5) ->
                  fun ~p6:(x349 : 'P6) ->
                    fun ~p7:(x350 : 'P7) ->
                      fun ~token:(x351 : CancellationToken.t) ->
                        _HandlerResult_of_js Obj.magic Obj.magic
                          (Ojs.apply
                             (t_to_js Obj.magic Obj.magic Obj.magic Obj.magic
                             ...
                             [|(Obj.magic x344);(Obj.magic x345);(Obj.magic
                               ...
                               Obj.magic x347);(Obj.magic x348);(Obj.magic
                                                                   x349);(
                               Obj.magic x350);(CancellationToken.t_to_js
                                                  x351)|])
  end
              ...
              fun ~p4:(x389 : 'P4) ->
                fun ~p5:(x390 : 'P5) ->
                  fun ~p6:(x391 : 'P6) ->
                    fun ~p7:(x392 : 'P7) ->
                      fun ~p8:(x393 : 'P8) ->
                        fun ~token:(x394 : CancellationToken.t) ->
                          _HandlerResult_of_js Obj.magic Obj.magic
                            (Ojs.apply
                               ...
                               [|(Obj.magic x386);(Obj.magic x387);(Obj.magic
                                 ...
                                 Obj.magic x389);(Obj.magic x390);(Obj.magic
                                                                    x391);(
                                 Obj.magic x392);(Obj.magic x393);(CancellationToken.t_to_js
                                                                    x394)|])
  end
                ...
                fun ~p5:(x436 : 'P5) ->
                  fun ~p6:(x437 : 'P6) ->
                    fun ~p7:(x438 : 'P7) ->
                      fun ~p8:(x439 : 'P8) ->
                        fun ~p9:(x440 : 'P9) ->
                          fun ~token:(x441 : CancellationToken.t) ->
                            _HandlerResult_of_js Obj.magic Obj.magic
                              (Ojs.apply
                                 (t_to_js Obj.magic Obj.magic Obj.magic
                                    Obj.magic Obj.magic Obj.magic Obj.magic
                                 ...
                                 [|(Obj.magic x432);(Obj.magic x433);(
                                   ...
                                   Obj.magic x440);(CancellationToken.t_to_js
                                                      x441)|])
  end
...
module TraceValues =
  struct
    type t = _TraceValues
    let rec t_of_js : Ojs.t -> t =
      fun (x700 : Ojs.t) -> _TraceValues_of_js x700
    and t_to_js : t -> Ojs.t =
      fun (x699 : _TraceValues) -> _TraceValues_to_js x699
  end
module Trace =
  struct
...
module SetTraceNotification =
  struct
    let (type_ : _SetTraceParams NotificationType.t_1) =
      NotificationType.t_1_of_js _SetTraceParams_of_js
        (Ojs.get_prop_ascii
...
module LogTraceNotification =
  struct
    let (type_ : _LogTraceParams NotificationType.t_1) =
      NotificationType.t_1_of_js _LogTraceParams_of_js
        (Ojs.get_prop_ascii
...
module CancellationReceiverStrategy =
  struct
    ...
    let (createCancellationTokenSource :
      t -> id:_CancellationId -> AbstractCancellationTokenSource.t) =
      fun (x755 : t) ->
        fun ~id:(x754 : _CancellationId) ->
          AbstractCancellationTokenSource.t_of_js
...
module MessageConnection =
  struct
    ...
    let (sendRequest :
      ...
      =
      fun (x793 : t) ->
        fun ~type_:(x787 : ('R, 'E) RequestType0.t_2) ->
          fun ?token:(x788 : CancellationToken.t option) ->
            fun () ->
                   ...
                   [|x794;((let x789 =
                            ...
                            (match x788 with
                             | Some x790 ->
                                 ignore
                                   (Ojs.call x789 "push"
                                      [|(CancellationToken.t_to_js x790)|])
                             | None -> ());
                            x789))|])
    let (sendRequest' :
      t ->
      ...
      =
      fun (x804 : t) ->
        fun ~type_:(x796 : ('P, 'R, 'E) RequestType.t_3) ->
          fun ~params:(x797 : 'P) ->
            fun ?token:(x798 : CancellationToken.t option) ->
              fun () ->
                Promise.t_of_js Obj.magic
                     ...
                     [|x805;((let x799 =
                              ...
                              (match x798 with
                               | Some x800 ->
                                   ignore
                                     (Ojs.call x799 "push"
                                        [|(CancellationToken.t_to_js x800)|])
                               | None -> ());
                              x799))|])
    let (sendRequest'' :
      t ->
        type_:('P1, 'R, 'E) RequestType1.t_3 ->
          p1:'P1 -> ?token:CancellationToken.t -> unit -> 'R Promise.t)
      =
      fun (x815 : t) ->
        fun ~type_:(x807 : ('P1, 'R, 'E) RequestType1.t_3) ->
          fun ~p1:(x808 : 'P1) ->
            fun ?token:(x809 : CancellationToken.t option) ->
              fun () ->
                Promise.t_of_js Obj.magic
                  (let x816 = t_to_js x815 in
                   Ojs.call (Ojs.get_prop_ascii x816 "sendRequest") "apply"
                     [|x816;((let x810 =
                              ...
                              ignore
                                (Ojs.call x810 "push"
                                   [|(RequestType1.t_3_to_js Obj.magic
                              ...
                              (match x809 with
                               | Some x811 ->
                                   ignore
                                     (Ojs.call x810 "push"
                                        [|(CancellationToken.t_to_js x811)|])
                               | None -> ());
                              x810))|])
    let (sendRequest''' :
      t ->
        type_:('P1, 'P2, 'R, 'E) RequestType2.t_4 ->
          p1:'P1 ->
            p2:'P2 -> ?token:CancellationToken.t -> unit -> 'R Promise.t)
      =
      fun (x828 : t) ->
        fun ~type_:(x818 : ('P1, 'P2, 'R, 'E) RequestType2.t_4) ->
          fun ~p1:(x819 : 'P1) ->
            fun ~p2:(x820 : 'P2) ->
              fun ?token:(x821 : CancellationToken.t option) ->
                fun () ->
                  Promise.t_of_js Obj.magic
                    (let x829 = t_to_js x828 in
                     Ojs.call (Ojs.get_prop_ascii x829 "sendRequest") "apply"
                       [|x829;((let x822 =
                                ...
                                ignore
                                  (Ojs.call x822 "push"
                                     [|(RequestType2.t_4_to_js Obj.magic
                                ...
                                (match x821 with
                                 | Some x823 ->
                                     ignore
                                       (Ojs.call x822 "push"
                                          [|(CancellationToken.t_to_js x823)|])
                                 | None -> ());
                                x822))|])
    let (sendRequest'''' :
      t ->
        type_:('P1, 'P2, 'P3, 'R, 'E) RequestType3.t_5 ->
          p1:'P1 ->
            p2:'P2 ->
              p3:'P3 -> ?token:CancellationToken.t -> unit -> 'R Promise.t)
      =
      fun (x843 : t) ->
        fun ~type_:(x831 : ('P1, 'P2, 'P3, 'R, 'E) RequestType3.t_5) ->
          fun ~p1:(x832 : 'P1) ->
            fun ~p2:(x833 : 'P2) ->
              fun ~p3:(x834 : 'P3) ->
                fun ?token:(x835 : CancellationToken.t option) ->
                  fun () ->
                    Promise.t_of_js Obj.magic
                      (let x844 = t_to_js x843 in
                       Ojs.call (Ojs.get_prop_ascii x844 "sendRequest")
                         ...
                         [|x844;((let x836 =
                                  ...
                                  ignore
                                    (Ojs.call x836 "push"
                                       [|(RequestType3.t_5_to_js Obj.magic
                                  ...
                                  (match x835 with
                                   | Some x837 ->
                                       ignore
                                         (Ojs.call x836 "push"
                                            [|(CancellationToken.t_to_js x837)|])
                                   | None -> ());
                                  x836))|])
    let (sendRequest''''' :
      t ->
        type_:('P1, 'P2, 'P3, 'P4, 'R, 'E) RequestType4.t_6 ->
          p1:'P1 ->
            p2:'P2 ->
              p3:'P3 ->
                p4:'P4 -> ?token:CancellationToken.t -> unit -> 'R Promise.t)
      =
      fun (x860 : t) ->
        fun ~type_:(x846 : ('P1, 'P2, 'P3, 'P4, 'R, 'E) RequestType4.t_6) ->
          fun ~p1:(x847 : 'P1) ->
            fun ~p2:(x848 : 'P2) ->
              fun ~p3:(x849 : 'P3) ->
                fun ~p4:(x850 : 'P4) ->
                  fun ?token:(x851 : CancellationToken.t option) ->
                    fun () ->
                      Promise.t_of_js Obj.magic
                        (let x861 = t_to_js x860 in
                         Ojs.call (Ojs.get_prop_ascii x861 "sendRequest")
                           ...
                           [|x861;((let x852 =
                                    ...
                                    ignore
                                      (Ojs.call x852 "push"
                                         [|(RequestType4.t_6_to_js Obj.magic
                                              Obj.magic Obj.magic Obj.magic
    ...
    let (sendRequest'''''' :
      ...
      fun (x879 : t) ->
        fun
          ~type_:(x863 : ('P1, 'P2, 'P3, 'P4, 'P5, 'R, 'E) RequestType5.t_7)
          ->
          fun ~p1:(x864 : 'P1) ->
            fun ~p2:(x865 : 'P2) ->
              fun ~p3:(x866 : 'P3) ->
                fun ~p4:(x867 : 'P4) ->
                  fun ~p5:(x868 : 'P5) ->
                    fun ?token:(x869 : CancellationToken.t option) ->
                      fun () ->
                        Promise.t_of_js Obj.magic
    ...
    let (sendRequest''''''' :
      ...
      fun (x900 : t) ->
        fun
          ~type_:(x882 :
                   ('P1, 'P2, 'P3, 'P4, 'P5, 'P6, 'R, 'E) RequestType6.t_8)
          ->
          fun ~p1:(x883 : 'P1) ->
            fun ~p2:(x884 : 'P2) ->
              fun ~p3:(x885 : 'P3) ->
                fun ~p4:(x886 : 'P4) ->
                  fun ~p5:(x887 : 'P5) ->
                    fun ~p6:(x888 : 'P6) ->
                      fun ?token:(x889 : CancellationToken.t option) ->
                        fun () ->
                          Promise.t_of_js Obj.magic
              ...
              fun ~p3:(x906 : 'P3) ->
                fun ~p4:(x907 : 'P4) ->
                  fun ~p5:(x908 : 'P5) ->
                    fun ~p6:(x909 : 'P6) ->
                      fun ~p7:(x910 : 'P7) ->
                        fun ?token:(x911 : CancellationToken.t option) ->
                          fun () ->
                            Promise.t_of_js Obj.magic
    ...
    let (sendRequest''''''''' :
      t ->
        type_:('P1, 'P2, 'P3, 'P4, 'P5, 'P6, 'P7, 'P8, 'R, 'E)
          RequestType8.t_10 ->
          p1:'P1 ->
            p2:'P2 ->
              p3:'P3 ->
                ...
                fun ~p4:(x930 : 'P4) ->
                  fun ~p5:(x931 : 'P5) ->
                    fun ~p6:(x932 : 'P6) ->
                      fun ~p7:(x933 : 'P7) ->
                        fun ~p8:(x934 : 'P8) ->
                          fun ?token:(x935 : CancellationToken.t option) ->
                            fun () ->
                              Promise.t_of_js Obj.magic
                  ...
                  fun ~p5:(x956 : 'P5) ->
                    fun ~p6:(x957 : 'P6) ->
                      fun ~p7:(x958 : 'P7) ->
                        fun ~p8:(x959 : 'P8) ->
                          fun ~p9:(x960 : 'P9) ->
                            fun ?token:(x961 : CancellationToken.t option) ->
                              fun () ->
                                Promise.t_of_js Obj.magic
    ...
    let (onRequest :
      t ->
        type_:('R, 'E) RequestType0.t_2 ->
          handler:('R, 'E) _RequestHandler0 -> Disposable.t)
      =
      fun (x995 : t) ->
        fun ~type_:(x989 : ('R, 'E) RequestType0.t_2) ->
          fun ~handler:(x992 : ('R, 'E) _RequestHandler0) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x995) "onRequest"
                 [|(RequestType0.t_2_to_js Obj.magic Obj.magic x989);(
                   _RequestHandler0_to_js Obj.magic Obj.magic x992)|])
    let (onRequest' :
      t ->
        type_:('P, 'R, 'E) RequestType.t_3 ->
          handler:('P, 'R, 'E) _RequestHandler -> Disposable.t)
      =
      fun (x1004 : t) ->
        fun ~type_:(x996 : ('P, 'R, 'E) RequestType.t_3) ->
          fun ~handler:(x1000 : ('P, 'R, 'E) _RequestHandler) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1004) "onRequest"
                 [|(RequestType.t_3_to_js Obj.magic Obj.magic Obj.magic x996);(
                   _RequestHandler_to_js Obj.magic Obj.magic Obj.magic x1000)|])
    let (onRequest'' :
      t ->
        type_:('P1, 'R, 'E) RequestType1.t_3 ->
          handler:('P1, 'R, 'E) _RequestHandler1 -> Disposable.t)
      =
      fun (x1013 : t) ->
        fun ~type_:(x1005 : ('P1, 'R, 'E) RequestType1.t_3) ->
          fun ~handler:(x1009 : ('P1, 'R, 'E) _RequestHandler1) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1013) "onRequest"
                 [|(RequestType1.t_3_to_js Obj.magic Obj.magic Obj.magic
                      x1005);(_RequestHandler1_to_js Obj.magic Obj.magic
                                Obj.magic x1009)|])
    let (onRequest''' :
      t ->
        type_:('P1, 'P2, 'R, 'E) RequestType2.t_4 ->
          handler:('P1, 'P2, 'R, 'E) _RequestHandler2 -> Disposable.t)
      =
      fun (x1024 : t) ->
        fun ~type_:(x1014 : ('P1, 'P2, 'R, 'E) RequestType2.t_4) ->
          fun ~handler:(x1019 : ('P1, 'P2, 'R, 'E) _RequestHandler2) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1024) "onRequest"
                 [|(RequestType2.t_4_to_js Obj.magic Obj.magic Obj.magic
                      Obj.magic x1014);(_RequestHandler2_to_js Obj.magic
                                          Obj.magic Obj.magic Obj.magic x1019)|])
    let (onRequest'''' :
      t ->
        type_:('P1, 'P2, 'P3, 'R, 'E) RequestType3.t_5 ->
          handler:('P1, 'P2, 'P3, 'R, 'E) _RequestHandler3 -> Disposable.t)
      =
      fun (x1037 : t) ->
        fun ~type_:(x1025 : ('P1, 'P2, 'P3, 'R, 'E) RequestType3.t_5) ->
          fun ~handler:(x1031 : ('P1, 'P2, 'P3, 'R, 'E) _RequestHandler3) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1037) "onRequest"
                 [|(RequestType3.t_5_to_js Obj.magic Obj.magic Obj.magic
    ...
    let (onRequest''''' :
      ...
      =
      fun (x1052 : t) ->
        fun ~type_:(x1038 : ('P1, 'P2, 'P3, 'P4, 'R, 'E) RequestType4.t_6) ->
          fun
            ~handler:(x1045 : ('P1, 'P2, 'P3, 'P4, 'R, 'E) _RequestHandler4)
            ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1052) "onRequest"
                 [|(RequestType4.t_6_to_js Obj.magic Obj.magic Obj.magic
    ...
    let (onRequest'''''' :
      ...
      fun (x1069 : t) ->
        fun
          ~type_:(x1053 : ('P1, 'P2, 'P3, 'P4, 'P5, 'R, 'E) RequestType5.t_7)
          ->
          fun
            ~handler:(x1061 :
                       ('P1, 'P2, 'P3, 'P4, 'P5, 'R, 'E) _RequestHandler5)
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1069) "onRequest"
                 [|(RequestType5.t_7_to_js Obj.magic Obj.magic Obj.magic
          ...
          fun
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1088) "onRequest"
                 [|(RequestType6.t_8_to_js Obj.magic Obj.magic Obj.magic
          ...
          fun
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1109) "onRequest"
                 [|(RequestType7.t_9_to_js Obj.magic Obj.magic Obj.magic
          ...
          fun
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1132) "onRequest"
                 [|(RequestType8.t_10_to_js Obj.magic Obj.magic Obj.magic
                      Obj.magic Obj.magic Obj.magic Obj.magic Obj.magic
          ...
          fun
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1157) "onRequest"
                 [|(RequestType9.t_11_to_js Obj.magic Obj.magic Obj.magic
                      Obj.magic Obj.magic Obj.magic Obj.magic Obj.magic
    ...
    let (onRequest''''''''''' :
      t ->
        method_:string ->
          handler:('R, 'E) _GenericRequestHandler -> Disposable.t)
      =
      fun (x1162 : t) ->
    ...
    let (onRequest'''''''''''' :
      t -> handler:_StarRequestHandler -> Disposable.t) =
      fun (x1164 : t) ->
    ...
    let (sendNotification' :
      ...
      fun (x1172 : t) ->
        fun ~type_:(x1167 : 'P NotificationType.t_1) ->
                ...
                (let x1173 = t_to_js x1172 in
                 Ojs.call (Ojs.get_prop_ascii x1173 "sendNotification")
                   ...
                   [|x1173;((let x1169 =
                             ...
                             x1169))|])
    let (sendNotification'' :
      t -> type_:'P1 NotificationType1.t_1 -> p1:'P1 -> unit) =
      fun (x1177 : t) ->
        fun ~type_:(x1174 : 'P1 NotificationType1.t_1) ->
          fun ~p1:(x1176 : 'P1) ->
            ignore
              (Ojs.call (t_to_js x1177) "sendNotification"
                 [|(NotificationType1.t_1_to_js Obj.magic x1174);(Obj.magic
                                                                    x1176)|])
    let (sendNotification''' :
      t -> type_:('P1, 'P2) NotificationType2.t_2 -> p1:'P1 -> p2:'P2 -> unit)
      =
      fun (x1183 : t) ->
        fun ~type_:(x1178 : ('P1, 'P2) NotificationType2.t_2) ->
          fun ~p1:(x1181 : 'P1) ->
            fun ~p2:(x1182 : 'P2) ->
              ignore
                (Ojs.call (t_to_js x1183) "sendNotification"
                   [|(NotificationType2.t_2_to_js Obj.magic Obj.magic x1178);(
    ...
    let (sendNotification'''' :
      ...
      =
      fun (x1191 : t) ->
        fun ~type_:(x1184 : ('P1, 'P2, 'P3) NotificationType3.t_3) ->
          fun ~p1:(x1188 : 'P1) ->
            fun ~p2:(x1189 : 'P2) ->
              fun ~p3:(x1190 : 'P3) ->
                ignore
                  (Ojs.call (t_to_js x1191) "sendNotification"
                     [|(NotificationType3.t_3_to_js Obj.magic Obj.magic
    ...
    let (sendNotification''''' :
      ...
      =
      fun (x1201 : t) ->
        fun ~type_:(x1192 : ('P1, 'P2, 'P3, 'P4) NotificationType4.t_4) ->
          fun ~p1:(x1197 : 'P1) ->
            fun ~p2:(x1198 : 'P2) ->
              fun ~p3:(x1199 : 'P3) ->
                fun ~p4:(x1200 : 'P4) ->
                  ignore
                    (Ojs.call (t_to_js x1201) "sendNotification"
                       [|(NotificationType4.t_4_to_js Obj.magic Obj.magic
    ...
    let (sendNotification'''''' :
      ...
      =
      fun (x1213 : t) ->
        fun ~type_:(x1202 : ('P1, 'P2, 'P3, 'P4, 'P5) NotificationType5.t_5)
          ->
          fun ~p1:(x1208 : 'P1) ->
            fun ~p2:(x1209 : 'P2) ->
              fun ~p3:(x1210 : 'P3) ->
                  ...
                  fun ~p5:(x1212 : 'P5) ->
                    ignore
                      (Ojs.call (t_to_js x1213) "sendNotification"
                         [|(NotificationType5.t_5_to_js Obj.magic Obj.magic
    ...
    let (sendNotification''''''' :
      ...
      fun (x1227 : t) ->
        fun
          ~type_:(x1214 :
                   ('P1, 'P2, 'P3, 'P4, 'P5, 'P6) NotificationType6.t_6)
          ->
          fun ~p1:(x1221 : 'P1) ->
            fun ~p2:(x1222 : 'P2) ->
              fun ~p3:(x1223 : 'P3) ->
                    ...
                    fun ~p6:(x1226 : 'P6) ->
                      ignore
                        (Ojs.call (t_to_js x1227) "sendNotification"
                           [|(NotificationType6.t_6_to_js Obj.magic Obj.magic
    ...
    let (sendNotification'''''''' :
      ...
      fun (x1243 : t) ->
        fun
          ~type_:(x1228 :
                   ('P1, 'P2, 'P3, 'P4, 'P5, 'P6, 'P7) NotificationType7.t_7)
          ->
          fun ~p1:(x1236 : 'P1) ->
            fun ~p2:(x1237 : 'P2) ->
              fun ~p3:(x1238 : 'P3) ->
                      ...
                      fun ~p7:(x1242 : 'P7) ->
                        ignore
                          (Ojs.call (t_to_js x1243) "sendNotification"
                             [|(NotificationType7.t_7_to_js Obj.magic
                                  Obj.magic Obj.magic Obj.magic Obj.magic
                                  Obj.magic Obj.magic x1228);(Obj.magic x1236);(
                        ...
                        fun ~p8:(x1260 : 'P8) ->
                          ignore
                            (Ojs.call (t_to_js x1261) "sendNotification"
                               [|(NotificationType8.t_8_to_js Obj.magic
                                    Obj.magic Obj.magic Obj.magic Obj.magic
                          ...
                          fun ~p9:(x1280 : 'P9) ->
                            ignore
                              (Ojs.call (t_to_js x1281) "sendNotification"
                                 [|(NotificationType9.t_9_to_js Obj.magic
                                      Obj.magic Obj.magic Obj.magic Obj.magic
                                      Obj.magic Obj.magic Obj.magic Obj.magic
    ...
    let (onNotification :
      t ->
        type_:NotificationType0.t ->
          handler:_NotificationHandler0 -> Disposable.t)
      =
      fun (x1294 : t) ->
    ...
    let (onNotification' :
      t ->
        type_:'P NotificationType.t_1 ->
          handler:'P _NotificationHandler -> Disposable.t)
      =
      fun (x1299 : t) ->
        fun ~type_:(x1295 : 'P NotificationType.t_1) ->
          fun ~handler:(x1297 : 'P _NotificationHandler) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1299) "onNotification"
                 [|(NotificationType.t_1_to_js Obj.magic x1295);(_NotificationHandler_to_js
                                                                   Obj.magic
                                                                   x1297)|])
    let (onNotification'' :
      t ->
        type_:'P1 NotificationType1.t_1 ->
          handler:'P1 _NotificationHandler1 -> Disposable.t)
      =
      fun (x1304 : t) ->
        fun ~type_:(x1300 : 'P1 NotificationType1.t_1) ->
          fun ~handler:(x1302 : 'P1 _NotificationHandler1) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1304) "onNotification"
                 [|(NotificationType1.t_1_to_js Obj.magic x1300);(_NotificationHandler1_to_js
                                                                    Obj.magic
                                                                    x1302)|])
    let (onNotification''' :
      t ->
        type_:('P1, 'P2) NotificationType2.t_2 ->
          handler:('P1, 'P2) _NotificationHandler2 -> Disposable.t)
      =
      fun (x1311 : t) ->
        fun ~type_:(x1305 : ('P1, 'P2) NotificationType2.t_2) ->
          fun ~handler:(x1308 : ('P1, 'P2) _NotificationHandler2) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1311) "onNotification"
                 [|(NotificationType2.t_2_to_js Obj.magic Obj.magic x1305);(
                   _NotificationHandler2_to_js Obj.magic Obj.magic x1308)|])
    let (onNotification'''' :
      t ->
        type_:('P1, 'P2, 'P3) NotificationType3.t_3 ->
          handler:('P1, 'P2, 'P3) _NotificationHandler3 -> Disposable.t)
      =
      fun (x1320 : t) ->
        fun ~type_:(x1312 : ('P1, 'P2, 'P3) NotificationType3.t_3) ->
          fun ~handler:(x1316 : ('P1, 'P2, 'P3) _NotificationHandler3) ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1320) "onNotification"
                 [|(NotificationType3.t_3_to_js Obj.magic Obj.magic Obj.magic
                      x1312);(_NotificationHandler3_to_js Obj.magic Obj.magic
                                Obj.magic x1316)|])
    let (onNotification''''' :
      t ->
        type_:('P1, 'P2, 'P3, 'P4) NotificationType4.t_4 ->
          handler:('P1, 'P2, 'P3, 'P4) _NotificationHandler4 -> Disposable.t)
      =
      fun (x1331 : t) ->
        fun ~type_:(x1321 : ('P1, 'P2, 'P3, 'P4) NotificationType4.t_4) ->
          fun ~handler:(x1326 : ('P1, 'P2, 'P3, 'P4) _NotificationHandler4)
            ->
            Disposable.t_of_js
              (Ojs.call (t_to_js x1331) "onNotification"
                 [|(NotificationType4.t_4_to_js Obj.magic Obj.magic Obj.magic
    ...
    let (onNotification'''''' :
      ...
      =
      fun (x1344 : t) ->
        fun ~type_:(x1332 : ('P1, 'P2, 'P3, 'P4, 'P5) NotificationType5.t_5)
          ->
          fun
            ~handler:(x1338 :
                       ('P1, 'P2, 'P3, 'P4, 'P5) _NotificationHandler5)
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1344) "onNotification"
                 [|(NotificationType5.t_5_to_js Obj.magic Obj.magic Obj.magic
          ...
          fun
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1359) "onNotification"
                 [|(NotificationType6.t_6_to_js Obj.magic Obj.magic Obj.magic
          ...
          fun
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1376) "onNotification"
                 [|(NotificationType7.t_7_to_js Obj.magic Obj.magic Obj.magic
      ...
      t ->
        type_:('P1, 'P2, 'P3, 'P4, 'P5, 'P6, 'P7, 'P8) NotificationType8.t_8
          ...
          handler:('P1, 'P2, 'P3, 'P4, 'P5, 'P6, 'P7, 'P8)
            _NotificationHandler8 -> Disposable.t)
      =
      fun (x1395 : t) ->
        fun
          ~type_:(x1377 :
          ...
          fun
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1395) "onNotification"
                 [|(NotificationType8.t_8_to_js Obj.magic Obj.magic Obj.magic
      ...
      t ->
        type_:('P1, 'P2, 'P3, 'P4, 'P5, 'P6, 'P7, 'P8, 'P9)
          ...
          handler:('P1, 'P2, 'P3, 'P4, 'P5, 'P6, 'P7, 'P8, 'P9)
            _NotificationHandler9 -> Disposable.t)
      =
      fun (x1416 : t) ->
        fun
          ~type_:(x1396 :
          ...
          fun
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1416) "onNotification"
                 [|(NotificationType9.t_9_to_js Obj.magic Obj.magic Obj.magic
                      Obj.magic Obj.magic Obj.magic Obj.magic Obj.magic
    ...
    let (onNotification''''''''''' :
      t ->
        method_:string -> handler:_GenericNotificationHandler -> Disposable.t)
      =
      fun (x1419 : t) ->
            ...
            Disposable.t_of_js
              (Ojs.call (t_to_js x1419) "onNotification"
                 [|(Ojs.string_to_js x1417);(_GenericNotificationHandler_to_js
                                               x1418)|])
    let (onNotification'''''''''''' :
      t -> handler:_StarNotificationHandler -> Disposable.t) =
      fun (x1421 : t) ->
    ...
    let (set_onUnhandledNotification :
      ...
      fun (x1424 : t) ->
        fun (x1425 : NotificationMessage.t Event.t_1) ->
          Ojs.set_prop_ascii (t_to_js x1424) "onUnhandledNotification"
            (Event.t_1_to_js NotificationMessage.t_to_js x1425)
    let (onProgress :
      t ->
              ...
              ignore
                (Ojs.call (t_to_js x1439) "sendProgress"
                   [|(_ProgressType_to_js Obj.magic x1434);(or_number_to_js
                                                              ...
                                                              x1436);(
                     Obj.magic x1438)|])
    let (get_onUnhandledProgress : t -> any _ProgressParams Event.t_1) =
      fun (x1440 : t) ->
        Event.t_1_of_js
    ...
    let (set_onUnhandledProgress :
      t -> any _ProgressParams Event.t_1 -> unit) =
      fun (x1443 : t) ->
        fun (x1444 : any _ProgressParams Event.t_1) ->
    ...
    let (set_onClose : t -> unit Event.t_1 -> unit) =
      fun (x1477 : t) ->
        fun (x1478 : unit Event.t_1) ->
          Ojs.set_prop_ascii (t_to_js x1477) "onClose"
            (Event.t_1_to_js Ojs.unit_to_js x1478)
    let (listen : t -> unit) =
    ...
    let (set_onDispose : t -> unit Event.t_1 -> unit) =
      fun (x1484 : t) ->
        fun (x1485 : unit Event.t_1) ->
          Ojs.set_prop_ascii (t_to_js x1484) "onDispose"
            (Event.t_1_to_js Ojs.unit_to_js x1485)
    let (dispose : t -> unit) =
...
let (createMessageConnection :
  ...
  =
  fun ~messageReader:(x1489 : MessageReader.t) ->
    fun ~messageWriter:(x1490 : MessageWriter.t) ->
              ...
              (let x1496 = Ojs.global in
               Ojs.call (Ojs.get_prop_ascii x1496 "createMessageConnection")
                 ...
                 [|x1496;((let x1493 =
                           ...
                           ignore
                             (Ojs.call x1493 "push"
                                [|(MessageReader.t_to_js x1489)|]);
                           ignore
                             (Ojs.call x1493 "push"
                                [|(MessageWriter.t_to_js x1490)|]);
                           (match x1491 with
                            | Some x1495 ->
                                ignore
                                  (Ojs.call x1493 "push"
