...
module Make (M: Missing) : sig
  ...
  module Internal : sig
    ...
    module Types : sig
      ...
      type ('K, 'V) _LRUCache = [`LRUCache of ('K * 'V) | `LinkedMap of ('K * 'V)] intf
      [@@js.custom { of_js=(fun _K _V -> Obj.magic); to_js=(fun _K _V -> Obj.magic) }]
      and ('K, 'V) _LinkedMap = [`LinkedMap of ('K * 'V)] intf
      [@@js.custom { of_js=(fun _K _V -> Obj.magic); to_js=(fun _K _V -> Obj.magic) }]
      and _Touch = ([`L_n_0[@js 0] | `L_n_1[@js 1] | `L_n_2[@js 2]] [@js.enum])
    end
  end
  ...
  module[@js.scope "LinkedMap"] LinkedMap : sig
    ...
    val get__Symbol_toStringTag_: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "[Symbol.toStringTag]"]
    val get__map: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "_map"]
    val set__map: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "_map"]
    val get__head: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "_head"]
    val set__head: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "_head"]
    val get__tail: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "_tail"]
    val set__tail: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "_tail"]
    val get__size: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "_size"]
    val set__size: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "_size"]
    val get__state: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "_state"]
    val set__state: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "_state"]
    ...
    val get_: ('K, 'V) t -> key:'K -> ?touch:_Touch -> unit -> 'V or_undefined [@@js.call "get"]
    val set_: ('K, 'V) t -> key:'K -> value:'V -> ?touch:_Touch -> unit -> ('K, 'V) t [@@js.call "set"]
    ...
    val entries: ('K, 'V) t -> ('K * 'V) IterableIterator.t_1 [@@js.call "entries"]
    val _Symbol_iterator_: ('K, 'V) t -> ('K * 'V) IterableIterator.t_1 [@@js.call "[Symbol.iterator]"]
    val trimOld: ('K, 'V) t -> newSize:float -> unit [@@js.call "trimOld"]
    val get_addItemFirst: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "addItemFirst"]
    val set_addItemFirst: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "addItemFirst"]
    val get_addItemLast: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "addItemLast"]
    val set_addItemLast: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "addItemLast"]
    val get_removeItem: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "removeItem"]
    val set_removeItem: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "removeItem"]
    val get_touch: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "touch"]
    val set_touch: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "touch"]
    val toJSON: ('K, 'V) t -> ('K * 'V) list [@@js.call "toJSON"]
    val fromJSON: ('K, 'V) t -> data:('K * 'V) list -> unit [@@js.call "fromJSON"]
    val cast: ('K, 'V) t -> ('K, 'V) Map.t_2 [@@js.cast]
  end
  module[@js.scope "LRUCache"] LRUCache : sig
    ...
    val t_2_to_js: ('K -> Ojs.t) -> ('V -> Ojs.t) -> ('K, 'V) t_2 -> Ojs.t
    val t_2_of_js: (Ojs.t -> 'K) -> (Ojs.t -> 'V) -> Ojs.t -> ('K, 'V) t_2
    val get__limit: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "_limit"]
    val set__limit: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "_limit"]
    val get__ratio: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "_ratio"]
    val set__ratio: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "_ratio"]
    ...
    val get_checkTrim: ('K, 'V) t -> (* FIXME: unknown type *)any [@@js.get "checkTrim"]
    val set_checkTrim: ('K, 'V) t -> (* FIXME: unknown type *)any -> unit [@@js.set "checkTrim"]
