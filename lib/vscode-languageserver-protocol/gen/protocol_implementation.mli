...
module Make (M: Missing) : sig
  ...
  module Internal : sig
    ...
    module Types : sig
      ...
      type _ImplementationClientCapabilities = [`ImplementationClientCapabilities] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _ImplementationOptions = [`ImplementationOptions] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _ImplementationParams = [`ImplementationParams] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _ImplementationRegistrationOptions = [`ImplementationRegistrationOptions | `ImplementationOptions] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _ImplementationRequest_HandlerSignature = (_ImplementationParams, (Definition.t_0, DefinitionLink.t_0) or_array or_null, unit) RequestHandler.t_3
    end
  end
  ...
  module[@js.scope "ImplementationClientCapabilities"] ImplementationClientCapabilities : sig
  ...
  module[@js.scope "ImplementationOptions"] ImplementationOptions : sig
  ...
  module[@js.scope "ImplementationRegistrationOptions"] ImplementationRegistrationOptions : sig
  ...
  module[@js.scope "ImplementationParams"] ImplementationParams : sig
  ...
  module[@js.scope "ImplementationRequest"] ImplementationRequest : sig
    val method_: ([`L_s0_textDocument_implementation[@js "textDocument/implementation"]] [@js.enum]) [@@js.global "method"]
    val type_: (_ImplementationParams, (Location.t_0, (Location.t_0, LocationLink.t_0) union2) or_array or_null, (Location.t_0, LocationLink.t_0) union2 list, unit, _ImplementationRegistrationOptions) ProtocolRequestType.t_5 [@@js.global "type"]
