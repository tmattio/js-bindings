...
module Make (M: Missing) : sig
  ...
  module Internal : sig
    ...
    module Types : sig
      ...
      type _TypeDefinitionClientCapabilities = [`TypeDefinitionClientCapabilities] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _TypeDefinitionOptions = [`TypeDefinitionOptions] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _TypeDefinitionParams = [`TypeDefinitionParams] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _TypeDefinitionRegistrationOptions = [`TypeDefinitionRegistrationOptions | `TypeDefinitionOptions] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _TypeDefinitionRequest_HandlerSignature = (_TypeDefinitionParams, (Definition.t_0, DefinitionLink.t_0) or_array or_null, unit) RequestHandler.t_3
    end
  end
  ...
  module[@js.scope "TypeDefinitionClientCapabilities"] TypeDefinitionClientCapabilities : sig
  ...
  module[@js.scope "TypeDefinitionOptions"] TypeDefinitionOptions : sig
  ...
  module[@js.scope "TypeDefinitionRegistrationOptions"] TypeDefinitionRegistrationOptions : sig
  ...
  module[@js.scope "TypeDefinitionParams"] TypeDefinitionParams : sig
  ...
  module[@js.scope "TypeDefinitionRequest"] TypeDefinitionRequest : sig
    val method_: ([`L_s0_textDocument_typeDefinition[@js "textDocument/typeDefinition"]] [@js.enum]) [@@js.global "method"]
    val type_: (_TypeDefinitionParams, (Location.t_0, (Location.t_0, LocationLink.t_0) union2) or_array or_null, (Location.t_0, LocationLink.t_0) union2 list, unit, _TypeDefinitionRegistrationOptions) ProtocolRequestType.t_5 [@@js.global "type"]
