    ...
    module Types =
      struct
        ...
        type ('P, 'RO) _ProtocolNotificationType =
          [ `ProtocolNotificationType of ('P * 'RO) 
          | `RegistrationType of 'RO ] intf
        and 'RO _ProtocolNotificationType0 =
          [ `ProtocolNotificationType0 of 'RO  | `RegistrationType of 'RO ]
            intf
        ...
        let rec _ProtocolNotificationType_of_js :
          'P 'RO .
            (Ojs.t -> 'P) ->
              (Ojs.t -> 'RO) -> Ojs.t -> ('P, 'RO) _ProtocolNotificationType
          = fun _P -> fun _RO -> Obj.magic
        and _ProtocolNotificationType_to_js :
          'P 'RO .
            ('P -> Ojs.t) ->
              ('RO -> Ojs.t) -> ('P, 'RO) _ProtocolNotificationType -> Ojs.t
          = fun _P -> fun _RO -> Obj.magic
        and _ProtocolNotificationType0_of_js :
          'RO . (Ojs.t -> 'RO) -> Ojs.t -> 'RO _ProtocolNotificationType0 =
          fun _RO -> Obj.magic
        and _ProtocolNotificationType0_to_js :
          'RO . ('RO -> Ojs.t) -> 'RO _ProtocolNotificationType0 -> Ojs.t =
          fun _RO -> Obj.magic
        and _ProtocolRequestType_of_js :
          'P 'R 'PR 'E 'RO .
            (Ojs.t -> 'P) ->
              (Ojs.t -> 'R) ->
                (Ojs.t -> 'PR) ->
                  (Ojs.t -> 'E) ->
                    (Ojs.t -> 'RO) ->
                      Ojs.t -> ('P, 'R, 'PR, 'E, 'RO) _ProtocolRequestType
          = fun _P -> fun _R -> fun _PR -> fun _E -> fun _RO -> Obj.magic
        and _ProtocolRequestType_to_js :
          'P 'R 'PR 'E 'RO .
            ('P -> Ojs.t) ->
              ('R -> Ojs.t) ->
                ('PR -> Ojs.t) ->
                  ('E -> Ojs.t) ->
                    ('RO -> Ojs.t) ->
                      ('P, 'R, 'PR, 'E, 'RO) _ProtocolRequestType -> Ojs.t
          = fun _P -> fun _R -> fun _PR -> fun _E -> fun _RO -> Obj.magic
        and _ProtocolRequestType0_of_js :
          'R 'PR 'E 'RO .
            (Ojs.t -> 'R) ->
              (Ojs.t -> 'PR) ->
                (Ojs.t -> 'E) ->
                  (Ojs.t -> 'RO) ->
                    Ojs.t -> ('R, 'PR, 'E, 'RO) _ProtocolRequestType0
          = fun _R -> fun _PR -> fun _E -> fun _RO -> Obj.magic
        and _ProtocolRequestType0_to_js :
          'R 'PR 'E 'RO .
            ('R -> Ojs.t) ->
              ('PR -> Ojs.t) ->
                ('E -> Ojs.t) ->
                  ('RO -> Ojs.t) ->
                    ('R, 'PR, 'E, 'RO) _ProtocolRequestType0 -> Ojs.t
          = fun _R -> fun _PR -> fun _E -> fun _RO -> Obj.magic
        and _RegistrationType_of_js :
          'RO . (Ojs.t -> 'RO) -> Ojs.t -> 'RO _RegistrationType =
          fun _RO -> Obj.magic
        and _RegistrationType_to_js :
          'RO . ('RO -> Ojs.t) -> 'RO _RegistrationType -> Ojs.t =
          fun _RO -> Obj.magic
      end
  end
open Internal
