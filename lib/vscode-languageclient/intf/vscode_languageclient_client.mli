...
module ProvideCompletionItemsSignature : sig
  ...
  val apply
    ...
    -> (VCompletionList.t, VCompletionItem.t) or_array ProviderResult.t_1
    [@@js.apply]
end
...
module ProvideDocumentSymbolsSignature : sig
  ...
  val apply
    ...
    -> document:TextDocument.t
    -> token:CancellationToken.t
    -> (VDocumentSymbol.t, VSymbolInformation.t) union2 list ProviderResult.t_1
    [@@js.apply]
end
...
module DynamicFeature : sig
  ...
  val get_registrationType : 'RO t -> 'RO RegistrationType.t_1
    [@@js.get "registrationType"]

  val set_registrationType : 'RO t -> 'RO RegistrationType.t_1 -> unit
...
module NotifyingFeature : sig
  ...
  val get_onNotificationSent
    :  ('E, 'P) t
    -> ('E, 'P) _NotificationSendEvent VEvent.t_1
...
module DidOpenTextDocumentFeatureShape : sig
  ...
  val get_openDocuments : t -> TextDocument.t Iterable.t_1
    [@@js.get "openDocuments"]

  val set_openDocuments : t -> TextDocument.t Iterable.t_1 -> unit
...
module TextDocumentFeature : sig
  ...
  val create
    ...
    -> _registrationType:'RO RegistrationType.t_1
    -> ('PO, 'RO, 'PR) t
    [@@js.create]

  val get_registrationType : ('PO, 'RO, 'PR) t -> 'RO RegistrationType.t_1
    [@@js.get "registrationType"]
  ...
  val getAllProviders : ('PO, 'RO, 'PR) t -> 'PR Iterable.t_1
...
module BaseLanguageClient : sig
  ...
  val get_onDidChangeState : t -> _StateChangeEvent Event.t_1
  ...
  val getFeature'''
    ...
    -> request:
         ...
         any
    -> ( TextDocumentRegistrationOptions.t _DynamicFeature
       , (textDocument:TextDocument.t -> VTextEdit.t list ProviderResult.t_1)
