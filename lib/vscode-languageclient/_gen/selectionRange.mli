...
module Make (M: Missing) : sig
  ...
  module Internal : sig
    ...
    module Types : sig
      ...
      type _ProvideSelectionRangeSignature = [`ProvideSelectionRangeSignature] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _SelectionRangeFeature = [`SelectionRangeFeature] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
      and _SelectionRangeProviderMiddleware = [`SelectionRangeProviderMiddleware] intf
      [@@js.custom { of_js=Obj.magic; to_js=Obj.magic }]
    end
  end
  ...
  module[@js.scope "ProvideSelectionRangeSignature"] ProvideSelectionRangeSignature : sig
    ...
    val t_0_to_js: t_0 -> Ojs.t
    val t_0_of_js: Ojs.t -> t_0
    val apply: t -> this:unit -> document:TextDocument.t_0 -> positions:VPosition.t_0 list -> token:CancellationToken.t_0 -> VSelectionRange.t_0 list ProviderResult.t_1 [@@js.apply]
  end
  module[@js.scope "SelectionRangeProviderMiddleware"] SelectionRangeProviderMiddleware : sig
    ...
    val t_0_to_js: t_0 -> Ojs.t
    val t_0_of_js: Ojs.t -> t_0
    val provideSelectionRanges: t -> this:unit -> document:TextDocument.t_0 -> positions:VPosition.t_0 list -> token:CancellationToken.t_0 -> next:_ProvideSelectionRangeSignature -> VSelectionRange.t_0 list ProviderResult.t_1 [@@js.call "provideSelectionRanges"]
  end
  module[@js.scope "SelectionRangeFeature"] SelectionRangeFeature : sig
    ...
    val registerLanguageProvider: t -> options:SelectionRangeRegistrationOptions.t_0 -> (Disposable.t_0 * SelectionRangeProvider.t_0) [@@js.call "registerLanguageProvider"]
    val cast: t -> (SelectionRangeOptions.t_0 or_boolean, SelectionRangeRegistrationOptions.t_0, SelectionRangeProvider.t_0) TextDocumentFeature.t_3 [@@js.cast]
  end
end
