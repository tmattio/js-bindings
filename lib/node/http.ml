  ...
  struct
                  ...
                  (Ojs.new_obj_arr (Ojs.get_prop_ascii Import.http "Server")
                     (let x356 =
                      ...
                      (match x355 with
                       ...
                       | None -> ());
                      x356))
        let (cast : t -> Net.Net.Server.t) =
          fun (x358 : t) -> Net.Net.Server.t_of_js (t_to_js x358)
      end
          ...
          fun (x380 : t) ->
            fun (x381 : bool) ->
              Ojs.set_prop_ascii (t_to_js x380) "headersSent"
                (Ojs.bool_to_js x381)
        let (get_connection : t -> Net.Net.Socket.t or_null) =
          fun (x382 : t) ->
            or_null_of_js Net.Net.Socket.t_of_js
              (Ojs.get_prop_ascii (t_to_js x382) "connection")
        let (set_connection : t -> Net.Net.Socket.t or_null -> unit) =
          fun (x384 : t) ->
            fun (x385 : Net.Net.Socket.t or_null) ->
              Ojs.set_prop_ascii (t_to_js x384) "connection"
                (or_null_to_js Net.Net.Socket.t_to_js x385)
        let (get_socket : t -> Net.Net.Socket.t or_null) =
          fun (x387 : t) ->
            or_null_of_js Net.Net.Socket.t_of_js
              (Ojs.get_prop_ascii (t_to_js x387) "socket")
        let (set_socket : t -> Net.Net.Socket.t or_null -> unit) =
          fun (x389 : t) ->
            fun (x390 : Net.Net.Socket.t or_null) ->
              Ojs.set_prop_ascii (t_to_js x389) "socket"
                (or_null_to_js Net.Net.Socket.t_to_js x390)
        let (create : unit -> t) =
          fun () ->
            t_of_js
    ...
    module ServerResponse =
      struct
        ...
        let (assignSocket : t -> socket:Net.Net.Socket.t -> unit) =
          fun (x437 : t) ->
            fun ~socket:(x436 : Net.Net.Socket.t) ->
              ignore
                (Ojs.call (t_to_js x437) "assignSocket"
                   [|(Net.Net.Socket.t_to_js x436)|])
        let (detachSocket : t -> socket:Net.Net.Socket.t -> unit) =
          fun (x439 : t) ->
            fun ~socket:(x438 : Net.Net.Socket.t) ->
              ignore
                (Ojs.call (t_to_js x439) "detachSocket"
                   [|(Net.Net.Socket.t_to_js x438)|])
    ...
    module ClientRequest =
      struct
        ...
        let (create :
          ...
          fun
            ~url:(x501 :
                   (http_ClientRequestArgs, Url.Url.Url.t) union2 or_string)
            ->
                      ...
                      ignore
                        (Ojs.call x503 "push"
                           [|(or_string_to_js
                                (fun
                                   (x506 :
                                     (http_ClientRequestArgs, Url.Url.Url.t)
                                       union2)
                                   ->
                                   union2_to_js http_ClientRequestArgs_to_js
                                     Url.Url.Url.t_to_js x506) x501)|]);
                      (match x502 with
                       | Some x504 ->
                           ignore
                             (Ojs.call x503 "push"
        ...
        let (onSocket : t -> socket:Net.Net.Socket.t -> unit) =
          fun (x517 : t) ->
            fun ~socket:(x516 : Net.Net.Socket.t) ->
              ignore
                (Ojs.call (t_to_js x517) "onSocket"
                   [|(Net.Net.Socket.t_to_js x516)|])
        let (setTimeout :
          ...
          t ->
            event:[ `connect ] ->
              listener:(response:http_IncomingMessage ->
                          socket:Net.Net.Socket.t -> head:Buffer.t -> unit)
                -> t)
          =
          fun (x544 : t) ->
                            ...
                            fun (x542 : Ojs.t) ->
                              fun (x543 : Ojs.t) ->
                                x540
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x542)
        ...
        let (addListener''''' :
          t ->
            event:[ `socket ] ->
              listener:(socket:Net.Net.Socket.t -> unit) -> t)
          =
          fun (x559 : t) ->
            fun ~event:(x556 : [ `socket ]) ->
              fun ~listener:(x557 : socket:Net.Net.Socket.t -> unit) ->
                t_of_js
                            ...
                            fun (x566 : Ojs.t) ->
                              fun (x567 : Ojs.t) ->
                                x564
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x566)
                            ...
                            fun (x602 : Ojs.t) ->
                              fun (x603 : Ojs.t) ->
                                x600
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x602)
        ...
        let (on''''' :
          ...
          fun (x619 : t) ->
            fun ~event:(x616 : [ `socket ]) ->
              fun ~listener:(x617 : socket:Net.Net.Socket.t -> unit) ->
                t_of_js
                            ...
                            fun (x626 : Ojs.t) ->
                              fun (x627 : Ojs.t) ->
                                x624
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x626)
                            ...
                            fun (x662 : Ojs.t) ->
                              fun (x663 : Ojs.t) ->
                                x660
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x662)
        ...
        let (once''''' :
          ...
          fun (x679 : t) ->
            fun ~event:(x676 : [ `socket ]) ->
              fun ~listener:(x677 : socket:Net.Net.Socket.t -> unit) ->
                t_of_js
                            ...
                            fun (x686 : Ojs.t) ->
                              fun (x687 : Ojs.t) ->
                                x684
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x686)
                            ...
                            fun (x722 : Ojs.t) ->
                              fun (x723 : Ojs.t) ->
                                x720
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x722)
        ...
        let (prependListener''''' :
          ...
          fun (x739 : t) ->
            fun ~event:(x736 : [ `socket ]) ->
              fun ~listener:(x737 : socket:Net.Net.Socket.t -> unit) ->
                t_of_js
                            ...
                            fun (x746 : Ojs.t) ->
                              fun (x747 : Ojs.t) ->
                                x744
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x746)
                            ...
                            fun (x782 : Ojs.t) ->
                              fun (x783 : Ojs.t) ->
                                x780
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x782)
        ...
        let (prependOnceListener''''' :
          ...
          fun (x799 : t) ->
            fun ~event:(x796 : [ `socket ]) ->
              fun ~listener:(x797 : socket:Net.Net.Socket.t -> unit) ->
                t_of_js
                            ...
                            fun (x806 : Ojs.t) ->
                              fun (x807 : Ojs.t) ->
                                x804
                                  ...
                                  ~socket:(Net.Net.Socket.t_of_js x806)
    ...
    module IncomingMessage =
      struct
        ...
        let (create : socket:Net.Net.Socket.t -> t) =
          fun ~socket:(x837 : Net.Net.Socket.t) ->
            t_of_js
              (Ojs.new_obj (Ojs.get_prop_ascii Import.http "IncomingMessage")
                 [|(Net.Net.Socket.t_to_js x837)|])
        let (get_aborted : t -> bool) =
          fun (x838 : t) ->
          ...
          fun (x851 : t) ->
            fun (x852 : bool) ->
              Ojs.set_prop_ascii (t_to_js x851) "complete"
                (Ojs.bool_to_js x852)
        let (get_connection : t -> Net.Net.Socket.t) =
          fun (x853 : t) ->
            Net.Net.Socket.t_of_js
              (Ojs.get_prop_ascii (t_to_js x853) "connection")
        let (set_connection : t -> Net.Net.Socket.t -> unit) =
          fun (x854 : t) ->
            fun (x855 : Net.Net.Socket.t) ->
              Ojs.set_prop_ascii (t_to_js x854) "connection"
                (Net.Net.Socket.t_to_js x855)
        let (get_socket : t -> Net.Net.Socket.t) =
          fun (x856 : t) ->
            Net.Net.Socket.t_of_js
              (Ojs.get_prop_ascii (t_to_js x856) "socket")
        let (set_socket : t -> Net.Net.Socket.t -> unit) =
          fun (x857 : t) ->
            fun (x858 : Net.Net.Socket.t) ->
              Ojs.set_prop_ascii (t_to_js x857) "socket"
                (Net.Net.Socket.t_to_js x858)
        let (get_headers : t -> http_IncomingHttpHeaders) =
          fun (x859 : t) ->
            http_IncomingHttpHeaders_of_js
    ...
    module Agent =
      struct
        ...
        let (get_freeSockets : t -> Net.Net.Socket.t list ReadOnlyDict.t) =
          fun (x935 : t) ->
            ReadOnlyDict.t_of_js
              (fun (x936 : Ojs.t) ->
                 Ojs.list_of_js Net.Net.Socket.t_of_js x936)
              (Ojs.get_prop_ascii (t_to_js x935) "freeSockets")
        let (get_sockets : t -> Net.Net.Socket.t list ReadOnlyDict.t) =
          fun (x938 : t) ->
            ReadOnlyDict.t_of_js
              (fun (x939 : Ojs.t) ->
                 Ojs.list_of_js Net.Net.Socket.t_of_js x939)
    ...
    let (request :
      ...
      fun
        ~options:(x961 :
                   (http_RequestOptions, Url.Url.Url.t) union2 or_string)
        ->
                          ...
                          ignore
                            (Ojs.call x963 "push"
                               [|(or_string_to_js
                                    (fun
                                       (x966 :
                                         (http_RequestOptions, Url.Url.Url.t)
                                           union2)
                                       ->
                                       union2_to_js http_RequestOptions_to_js
                                         Url.Url.Url.t_to_js x966) x961)|]);
                          (match x962 with
                           | Some x964 ->
                               ignore
                                 (Ojs.call x963 "push"
      ...
      url:Url.Url.Url.t or_string ->
        options:http_RequestOptions ->
          ?callback:(res:http_IncomingMessage -> unit) ->
            unit -> http_ClientRequest)
      =
      fun ~url:(x970 : Url.Url.Url.t or_string) ->
                ...
                (let x977 = Import.http in
                 Ojs.call (Ojs.get_prop_ascii x977 "request") "apply"
                   [|x977;((let x973 =
                            ...
                            ignore
                              (Ojs.call x973 "push"
                                 [|(or_string_to_js Url.Url.Url.t_to_js x970)|]);
                            ignore
                              (Ojs.call x973 "push"
      ...
      url:Url.Url.Url.t or_string ->
        options:http_RequestOptions ->
          ?callback:(res:http_IncomingMessage -> unit) ->
            unit -> http_ClientRequest)
      =
      fun ~url:(x987 : Url.Url.Url.t or_string) ->
                ...
                (let x994 = Import.http in
                 Ojs.call (Ojs.get_prop_ascii x994 "get") "apply"
                   [|x994;((let x990 =
                            ...
                            ignore
                              (Ojs.call x990 "push"
                                 [|(or_string_to_js Url.Url.Url.t_to_js x987)|]);
                            ignore
                              (Ojs.call x990 "push"
