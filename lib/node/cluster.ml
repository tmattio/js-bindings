  ...
  struct
    ...
    module Worker =
      struct
        ...
        let (get_process : t -> Child_process.Child_process.ChildProcess.t) =
          fun (x54 : t) ->
            Child_process.Child_process.ChildProcess.t_of_js
              (Ojs.get_prop_ascii (t_to_js x54) "process")
        let (set_process :
          t -> Child_process.Child_process.ChildProcess.t -> unit) =
          fun (x55 : t) ->
            fun (x56 : Child_process.Child_process.ChildProcess.t) ->
              Ojs.set_prop_ascii (t_to_js x55) "process"
                (Child_process.Child_process.ChildProcess.t_to_js x56)
        let (send :
          t ->
          ...
          =
          fun (x65 : t) ->
            fun ~message:(x57 : Child_process.Child_process.Serializable.t)
              ->
              fun
                ?sendHandle:(x58 :
                              Child_process.Child_process.SendHandle.t option)
                ->
                      ...
                      (let x66 = t_to_js x65 in
                       Ojs.call (Ojs.get_prop_ascii x66 "send") "apply"
                         [|x66;((let x60 =
                                 ...
                                 ignore
                                   (Ojs.call x60 "push"
                                      [|(Child_process.Child_process.Serializable.t_to_js
                                           x57)|]);
                                 (match x58 with
                                  | Some x64 ->
                                      ignore
                                        (Ojs.call x60 "push"
                                           [|(Child_process.Child_process.SendHandle.t_to_js
                                                x64)|])
                                  | None -> ());
                                 (match x59 with
                                  | Some x61 ->
        ...
        let (cast : t -> Events.Events.EventEmitter.t) =
          fun (x265 : t) -> Events.Events.EventEmitter.t_of_js (t_to_js x265)
      end
    module Cluster =
      struct
        ...
        let (cast : t -> Events.Events.EventEmitter.t) =
          fun (x543 : t) -> Events.Events.EventEmitter.t_of_js (t_to_js x543)
      end
