...
module Console : sig
  module Console : sig
    ...
    val dir
      :  t
      -> obj:any
      -> ?options:Util.Util.InspectOptions.t
      -> unit
      -> unit
      [@@js.call "dir"]
    ...
    module ConsoleConstructorOptions : sig
      ...
      val get_stdout : t -> WritableStream.t [@@js.get "stdout"]

      val set_stdout : t -> WritableStream.t -> unit [@@js.set "stdout"]

      val get_stderr : t -> WritableStream.t [@@js.get "stderr"]
      ...
      val get_inspectOptions : t -> Util.Util.InspectOptions.t
        [@@js.get "inspectOptions"]

      val set_inspectOptions : t -> Util.Util.InspectOptions.t -> unit
