...
module Internal : sig
  ...
  module Types : sig
    ...
    and worker_threads_TransferListItem =
      ( ArrayBuffer.t
      , Fs_promises.Fs_promises.FileHandle.t
...
module Worker_threads : sig
  ...
  module Worker : sig
    ...
    val get_stdout : t -> Stream.Stream.Writable.t [@@js.get "stdout"]

    val get_stderr : t -> Stream.Stream.Writable.t [@@js.get "stderr"]
    ...
    val getHeapSnapshot : t -> Stream.Stream.Writable.t Promise.t
