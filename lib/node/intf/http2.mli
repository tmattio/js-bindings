...
module Http2 : sig
  ...
  module IncomingHttpHeaders : sig
    ...
    val cast : t -> Http.Http.IncomingHttpHeaders.t [@@js.cast]
  end
  ...
  module ServerStreamFileResponseOptions : sig
    ...
    val statCheck
      :  t
      -> stats:Fs.Stats.t
      -> headers:Http.Http.OutgoingHttpHeaders.t
  ...
  module Http2Stream : sig
    ...
    val get_sentHeaders : t -> Http.Http.OutgoingHttpHeaders.t
      [@@js.get "sentHeaders"]

    val get_sentInfoHeaders : t -> Http.Http.OutgoingHttpHeaders.t list
      [@@js.get "sentInfoHeaders"]

    val get_sentTrailers : t -> Http.Http.OutgoingHttpHeaders.t
      [@@js.get "sentTrailers"]
    ...
    val sendTrailers : t -> headers:Http.Http.OutgoingHttpHeaders.t -> unit
  ...
  module ServerHttp2Stream : sig
    ...
    val additionalHeaders : t -> headers:Http.Http.OutgoingHttpHeaders.t -> unit
  ...
  module Http2Session : sig
    ...
    val destroy : t -> ?error:Error.t -> ?code:float -> unit -> unit
      [@@js.call "destroy"]
    ...
    val ping
      :  t
      -> callback:
           (err:Error.t or_null -> duration:float -> payload:Buffer.t -> unit)
      -> bool
      [@@js.call "ping"]
  ...
  module Http2ServerRequest : sig
    ...
    val read : t -> ?size:float -> unit -> Buffer.t or_string or_null
      [@@js.call "read"]
  ...
  module Http2ServerResponse : sig
    ...
    val addTrailers : t -> trailers:Http.Http.OutgoingHttpHeaders.t -> unit
      [@@js.call "addTrailers"]
    ...
    val getHeaders : t -> Http.Http.OutgoingHttpHeaders.t
      [@@js.call "getHeaders"]
