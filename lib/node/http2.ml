  ...
  struct
    ...
    module IncomingHttpHeaders =
      struct
        ...
        let (cast : t -> Http.Http.IncomingHttpHeaders.t) =
          fun (x27 : t) ->
            Http.Http.IncomingHttpHeaders.t_of_js (t_to_js x27)
      end
        ...
        let (statCheck :
          ...
          fun (x83 : t) ->
            fun ~stats:(x80 : Fs.Stats.t) ->
              fun ~headers:(x81 : Http.Http.OutgoingHttpHeaders.t) ->
                fun ~statOptions:(x82 : http2_StatOptions) ->
                  or_boolean_of_js Ojs.unit_of_js
                    (Ojs.call (t_to_js x83) "statCheck"
                       [|(Fs.Stats.t_to_js x80);(Http.Http.OutgoingHttpHeaders.t_to_js
    ...
    module Http2Stream =
      struct
        ...
        let (get_sentHeaders : t -> Http.Http.OutgoingHttpHeaders.t) =
          fun (x109 : t) ->
            Http.Http.OutgoingHttpHeaders.t_of_js
              (Ojs.get_prop_ascii (t_to_js x109) "sentHeaders")
        let (get_sentInfoHeaders : t -> Http.Http.OutgoingHttpHeaders.t list)
          =
          fun (x110 : t) ->
            Ojs.list_of_js Http.Http.OutgoingHttpHeaders.t_of_js
              (Ojs.get_prop_ascii (t_to_js x110) "sentInfoHeaders")
        let (get_sentTrailers : t -> Http.Http.OutgoingHttpHeaders.t) =
          fun (x112 : t) ->
            Http.Http.OutgoingHttpHeaders.t_of_js
                    ...
                    (let x129 = t_to_js x128 in
                     Ojs.call (Ojs.get_prop_ascii x129 "setTimeout") "apply"
                       [|x129;((let x126 =
                                ...
                                x126))|])
        let (sendTrailers :
          t -> headers:Http.Http.OutgoingHttpHeaders.t -> unit) =
          fun (x131 : t) ->
            fun ~headers:(x130 : Http.Http.OutgoingHttpHeaders.t) ->
              ignore
                (Ojs.call (t_to_js x131) "sendTrailers"
                   [|(Http.Http.OutgoingHttpHeaders.t_to_js x130)|])
        let (addListener :
    ...
    module ServerHttp2Stream =
      struct
        ...
        let (additionalHeaders :
          t -> headers:Http.Http.OutgoingHttpHeaders.t -> unit) =
          fun (x641 : t) ->
            fun ~headers:(x640 : Http.Http.OutgoingHttpHeaders.t) ->
              ignore
                (Ojs.call (t_to_js x641) "additionalHeaders"
                   [|(Http.Http.OutgoingHttpHeaders.t_to_js x640)|])
        let (pushStream :
          t ->
            headers:Http.Http.OutgoingHttpHeaders.t ->
              ?callback:(err:Error.t or_null ->
                           pushStream:t ->
                             headers:Http.Http.OutgoingHttpHeaders.t -> unit)
                -> unit -> unit)
          =
          fun (x650 : t) ->
            fun ~headers:(x642 : Http.Http.OutgoingHttpHeaders.t) ->
              fun
                ?callback:(x643 :
                            (err:Error.t or_null ->
                               pushStream:t ->
                    ...
                    (let x651 = t_to_js x650 in
                     Ojs.call (Ojs.get_prop_ascii x651 "pushStream") "apply"
                       [|x651;((let x644 =
                                ...
                                ignore
                                  (Ojs.call x644 "push"
                                     [|(Http.Http.OutgoingHttpHeaders.t_to_js
                                          x642)|]);
                                (match x643 with
                                 | Some x645 ->
                                     ignore
                                                  ...
                                                  fun (x648 : Ojs.t) ->
                                                    fun (x649 : Ojs.t) ->
                                                      x645
                                                        ...
                                                        ~pushStream:(
                                                        t_of_js x648)
                                                        ~headers:(Http.Http.OutgoingHttpHeaders.t_of_js
                                                                    x649)))|])
                                 | None -> ());
                                x644))|])
        let (pushStream' :
          ...
          =
          fun (x662 : t) ->
            fun ~headers:(x652 : Http.Http.OutgoingHttpHeaders.t) ->
        ...
        let (respond :
          ...
          =
          fun (x669 : t) ->
            fun ?headers:(x664 : Http.Http.OutgoingHttpHeaders.t option) ->
        ...
        let (respondWithFD :
          ...
          fun (x678 : t) ->
            fun ~fd:(x671 : Fs_promises.FileHandle.t or_number) ->
              fun ?headers:(x672 : Http.Http.OutgoingHttpHeaders.t option) ->
                fun
                  ?options:(x673 :
        ...
        let (respondWithFile :
          ...
          fun (x686 : t) ->
            fun ~path:(x680 : string) ->
              fun ?headers:(x681 : Http.Http.OutgoingHttpHeaders.t option) ->
                fun
                  ?options:(x682 :
                             http2_ServerStreamFileResponseOptionsWithError
                               option)
    ...
    module Http2Session =
      struct
        ...
        let (cast : t -> Events.Events.EventEmitter.t) =
          fun (x1048 : t) ->
            Events.Events.EventEmitter.t_of_js (t_to_js x1048)
      end
    module ClientHttp2Session =
      struct
        ...
        let (request :
          ...
          =
          fun (x1056 : t) ->
            fun ?headers:(x1051 : Http.Http.OutgoingHttpHeaders.t option) ->
    ...
    module Http2ServerResponse =
      struct
        ...
        let (addTrailers :
          t -> trailers:Http.Http.OutgoingHttpHeaders.t -> unit) =
          fun (x2134 : t) ->
            fun ~trailers:(x2133 : Http.Http.OutgoingHttpHeaders.t) ->
              ignore
                (Ojs.call (t_to_js x2134) "addTrailers"
                   [|(Http.Http.OutgoingHttpHeaders.t_to_js x2133)|])
        ...
        let (getHeaders : t -> Http.Http.OutgoingHttpHeaders.t) =
          fun (x2159 : t) ->
            Http.Http.OutgoingHttpHeaders.t_of_js
        ...
        let (writeHead :
          t ->
            statusCode:float ->
              ?headers:Http.Http.OutgoingHttpHeaders.t -> unit -> t)
          =
          fun (x2198 : t) ->
            fun ~statusCode:(x2194 : float) ->
              fun ?headers:(x2195 : Http.Http.OutgoingHttpHeaders.t option)
                ->
                fun () ->
                  t_of_js
          ...
          fun (x2205 : t) ->
            fun ~statusCode:(x2200 : float) ->
              fun ~statusMessage:(x2201 : string) ->
                fun ?headers:(x2202 : Http.Http.OutgoingHttpHeaders.t option)
                  ->
                  fun () ->
                    t_of_js
        ...
        let (createPushResponse :
          ...
          =
          fun (x2212 : t) ->
            fun ~headers:(x2207 : Http.Http.OutgoingHttpHeaders.t) ->
              fun ~callback:(x2208 : err:Error.t or_null -> res:t -> unit) ->
                ignore
                  (Ojs.call (t_to_js x2212) "createPushResponse"
                     [|(Http.Http.OutgoingHttpHeaders.t_to_js x2207);(
                       Ojs.fun_to_js 2
                         (fun (x2209 : Ojs.t) ->
                            fun (x2211 : Ojs.t) ->
