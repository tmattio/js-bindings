  ...
  struct
      ...
      struct
        ...
        let (get_query :
          ...
          fun (x55 : t) ->
            or_null_of_js
              (fun (x56 : Ojs.t) ->
                 or_string_of_js
                   Querystring.Querystring.ParsedUrlQueryInput.t_of_js x56)
        ...
        let (set_query :
          ...
          fun (x58 : t) ->
            fun
              (x59 :
                Querystring.Querystring.ParsedUrlQueryInput.t or_string
                  or_null)
              ->
              Ojs.set_prop_ascii (t_to_js x58) "query"
                (or_null_to_js
                   (fun
                      (x60 :
                        Querystring.Querystring.ParsedUrlQueryInput.t
                          or_string)
                      ->
                      or_string_to_js
                        Querystring.Querystring.ParsedUrlQueryInput.t_to_js
                        x60) x59)
      end
    module Url =
      struct
        ...
        let (get_query :
          t -> Querystring.Querystring.ParsedUrlQuery.t or_string or_null) =
          fun (x117 : t) ->
            or_null_of_js
              (fun (x118 : Ojs.t) ->
                 or_string_of_js
                   Querystring.Querystring.ParsedUrlQuery.t_of_js x118)
            ...
            fun
              ...
              Ojs.set_prop_ascii (t_to_js x120) "query"
                (or_null_to_js
                   (fun
                      (x122 :
                        Querystring.Querystring.ParsedUrlQuery.t or_string)
                      ->
                      or_string_to_js
                        Querystring.Querystring.ParsedUrlQuery.t_to_js x122)
                   x121)
      end
    module UrlWithParsedQuery =
      struct
        ...
        let (get_query : t -> Querystring.Querystring.ParsedUrlQuery.t) =
          fun (x126 : t) ->
            Querystring.Querystring.ParsedUrlQuery.t_of_js
              (Ojs.get_prop_ascii (t_to_js x126) "query")
        let (set_query :
          t -> Querystring.Querystring.ParsedUrlQuery.t -> unit) =
          fun (x127 : t) ->
            fun (x128 : Querystring.Querystring.ParsedUrlQuery.t) ->
              Ojs.set_prop_ascii (t_to_js x127) "query"
                (Querystring.Querystring.ParsedUrlQuery.t_to_js x128)
        let (cast : t -> url_Url) =
