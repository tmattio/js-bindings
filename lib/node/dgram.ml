  ...
  struct
    ...
    module Socket =
      struct
                     ...
                     Ojs.call (Ojs.get_prop_ascii x81 "addMembership")
                       ...
                       [|x81;((let x78 =
                               ...
                               (match x77 with
                                ...
                                | None -> ());
                               x78))|])
        let (address : t -> Net.Net.AddressInfo.t) =
          fun (x82 : t) ->
            Net.Net.AddressInfo.t_of_js
        ...
        let (remoteAddress : t -> Net.Net.AddressInfo.t) =
          fun (x136 : t) ->
            Net.Net.AddressInfo.t_of_js
        ...
        let (cast : t -> Events.Events.EventEmitter.t) =
          fun (x388 : t) -> Events.Events.EventEmitter.t_of_js (t_to_js x388)
      end
  end
