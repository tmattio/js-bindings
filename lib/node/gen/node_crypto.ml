    ...
    module Types =
      struct
        ...
        and crypto_BinaryLike_of_js : Ojs.t -> crypto_BinaryLike =
          fun (x3 : Ojs.t) ->
            or_string_of_js NodeJS.ArrayBufferView.t_0_of_js x3
        and crypto_BinaryLike_to_js : crypto_BinaryLike -> Ojs.t =
          fun (x1 : NodeJS.ArrayBufferView.t_0 or_string) ->
            or_string_to_js NodeJS.ArrayBufferView.t_0_to_js x1
        ...
        and crypto_KeyLike_of_js : Ojs.t -> crypto_KeyLike =
          fun (x49 : Ojs.t) ->
            or_string_of_js
              (fun (x50 : Ojs.t) ->
                 union2_of_js Buffer.t_0_of_js crypto_KeyObject_of_js x50)
              x49
        and crypto_KeyLike_to_js : crypto_KeyLike -> Ojs.t =
          fun (x45 : (Buffer.t_0, crypto_KeyObject) union2 or_string) ->
            or_string_to_js
              (fun (x46 : (Buffer.t_0, crypto_KeyObject) union2) ->
                 union2_to_js Buffer.t_0_to_js crypto_KeyObject_to_js x46)
              x45
...
module AnonymousInterface2 =
  struct
    ...
    let (get_publicKey : t -> Buffer.t_0) =
      fun (x77 : t) ->
        Buffer.t_0_of_js (Ojs.get_prop_ascii (t_to_js x77) "publicKey")
    let (set_publicKey : t -> Buffer.t_0 -> unit) =
      fun (x78 : t) ->
        fun (x79 : Buffer.t_0) ->
          Ojs.set_prop_ascii (t_to_js x78) "publicKey" (Buffer.t_0_to_js x79)
    let (get_privateKey : t -> Buffer.t_0) =
      fun (x80 : t) ->
        Buffer.t_0_of_js (Ojs.get_prop_ascii (t_to_js x80) "privateKey")
    let (set_privateKey : t -> Buffer.t_0 -> unit) =
      fun (x81 : t) ->
        fun (x82 : Buffer.t_0) ->
          Ojs.set_prop_ascii (t_to_js x81) "privateKey"
            (Buffer.t_0_to_js x82)
  end
module AnonymousInterface3 =
  struct
    ...
    let (get_publicKey : t -> Buffer.t_0) =
      fun (x85 : t) ->
        Buffer.t_0_of_js (Ojs.get_prop_ascii (t_to_js x85) "publicKey")
    let (set_publicKey : t -> Buffer.t_0 -> unit) =
      fun (x86 : t) ->
        fun (x87 : Buffer.t_0) ->
          Ojs.set_prop_ascii (t_to_js x86) "publicKey" (Buffer.t_0_to_js x87)
...
module AnonymousInterface4 =
  struct
    ...
    let (get_privateKey : t -> Buffer.t_0) =
      fun (x96 : t) ->
        Buffer.t_0_of_js (Ojs.get_prop_ascii (t_to_js x96) "privateKey")
    let (set_privateKey : t -> Buffer.t_0 -> unit) =
      fun (x97 : t) ->
        fun (x98 : Buffer.t_0) ->
          Ojs.set_prop_ascii (t_to_js x97) "privateKey"
            (Buffer.t_0_to_js x98)
  end
  ...
  struct
    module Certificate =
      struct
        ...
        let (exportChallenge : t -> spkac:crypto_BinaryLike -> Buffer.t_0) =
          fun (x150 : t) ->
        ...
        let (exportPublicKey :
          t ->
            spkac:crypto_BinaryLike -> ?encoding:string -> unit -> Buffer.t_0)
          =
          fun (x155 : t) ->
                     ...
                     Ojs.call (Ojs.get_prop_ascii x156 "exportPublicKey")
                       ...
                       [|x156;((let x153 =
                                ...
                                (match x152 with
                                 ...
                                 | None -> ());
                                x153))|])
        let (verifySpkac : t -> spkac:NodeJS.ArrayBufferView.t_0 -> bool) =
          fun (x158 : t) ->
            fun ~spkac:(x157 : NodeJS.ArrayBufferView.t_0) ->
              Ojs.bool_of_js
                (Ojs.call (t_to_js x158) "verifySpkac"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x157)|])
      end
    let (certificate :
    ...
    module HashOptions =
      struct
        ...
        let (cast : t -> Stream.TransformOptions.t_0) =
          fun (x166 : t) -> Stream.TransformOptions.t_0_of_js (t_to_js x166)
      end
    let (fips : bool) =
      Ojs.bool_of_js
        (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "crypto") "fips")
    let (createHash :
      ...
      fun ~algorithm:(x167 : string) ->
        fun ?options:(x168 : crypto_HashOptions option) ->
          fun () ->
            crypto_Hash_of_js
              (let x171 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    let (createHmac :
      algorithm:string ->
        key:(crypto_BinaryLike, crypto_KeyObject) union2 ->
          ?options:Stream.TransformOptions.t_0 -> unit -> crypto_Hmac)
      =
      fun ~algorithm:(x172 : string) ->
        fun ~key:(x173 : (crypto_BinaryLike, crypto_KeyObject) union2) ->
          fun ?options:(x174 : Stream.TransformOptions.t_0 option) ->
            fun () ->
              crypto_Hmac_of_js
                (let x179 = Ojs.get_prop_ascii Ojs.global "crypto" in
                   ...
                   [|x179;((let x175 =
                            ...
                            (match x174 with
                             | Some x176 ->
                                 ignore
                                   (Ojs.call x175 "push"
                                      [|(Stream.TransformOptions.t_0_to_js
                                           x176)|])
                             | None -> ());
                            x175))|])
    ...
    module Hash =
      struct
        ...
        let (digest : t -> Buffer.t_0) =
          fun (x198 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x198) "digest" [||])
        ...
        let (cast : t -> Stream.Transform.t_0) =
          fun (x201 : t) -> Stream.Transform.t_0_of_js (t_to_js x201)
      end
    module Hmac =
      struct
        type t = crypto_Hmac
        ...
        let (digest : t -> Buffer.t_0) =
          fun (x209 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x209) "digest" [||])
        let (digest' : t -> encoding:crypto_BinaryToTextEncoding -> string) =
          fun (x211 : t) ->
        ...
        let (cast : t -> Stream.Transform.t_0) =
          fun (x212 : t) -> Stream.Transform.t_0_of_js (t_to_js x212)
      end
    ...
    module KeyExportOptions =
      struct
        ...
        let (get_passphrase : 'T t -> Buffer.t_0 or_string) =
          fun (x235 : 'T t) ->
            or_string_of_js Buffer.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js Obj.magic x235) "passphrase")
        let (set_passphrase : 'T t -> Buffer.t_0 or_string -> unit) =
          fun (x238 : 'T t) ->
            fun (x239 : Buffer.t_0 or_string) ->
              Ojs.set_prop_ascii (t_to_js Obj.magic x238) "passphrase"
                (or_string_to_js Buffer.t_0_to_js x239)
      end
    module KeyObject =
      struct
        ...
        let (export :
          t ->
            options:[ `pem ] crypto_KeyExportOptions -> Buffer.t_0 or_string)
          =
          fun (x252 : t) ->
        ...
        let (export' :
          t ->
            ?options:[ `der ] crypto_KeyExportOptions -> unit -> Buffer.t_0)
          =
          fun (x258 : t) ->
    ...
    module CipherCCMOptions =
      struct
        ...
        let (cast : t -> Stream.TransformOptions.t_0) =
          fun (x279 : t) -> Stream.TransformOptions.t_0_of_js (t_to_js x279)
      end
    module CipherGCMOptions =
      struct
        ...
        let (cast : t -> Stream.TransformOptions.t_0) =
          fun (x285 : t) -> Stream.TransformOptions.t_0_of_js (t_to_js x285)
      end
    let (createCipher :
          ...
          fun ?options:(x291 : crypto_CipherGCMOptions option) ->
            fun () ->
              crypto_CipherGCM_of_js
                (let x294 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    let (createCipher :
      algorithm:string ->
        password:crypto_BinaryLike ->
          ?options:Stream.TransformOptions.t_0 -> unit -> crypto_Cipher)
      =
      fun ~algorithm:(x295 : string) ->
        fun ~password:(x296 : crypto_BinaryLike) ->
          fun ?options:(x297 : Stream.TransformOptions.t_0 option) ->
            fun () ->
              crypto_Cipher_of_js
                (let x300 = Ojs.get_prop_ascii Ojs.global "crypto" in
        ...
        fun ~key:(x307 : crypto_CipherKey) ->
          fun ~iv:(x308 : crypto_BinaryLike or_null) ->
            fun ?options:(x309 : crypto_CipherGCMOptions option) ->
              fun () ->
                crypto_CipherGCM_of_js
                  (let x313 = Ojs.get_prop_ascii Ojs.global "crypto" in
      ...
      fun ~algorithm:(x314 : string) ->
        fun ~key:(x315 : crypto_CipherKey) ->
          fun ~iv:(x316 : crypto_BinaryLike or_null) ->
            fun ?options:(x317 : Stream.TransformOptions.t_0 option) ->
              fun () ->
                crypto_Cipher_of_js
                  (let x321 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    module Cipher =
      struct
          ...
          fun () ->
            t_of_js
              (Ojs.new_obj
                 (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "crypto")
                    "Cipher") [||])
        let (update : t -> data:crypto_BinaryLike -> Buffer.t_0) =
          fun (x325 : t) ->
        ...
        let (update' :
          t -> data:string -> input_encoding:crypto_Encoding -> Buffer.t_0) =
          fun (x328 : t) ->
                    ...
                    (Ojs.call (t_to_js x338) "update"
                       [|(Ojs.string_to_js x334);(or_undefined_to_js
                                                    ...
                                                    x335);(crypto_Encoding_to_js
                                                             x337)|])
        let (final : t -> Buffer.t_0) =
          fun (x339 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x339) "final" [||])
        let (final' : t -> output_encoding:BufferEncoding.t_0 -> string) =
          fun (x341 : t) ->
            fun ~output_encoding:(x340 : BufferEncoding.t_0) ->
              Ojs.string_of_js
                (Ojs.call (t_to_js x341) "final"
                   [|(BufferEncoding.t_0_to_js x340)|])
                  ...
                  (let x346 = t_to_js x345 in
                   Ojs.call (Ojs.get_prop_ascii x346 "setAutoPadding")
                     ...
                     [|x346;((let x343 =
                              ...
                              x343))|])
        let (cast : t -> Stream.Transform.t_0) =
          fun (x347 : t) -> Stream.Transform.t_0_of_js (t_to_js x347)
      end
    module CipherCCM =
      struct
        ...
        let (setAAD :
          t ->
            buffer:NodeJS.ArrayBufferView.t_0 ->
              options:anonymous_interface_0 -> t)
          =
          fun (x352 : t) ->
            fun ~buffer:(x350 : NodeJS.ArrayBufferView.t_0) ->
              fun ~options:(x351 : anonymous_interface_0) ->
                t_of_js
                  (Ojs.call (t_to_js x352) "setAAD"
                     [|(NodeJS.ArrayBufferView.t_0_to_js x350);(anonymous_interface_0_to_js
                                                                  x351)|])
        let (getAuthTag : t -> Buffer.t_0) =
          fun (x353 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x353) "getAuthTag" [||])
    ...
    module CipherGCM =
      struct
        ...
        let (setAAD :
          ...
          =
          fun (x361 : t) ->
            fun ~buffer:(x357 : NodeJS.ArrayBufferView.t_0) ->
                    ...
                    (let x362 = t_to_js x361 in
                     Ojs.call (Ojs.get_prop_ascii x362 "setAAD") "apply"
                       [|x362;((let x359 =
                                ...
                                ignore
                                  (Ojs.call x359 "push"
                                     [|(NodeJS.ArrayBufferView.t_0_to_js x357)|]);
                                (match x358 with
                                 | Some x360 ->
                                     ignore
                                       (Ojs.call x359 "push"
        ...
        let (getAuthTag : t -> Buffer.t_0) =
          fun (x363 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x363) "getAuthTag" [||])
        let (cast : t -> crypto_Cipher) =
          ...
          fun ?options:(x370 : crypto_CipherGCMOptions option) ->
            fun () ->
              crypto_DecipherGCM_of_js
                (let x373 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    let (createDecipher :
      algorithm:string ->
        password:crypto_BinaryLike ->
          ?options:Stream.TransformOptions.t_0 -> unit -> crypto_Decipher)
      =
      fun ~algorithm:(x374 : string) ->
        fun ~password:(x375 : crypto_BinaryLike) ->
          fun ?options:(x376 : Stream.TransformOptions.t_0 option) ->
            fun () ->
              crypto_Decipher_of_js
                (let x379 = Ojs.get_prop_ascii Ojs.global "crypto" in
        ...
        fun ~key:(x386 : crypto_CipherKey) ->
          fun ~iv:(x387 : crypto_BinaryLike or_null) ->
            fun ?options:(x388 : crypto_CipherGCMOptions option) ->
              fun () ->
                crypto_DecipherGCM_of_js
                  (let x392 = Ojs.get_prop_ascii Ojs.global "crypto" in
      ...
      fun ~algorithm:(x393 : string) ->
        fun ~key:(x394 : crypto_CipherKey) ->
          fun ~iv:(x395 : crypto_BinaryLike or_null) ->
            fun ?options:(x396 : Stream.TransformOptions.t_0 option) ->
              fun () ->
                crypto_Decipher_of_js
                  (let x400 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    module Decipher =
      struct
          ...
          fun () ->
            t_of_js
              (Ojs.new_obj
                 (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "crypto")
                    "Decipher") [||])
        let (update : t -> data:NodeJS.ArrayBufferView.t_0 -> Buffer.t_0) =
          fun (x404 : t) ->
            fun ~data:(x403 : NodeJS.ArrayBufferView.t_0) ->
              Buffer.t_0_of_js
                (Ojs.call (t_to_js x404) "update"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x403)|])
        let (update' :
          t -> data:string -> input_encoding:crypto_Encoding -> Buffer.t_0) =
          fun (x407 : t) ->
        ...
        let (final : t -> Buffer.t_0) =
          fun (x418 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x418) "final" [||])
        let (final' : t -> output_encoding:BufferEncoding.t_0 -> string) =
          fun (x420 : t) ->
            fun ~output_encoding:(x419 : BufferEncoding.t_0) ->
              Ojs.string_of_js
                (Ojs.call (t_to_js x420) "final"
                   [|(BufferEncoding.t_0_to_js x419)|])
        let (setAutoPadding : t -> ?auto_padding:bool -> unit -> t) =
          fun (x424 : t) ->
                  ...
                  (let x425 = t_to_js x424 in
                   Ojs.call (Ojs.get_prop_ascii x425 "setAutoPadding")
                     ...
                     [|x425;((let x422 =
                              ...
                              x422))|])
        let (cast : t -> Stream.Transform.t_0) =
          fun (x426 : t) -> Stream.Transform.t_0_of_js (t_to_js x426)
      end
    module DecipherCCM =
      struct
        ...
        let (setAuthTag : t -> buffer:NodeJS.ArrayBufferView.t_0 -> t) =
          fun (x430 : t) ->
            fun ~buffer:(x429 : NodeJS.ArrayBufferView.t_0) ->
              t_of_js
                (Ojs.call (t_to_js x430) "setAuthTag"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x429)|])
        let (setAAD :
          t ->
            buffer:NodeJS.ArrayBufferView.t_0 ->
              options:anonymous_interface_0 -> t)
          =
          fun (x433 : t) ->
            fun ~buffer:(x431 : NodeJS.ArrayBufferView.t_0) ->
              fun ~options:(x432 : anonymous_interface_0) ->
                t_of_js
                  (Ojs.call (t_to_js x433) "setAAD"
                     [|(NodeJS.ArrayBufferView.t_0_to_js x431);(anonymous_interface_0_to_js
                                                                  x432)|])
    ...
    module DecipherGCM =
      struct
        ...
        let (setAuthTag : t -> buffer:NodeJS.ArrayBufferView.t_0 -> t) =
          fun (x438 : t) ->
            fun ~buffer:(x437 : NodeJS.ArrayBufferView.t_0) ->
              t_of_js
                (Ojs.call (t_to_js x438) "setAuthTag"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x437)|])
        let (setAAD :
          t ->
            buffer:NodeJS.ArrayBufferView.t_0 ->
              ?options:anonymous_interface_0 -> unit -> t)
          =
          fun (x443 : t) ->
            fun ~buffer:(x439 : NodeJS.ArrayBufferView.t_0) ->
                    ...
                    (let x444 = t_to_js x443 in
                     Ojs.call (Ojs.get_prop_ascii x444 "setAAD") "apply"
                       [|x444;((let x441 =
                                ...
                                ignore
                                  (Ojs.call x441 "push"
                                     [|(NodeJS.ArrayBufferView.t_0_to_js x439)|]);
                                (match x440 with
                                 | Some x442 ->
                                     ignore
                                       (Ojs.call x441 "push"
    ...
    module PrivateKeyInput =
      struct
        ...
        let (get_key : t -> Buffer.t_0 or_string) =
          fun (x448 : t) ->
            or_string_of_js Buffer.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x448) "key")
        let (set_key : t -> Buffer.t_0 or_string -> unit) =
          fun (x450 : t) ->
            fun (x451 : Buffer.t_0 or_string) ->
              Ojs.set_prop_ascii (t_to_js x450) "key"
                (or_string_to_js Buffer.t_0_to_js x451)
            ...
            fun (x459 : [ `pkcs1  | `pkcs8  | `sec1 ]) ->
              Ojs.set_prop_ascii (t_to_js x458) "type"
                (match x459 with
                 ...
                 | `pkcs8 -> Ojs.string_to_js "pkcs8"
                 | `sec1 -> Ojs.string_to_js "sec1")
        let (get_passphrase : t -> Buffer.t_0 or_string) =
          fun (x460 : t) ->
            or_string_of_js Buffer.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x460) "passphrase")
        let (set_passphrase : t -> Buffer.t_0 or_string -> unit) =
          fun (x462 : t) ->
            fun (x463 : Buffer.t_0 or_string) ->
              Ojs.set_prop_ascii (t_to_js x462) "passphrase"
                (or_string_to_js Buffer.t_0_to_js x463)
      end
    module PublicKeyInput =
      struct
        ...
        let (set_key : t -> Buffer.t_0 or_string -> unit) =
          fun (x469 : t) ->
            fun (x470 : Buffer.t_0 or_string) ->
              Ojs.set_prop_ascii (t_to_js x469) "key"
                (or_string_to_js Buffer.t_0_to_js x470)
        let (get_format : t -> crypto_KeyFormat) =
          fun (x472 : t) ->
            crypto_KeyFormat_of_js
    ...
    let (createPrivateKey :
      key:(Buffer.t_0, crypto_PrivateKeyInput) union2 or_string ->
        crypto_KeyObject)
      =
      fun ~key:(x479 : (Buffer.t_0, crypto_PrivateKeyInput) union2 or_string)
        ->
        crypto_KeyObject_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
             "createPrivateKey"
             [|(or_string_to_js
                  (fun (x480 : (Buffer.t_0, crypto_PrivateKeyInput) union2)
                     ->
                     union2_to_js Buffer.t_0_to_js
                       crypto_PrivateKeyInput_to_js x480) x479)|])
    let (createPublicKey :
      key:([ `U_s21_pkcs1 of crypto_PublicKeyInput 
        ...
        Buffer.t_0) or_ or_string -> crypto_KeyObject)
      =
      fun
        ~key:(x483 :
               ([ `U_s21_pkcs1 of crypto_PublicKeyInput 
                ...
                | `U_s24_public of crypto_KeyObject 
                | `U_s27_secret of crypto_KeyObject 
                | `U_s28_spki of crypto_PublicKeyInput ], Buffer.t_0) or_
                 or_string)
        ->
        crypto_KeyObject_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
                  ...
                  (fun
                     (x484 :
                       ([ `U_s21_pkcs1 of crypto_PublicKeyInput 
                        ...
                        | `U_s24_public of crypto_KeyObject 
                        | `U_s27_secret of crypto_KeyObject 
                        | `U_s28_spki of crypto_PublicKeyInput ], Buffer.t_0)
                         or_)
                     ->
                     or__to_js
                       (fun
                       ...
                       Buffer.t_0_to_js x484) x483)|])
    let (createSecretKey :
      key:NodeJS.ArrayBufferView.t_0 -> crypto_KeyObject) =
      fun ~key:(x492 : NodeJS.ArrayBufferView.t_0) ->
        crypto_KeyObject_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
             "createSecretKey" [|(NodeJS.ArrayBufferView.t_0_to_js x492)|])
    let (createSign :
      algorithm:string ->
        ?options:Stream.WritableOptions.t_0 -> unit -> crypto_Signer)
      =
      fun ~algorithm:(x493 : string) ->
        fun ?options:(x494 : Stream.WritableOptions.t_0 option) ->
          fun () ->
            crypto_Signer_of_js
              (let x497 = Ojs.get_prop_ascii Ojs.global "crypto" in
                 ...
                 [|x497;((let x495 =
                          ...
                          (match x494 with
                           | Some x496 ->
                               ignore
                                 (Ojs.call x495 "push"
                                    [|(Stream.WritableOptions.t_0_to_js x496)|])
                           | None -> ());
                          x495))|])
    module DSAEncoding =
      struct
    ...
    module Signer =
      struct
        ...
        let (sign :
          t ->
            private_key:([ `U_s11_der of crypto_SignKeyObjectInput 
              ...
              | `U_s27_secret of crypto_KeyLike ]) union2 -> Buffer.t_0)
          =
          fun (x551 : t) ->
            fun
              ~private_key:(x540 :
        ...
        let (cast : t -> Stream.Writable.t_0) =
          fun (x565 : t) -> Stream.Writable.t_0_of_js (t_to_js x565)
      end
    let (createVerify :
      algorithm:string ->
        ?options:Stream.WritableOptions.t_0 -> unit -> crypto_Verify)
      =
      fun ~algorithm:(x566 : string) ->
        fun ?options:(x567 : Stream.WritableOptions.t_0 option) ->
          fun () ->
            crypto_Verify_of_js
              (let x570 = Ojs.get_prop_ascii Ojs.global "crypto" in
                 ...
                 [|x570;((let x568 =
                          ...
                          (match x567 with
                           | Some x569 ->
                               ignore
                                 (Ojs.call x568 "push"
                                    [|(Stream.WritableOptions.t_0_to_js x569)|])
                           | None -> ());
                          x568))|])
    module Verify =
      struct
        ...
        let (verify :
          t ->
            object_:([ `U_s11_der of crypto_VerifyKeyObjectInput 
              ...
              signature:NodeJS.ArrayBufferView.t_0 -> bool)
          =
          fun (x589 : t) ->
            fun
              ~object_:(x578 :
                         ([ `U_s11_der of crypto_VerifyKeyObjectInput 
                          | `U_s18_ieee_p1363 of crypto_VerifyKeyObjectInput ],
                           ...
                           union2)
              ->
              fun ~signature:(x588 : NodeJS.ArrayBufferView.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x589) "verify"
                     [|(union2_to_js
                       ...
                       NodeJS.ArrayBufferView.t_0_to_js x588)|])
        let (verify' :
          t ->
            object_:([ `U_s11_der of crypto_VerifyKeyObjectInput 
                     | `U_s18_ieee_p1363 of crypto_VerifyKeyObjectInput ],
                      ...
                      (let x605 = t_to_js x604 in
                       Ojs.call (Ojs.get_prop_ascii x605 "verify") "apply"
                         [|x605;((let x593 =
                                  ...
                                  x593))|])
        let (cast : t -> Stream.Writable.t_0) =
          fun (x606 : t) -> Stream.Writable.t_0_of_js (t_to_js x606)
      end
    let (createDiffieHellman :
      ...
      fun ~prime_length:(x607 : float) ->
        fun ?generator:(x608 : NodeJS.ArrayBufferView.t_0 or_number option)
          ->
          fun () ->
            crypto_DiffieHellman_of_js
              (let x612 = Ojs.get_prop_ascii Ojs.global "crypto" in
               Ojs.call (Ojs.get_prop_ascii x612 "createDiffieHellman")
                 ...
                 [|x612;((let x609 =
                          ...
                          x609))|])
    let (createDiffieHellman :
      prime:NodeJS.ArrayBufferView.t_0 -> crypto_DiffieHellman) =
      fun ~prime:(x613 : NodeJS.ArrayBufferView.t_0) ->
        crypto_DiffieHellman_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
             "createDiffieHellman"
             [|(NodeJS.ArrayBufferView.t_0_to_js x613)|])
    let (createDiffieHellman :
      prime:string ->
    ...
    let (createDiffieHellman :
      ...
      fun ~prime:(x616 : string) ->
        fun ~prime_encoding:(x617 : crypto_BinaryToTextEncoding) ->
          fun ~generator:(x618 : NodeJS.ArrayBufferView.t_0 or_number) ->
            crypto_DiffieHellman_of_js
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
                 "createDiffieHellman"
    ...
    module DiffieHellman =
      struct
          ...
          fun () ->
            t_of_js
              (Ojs.new_obj
                 (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "crypto")
                    "DiffieHellman") [||])
        let (generateKeys : t -> Buffer.t_0) =
          fun (x626 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x626) "generateKeys" [||])
        let (generateKeys' :
        ...
        let (computeSecret :
          t -> other_public_key:NodeJS.ArrayBufferView.t_0 -> Buffer.t_0) =
          fun (x630 : t) ->
            fun ~other_public_key:(x629 : NodeJS.ArrayBufferView.t_0) ->
              Buffer.t_0_of_js
                (Ojs.call (t_to_js x630) "computeSecret"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x629)|])
        let (computeSecret' :
          t ->
            other_public_key:string ->
              input_encoding:crypto_BinaryToTextEncoding -> Buffer.t_0)
          =
          fun (x633 : t) ->
        ...
        let (computeSecret'' :
          ...
          =
          fun (x636 : t) ->
            fun ~other_public_key:(x634 : NodeJS.ArrayBufferView.t_0) ->
              fun ~output_encoding:(x635 : crypto_BinaryToTextEncoding) ->
                Ojs.string_of_js
                  (Ojs.call (t_to_js x636) "computeSecret"
                     [|(NodeJS.ArrayBufferView.t_0_to_js x634);(crypto_BinaryToTextEncoding_to_js
                                                                  x635)|])
        let (computeSecret''' :
          t ->
            other_public_key:string ->
                    ...
                    (Ojs.call (t_to_js x640) "computeSecret"
                       [|(Ojs.string_to_js x637);(crypto_BinaryToTextEncoding_to_js
                                                    x638);(crypto_BinaryToTextEncoding_to_js
                                                             x639)|])
        let (getPrime : t -> Buffer.t_0) =
          fun (x641 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x641) "getPrime" [||])
        ...
        let (getGenerator : t -> Buffer.t_0) =
          fun (x644 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x644) "getGenerator" [||])
        let (getGenerator' :
          t -> encoding:crypto_BinaryToTextEncoding -> string) =
          fun (x646 : t) ->
        ...
        let (getPublicKey : t -> Buffer.t_0) =
          fun (x647 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x647) "getPublicKey" [||])
        let (getPublicKey' :
          t -> encoding:crypto_BinaryToTextEncoding -> string) =
          fun (x649 : t) ->
        ...
        let (getPrivateKey : t -> Buffer.t_0) =
          fun (x650 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x650) "getPrivateKey" [||])
        let (getPrivateKey' :
          t -> encoding:crypto_BinaryToTextEncoding -> string) =
          fun (x652 : t) ->
        ...
        let (setPublicKey :
          t -> public_key:NodeJS.ArrayBufferView.t_0 -> unit) =
          fun (x654 : t) ->
            fun ~public_key:(x653 : NodeJS.ArrayBufferView.t_0) ->
              ignore
                (Ojs.call (t_to_js x654) "setPublicKey"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x653)|])
        let (setPublicKey' :
          t -> public_key:string -> encoding:BufferEncoding.t_0 -> unit) =
          fun (x657 : t) ->
            fun ~public_key:(x655 : string) ->
              fun ~encoding:(x656 : BufferEncoding.t_0) ->
                ignore
                  (Ojs.call (t_to_js x657) "setPublicKey"
                     [|(Ojs.string_to_js x655);(BufferEncoding.t_0_to_js x656)|])
        let (setPrivateKey :
          t -> private_key:NodeJS.ArrayBufferView.t_0 -> unit) =
          fun (x659 : t) ->
            fun ~private_key:(x658 : NodeJS.ArrayBufferView.t_0) ->
              ignore
                (Ojs.call (t_to_js x659) "setPrivateKey"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x658)|])
        let (setPrivateKey' :
          t -> private_key:string -> encoding:BufferEncoding.t_0 -> unit) =
          fun (x662 : t) ->
            fun ~private_key:(x660 : string) ->
              fun ~encoding:(x661 : BufferEncoding.t_0) ->
                ignore
                  (Ojs.call (t_to_js x662) "setPrivateKey"
                     [|(Ojs.string_to_js x660);(BufferEncoding.t_0_to_js x661)|])
    ...
    let (getDiffieHellman : group_name:string -> crypto_DiffieHellman) =
      fun ~group_name:(x666 : string) ->
        crypto_DiffieHellman_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
             "getDiffieHellman" [|(Ojs.string_to_js x666)|])
    let (pbkdf2 :
      password:crypto_BinaryLike ->
                         ...
                         Ojs.fun_to_js 2
                           (fun (x673 : Ojs.t) ->
                              fun (x675 : Ojs.t) ->
                                any_to_js
                                  (x672
                                     ~err:(or_null_of_js Error.t_0_of_js x673)
                                     ~derivedKey:(Buffer.t_0_of_js x675))))|])
    let (pbkdf2Sync :
      password:crypto_BinaryLike ->
        salt:crypto_BinaryLike ->
          iterations:float -> keylen:float -> digest:string -> Buffer.t_0)
      =
    ...
    let (randomBytes : size:float -> Buffer.t_0) =
      fun ~size:(x681 : float) ->
        Buffer.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "randomBytes"
             [|(Ojs.float_to_js x681)|])
    let (randomBytes :
      size:float ->
        callback:(err:Error.t_0 or_null -> buf:Buffer.t_0 -> unit) -> unit)
      =
      fun ~size:(x682 : float) ->
        fun
          ~callback:(x683 : err:Error.t_0 or_null -> buf:Buffer.t_0 -> unit)
          ->
          ignore
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "randomBytes"
                                              ...
                                              fun (x686 : Ojs.t) ->
                                                x683
                                                  ~err:(or_null_of_js
                                                          Error.t_0_of_js
                                                          x684)
                                                  ~buf:(Buffer.t_0_of_js x686)))|])
    let (pseudoRandomBytes : size:float -> Buffer.t_0) =
      fun ~size:(x687 : float) ->
        Buffer.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
             "pseudoRandomBytes" [|(Ojs.float_to_js x687)|])
    let (pseudoRandomBytes :
      ...
      fun ~size:(x688 : float) ->
        fun
          ~callback:(x689 : err:Error.t_0 or_null -> buf:Buffer.t_0 -> unit)
          ->
          ignore
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
               "pseudoRandomBytes"
                                              ...
                                              fun (x692 : Ojs.t) ->
                                                x689
                                                  ~err:(or_null_of_js
                                                          Error.t_0_of_js
                                                          x690)
                                                  ~buf:(Buffer.t_0_of_js x692)))|])
    let (randomInt : max:float -> float) =
      fun ~max:(x693 : float) ->
        Ojs.float_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "randomInt"
    ...
    let (randomInt :
      max:float ->
        callback:(err:Error.t_0 or_null -> value:float -> unit) -> unit)
      =
      fun ~max:(x696 : float) ->
        fun ~callback:(x697 : err:Error.t_0 or_null -> value:float -> unit)
          ->
          ignore
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "randomInt"
    ...
    let (randomInt :
      ...
      fun ~min:(x701 : float) ->
        fun ~max:(x702 : float) ->
          fun ~callback:(x703 : err:Error.t_0 or_null -> value:float -> unit)
            ->
            ignore
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "randomInt"
      ...
      fun ~buffer:(x707 : 'T) ->
        fun ?offset:(x708 : float option) ->
          fun ?size:(x709 : float option) ->
            fun () ->
              Obj.magic
                (let x713 = Ojs.get_prop_ascii Ojs.global "crypto" in
                 Ojs.call (Ojs.get_prop_ascii x713 "randomFillSync") "apply"
                   [|x713;((let x710 =
                            ...
                            x710))|])
    let (randomFill :
      buffer:'T -> callback:(err:Error.t_0 or_null -> buf:'T -> unit) -> unit)
      =
      fun ~buffer:(x714 : 'T) ->
        fun ~callback:(x715 : err:Error.t_0 or_null -> buf:'T -> unit) ->
          ignore
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "randomFill"
               [|(Obj.magic x714);(Ojs.fun_to_js 2
                                     (fun (x716 : Ojs.t) ->
                                        fun (x718 : Ojs.t) ->
                                          x715
                                            ~err:(or_null_of_js
                                                    Error.t_0_of_js x716)
                                            ~buf:(Obj.magic x718)))|])
    let (randomFill :
      buffer:'T ->
        offset:float ->
          callback:(err:Error.t_0 or_null -> buf:'T -> unit) -> unit)
      =
      fun ~buffer:(x719 : 'T) ->
        fun ~offset:(x720 : float) ->
          fun ~callback:(x721 : err:Error.t_0 or_null -> buf:'T -> unit) ->
            ignore
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "randomFill"
    ...
    let (randomFill :
      ...
      fun ~buffer:(x725 : 'T) ->
        fun ~offset:(x726 : float) ->
          fun ~size:(x727 : float) ->
            fun ~callback:(x728 : err:Error.t_0 or_null -> buf:'T -> unit) ->
              ignore
                (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
                   "randomFill"
                   [|(Obj.magic x725);(Ojs.float_to_js x726);(Ojs.float_to_js
                     ...
                     Ojs.fun_to_js 2
                       (fun (x729 : Ojs.t) ->
                          fun (x731 : Ojs.t) ->
                            x728 ~err:(or_null_of_js Error.t_0_of_js x729)
                              ~buf:(Obj.magic x731)))|])
        ...
        fun ~salt:(x756 : crypto_BinaryLike) ->
          fun ~keylen:(x757 : float) ->
            fun
              ~callback:(x758 :
                          err:Error.t_0 or_null ->
                            derivedKey:Buffer.t_0 -> unit)
              ->
              ignore
                (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "scrypt"
                   [|(crypto_BinaryLike_to_js x755);(crypto_BinaryLike_to_js
                     ...
                     Ojs.fun_to_js 2
                       (fun (x759 : Ojs.t) ->
                          fun (x761 : Ojs.t) ->
                            x758 ~err:(or_null_of_js Error.t_0_of_js x759)
                              ~derivedKey:(Buffer.t_0_of_js x761)))|])
    let (scrypt :
      password:crypto_BinaryLike ->
        salt:crypto_BinaryLike ->
          keylen:float ->
    ...
    let (scryptSync :
      password:crypto_BinaryLike ->
        salt:crypto_BinaryLike ->
          keylen:float -> ?options:crypto_ScryptOptions -> unit -> Buffer.t_0)
      =
        ...
        fun ~salt:(x771 : crypto_BinaryLike) ->
          fun ~keylen:(x772 : float) ->
            fun ?options:(x773 : crypto_ScryptOptions option) ->
              fun () ->
                Buffer.t_0_of_js
                  (let x776 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    module RsaPrivateKey =
      struct
        ...
        let (get_oaepLabel : t -> NodeJS.TypedArray.t) =
          fun (x796 : t) ->
            NodeJS.TypedArray.t_of_js
              (Ojs.get_prop_ascii (t_to_js x796) "oaepLabel")
        let (set_oaepLabel : t -> NodeJS.TypedArray.t -> unit) =
          fun (x797 : t) ->
            fun (x798 : NodeJS.TypedArray.t) ->
              Ojs.set_prop_ascii (t_to_js x797) "oaepLabel"
                (NodeJS.TypedArray.t_to_js x798)
        let (get_padding : t -> float) =
          fun (x799 : t) ->
    ...
    let (publicEncrypt :
      key:(crypto_KeyLike, crypto_RsaPrivateKey, crypto_RsaPublicKey) union3
        -> buffer:NodeJS.ArrayBufferView.t_0 -> Buffer.t_0)
      =
      fun
        ~key:(x802 :
      ...
      fun
        ~key:(x807 :
               (crypto_KeyLike, crypto_RsaPrivateKey, crypto_RsaPublicKey)
                 union3)
        ->
        fun ~buffer:(x811 : NodeJS.ArrayBufferView.t_0) ->
          Buffer.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
               "publicDecrypt"
               [|(union3_to_js crypto_KeyLike_to_js
                    crypto_RsaPrivateKey_to_js crypto_RsaPublicKey_to_js x807);(
                 NodeJS.ArrayBufferView.t_0_to_js x811)|])
    let (privateDecrypt :
      ...
      fun ~private_key:(x812 : (crypto_KeyLike, crypto_RsaPrivateKey) union2)
        ->
        fun ~buffer:(x815 : NodeJS.ArrayBufferView.t_0) ->
          Buffer.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
               "privateDecrypt"
               [|(union2_to_js crypto_KeyLike_to_js
                    crypto_RsaPrivateKey_to_js x812);(NodeJS.ArrayBufferView.t_0_to_js
                                                        x815)|])
    let (privateEncrypt :
      private_key:(crypto_KeyLike, crypto_RsaPrivateKey) union2 ->
        buffer:NodeJS.ArrayBufferView.t_0 -> Buffer.t_0)
      ...
      fun ~private_key:(x816 : (crypto_KeyLike, crypto_RsaPrivateKey) union2)
        ->
        fun ~buffer:(x819 : NodeJS.ArrayBufferView.t_0) ->
          Buffer.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
               "privateEncrypt"
               [|(union2_to_js crypto_KeyLike_to_js
                    crypto_RsaPrivateKey_to_js x816);(NodeJS.ArrayBufferView.t_0_to_js
                                                        x819)|])
    let (getCiphers : unit -> string list) =
      fun () ->
        Ojs.list_of_js Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "getCiphers"
             [||])
    let (getCurves : unit -> string list) =
      fun () ->
        Ojs.list_of_js Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "getCurves" [||])
    let (getFips : unit -> [ `L_n_0  | `L_n_1 ]) =
      fun () ->
        let x822 =
          Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "getFips" [||] in
    ...
    let (getHashes : unit -> string list) =
      fun () ->
        Ojs.list_of_js Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "getHashes" [||])
    module ECDH =
      struct
        type t = crypto_ECDH
        let rec t_of_js : Ojs.t -> t =
                  ...
                  fun
                    ...
                    fun () ->
                      or_string_of_js Buffer.t_0_of_js
                        (let x835 =
                           Ojs.get_prop_ascii
                             (Ojs.get_prop_ascii Ojs.global "crypto") "ECDH" in
        ...
        let (generateKeys : t -> Buffer.t_0) =
          fun (x837 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x837) "generateKeys" [||])
        let (generateKeys' :
          t ->
        ...
        let (computeSecret :
          t -> other_public_key:NodeJS.ArrayBufferView.t_0 -> Buffer.t_0) =
          fun (x845 : t) ->
            fun ~other_public_key:(x844 : NodeJS.ArrayBufferView.t_0) ->
              Buffer.t_0_of_js
                (Ojs.call (t_to_js x845) "computeSecret"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x844)|])
        let (computeSecret' :
          t ->
            other_public_key:string ->
              input_encoding:crypto_BinaryToTextEncoding -> Buffer.t_0)
        ...
        let (computeSecret'' :
          ...
          =
          fun (x851 : t) ->
            fun ~other_public_key:(x849 : NodeJS.ArrayBufferView.t_0) ->
              fun ~output_encoding:(x850 : crypto_BinaryToTextEncoding) ->
                Ojs.string_of_js
                  (Ojs.call (t_to_js x851) "computeSecret"
                     [|(NodeJS.ArrayBufferView.t_0_to_js x849);(crypto_BinaryToTextEncoding_to_js
                                                                  x850)|])
        let (computeSecret''' :
          t ->
            other_public_key:string ->
        ...
        let (getPrivateKey : t -> Buffer.t_0) =
          fun (x856 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x856) "getPrivateKey" [||])
        let (getPrivateKey' :
          t -> encoding:crypto_BinaryToTextEncoding -> string) =
          fun (x858 : t) ->
        ...
        let (getPublicKey : t -> Buffer.t_0) =
          fun (x859 : t) ->
            Buffer.t_0_of_js (Ojs.call (t_to_js x859) "getPublicKey" [||])
        let (getPublicKey' :
          t ->
            encoding:crypto_BinaryToTextEncoding ->
              ?format:crypto_ECDHKeyFormat -> unit -> string)
        ...
        let (setPrivateKey :
          t -> private_key:NodeJS.ArrayBufferView.t_0 -> unit) =
          fun (x867 : t) ->
            fun ~private_key:(x866 : NodeJS.ArrayBufferView.t_0) ->
              ignore
                (Ojs.call (t_to_js x867) "setPrivateKey"
                   [|(NodeJS.ArrayBufferView.t_0_to_js x866)|])
        let (setPrivateKey' :
          t ->
            private_key:string ->
    ...
    let (createECDH : curve_name:string -> crypto_ECDH) =
      fun ~curve_name:(x871 : string) ->
        crypto_ECDH_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "createECDH"
             [|(Ojs.string_to_js x871)|])
    let (timingSafeEqual :
      a:NodeJS.ArrayBufferView.t_0 -> b:NodeJS.ArrayBufferView.t_0 -> bool) =
      fun ~a:(x872 : NodeJS.ArrayBufferView.t_0) ->
        fun ~b:(x873 : NodeJS.ArrayBufferView.t_0) ->
          Ojs.bool_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
               "timingSafeEqual"
               [|(NodeJS.ArrayBufferView.t_0_to_js x872);(NodeJS.ArrayBufferView.t_0_to_js
                                                            x873)|])
    let (dEFAULT_ENCODING : BufferEncoding.t_0) =
    ...
    let (generateKeyPairSync :
      ...
      fun ~type_:(x1177 : [ `rsa ]) ->
        fun ~options:(x1178 : ([ `pem ], [ `der ]) crypto_RSAKeyPairOptions)
          ->
          crypto_KeyPairSyncResult_of_js Ojs.string_of_js Buffer.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
               "generateKeyPairSync"
    ...
    let (generateKeyPairSync :
      ...
      fun ~type_:(x1183 : [ `rsa ]) ->
        fun ~options:(x1184 : ([ `der ], [ `pem ]) crypto_RSAKeyPairOptions)
          ->
          crypto_KeyPairSyncResult_of_js Buffer.t_0_of_js Ojs.string_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
               "generateKeyPairSync"
    ...
    let (generateKeyPairSync :
      ...
      fun ~type_:(x1189 : [ `rsa ]) ->
        fun ~options:(x1190 : ([ `der ], [ `der ]) crypto_RSAKeyPairOptions)
          ->
          crypto_KeyPairSyncResult_of_js Buffer.t_0_of_js Buffer.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto")
               "generateKeyPairSync"
    ...
    let (generateKeyPairSync :
      ...
      fun ~type_:(x1273 : [ `ed25519 ]) ->
        fun ?options:(x1274 : crypto_ED25519KeyPairKeyObjectOptions option)
          ...
          fun () ->
            crypto_KeyPairKeyObjectResult_of_js
              (let x1277 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    let (generateKeyPairSync :
      ...
      fun ~type_:(x1302 : [ `ed448 ]) ->
        fun ?options:(x1303 : crypto_ED448KeyPairKeyObjectOptions option) ->
          fun () ->
            crypto_KeyPairKeyObjectResult_of_js
              (let x1306 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    let (generateKeyPairSync :
      ...
      fun ~type_:(x1331 : [ `x25519 ]) ->
        fun ?options:(x1332 : crypto_X25519KeyPairKeyObjectOptions option) ->
          fun () ->
            crypto_KeyPairKeyObjectResult_of_js
              (let x1335 = Ojs.get_prop_ascii Ojs.global "crypto" in
    ...
    let (generateKeyPairSync :
      ...
      fun ~type_:(x1360 : [ `x448 ]) ->
        fun ?options:(x1361 : crypto_X448KeyPairKeyObjectOptions option) ->
          fun () ->
            crypto_KeyPairKeyObjectResult_of_js
              (let x1364 = Ojs.get_prop_ascii Ojs.global "crypto" in
                     ...
                     x1366);(Ojs.fun_to_js 3
                               (fun (x1370 : Ojs.t) ->
                                  fun (x1372 : Ojs.t) ->
                                    fun (x1373 : Ojs.t) ->
                                      x1369
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1370)
    ...
    let (generateKeyPair :
      type_:[ `rsa ] ->
        options:([ `pem ], [ `der ]) crypto_RSAKeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                      publicKey:string -> privateKey:Buffer.t_0 -> unit)
            -> unit)
      =
      fun ~type_:(x1374 : [ `rsa ]) ->
                                  ...
                                  fun (x1381 : Ojs.t) ->
                                    fun (x1382 : Ojs.t) ->
                                      x1378
                                        ...
                                        ~privateKey:(Buffer.t_0_of_js x1382)))|])
    let (generateKeyPair :
      type_:[ `rsa ] ->
        options:([ `der ], [ `pem ]) crypto_RSAKeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                      publicKey:Buffer.t_0 -> privateKey:string -> unit)
            -> unit)
      =
      fun ~type_:(x1383 : [ `rsa ]) ->
                                  ...
                                  fun (x1390 : Ojs.t) ->
                                    fun (x1391 : Ojs.t) ->
                                      x1387
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1388)
                                        ~publicKey:(Buffer.t_0_of_js x1390)
                                        ~privateKey:(Ojs.string_of_js x1391)))|])
    let (generateKeyPair :
      type_:[ `rsa ] ->
        options:([ `der ], [ `der ]) crypto_RSAKeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                      publicKey:Buffer.t_0 -> privateKey:Buffer.t_0 -> unit)
            -> unit)
      =
      fun ~type_:(x1392 : [ `rsa ]) ->
                                  ...
                                  fun (x1399 : Ojs.t) ->
                                    fun (x1400 : Ojs.t) ->
                                      x1396
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1397)
                                        ~publicKey:(Buffer.t_0_of_js x1399)
                                        ~privateKey:(Buffer.t_0_of_js x1400)))|])
    let (generateKeyPair :
      type_:[ `rsa ] ->
        options:crypto_RSAKeyPairKeyObjectOptions ->
          callback:(err:Error.t_0 or_null ->
                                  ...
                                  fun (x1424 : Ojs.t) ->
                                    fun (x1425 : Ojs.t) ->
                                      x1421
                                        ...
                                        ~privateKey:(Buffer.t_0_of_js x1425)))|])
    let (generateKeyPair :
      type_:[ `dsa ] ->
        options:([ `der ], [ `pem ]) crypto_DSAKeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                                  ...
                                  fun (x1433 : Ojs.t) ->
                                    fun (x1434 : Ojs.t) ->
                                      x1430
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1431)
                                        ~publicKey:(Buffer.t_0_of_js x1433)
                                  ...
                                  fun (x1442 : Ojs.t) ->
                                    fun (x1443 : Ojs.t) ->
                                      x1439
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1440)
                                        ~publicKey:(Buffer.t_0_of_js x1442)
                                        ~privateKey:(Buffer.t_0_of_js x1443)))|])
    let (generateKeyPair :
      type_:[ `dsa ] ->
        options:crypto_DSAKeyPairKeyObjectOptions ->
          callback:(err:Error.t_0 or_null ->
                                  ...
                                  fun (x1467 : Ojs.t) ->
                                    fun (x1468 : Ojs.t) ->
                                      x1464
                                        ...
                                        ~privateKey:(Buffer.t_0_of_js x1468)))|])
    let (generateKeyPair :
      type_:[ `ec ] ->
        options:([ `der ], [ `pem ]) crypto_ECKeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                                  ...
                                  fun (x1476 : Ojs.t) ->
                                    fun (x1477 : Ojs.t) ->
                                      x1473
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1474)
                                        ~publicKey:(Buffer.t_0_of_js x1476)
                                  ...
                                  fun (x1485 : Ojs.t) ->
                                    fun (x1486 : Ojs.t) ->
                                      x1482
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1483)
                                        ~publicKey:(Buffer.t_0_of_js x1485)
                                        ~privateKey:(Buffer.t_0_of_js x1486)))|])
    let (generateKeyPair :
      type_:[ `ec ] ->
        options:crypto_ECKeyPairKeyObjectOptions ->
          callback:(err:Error.t_0 or_null ->
                 ...
                 [|((match x1494 with
                   ...
                   Ojs.fun_to_js 3
                     (fun (x1499 : Ojs.t) ->
                        fun (x1501 : Ojs.t) ->
                          fun (x1502 : Ojs.t) ->
                            x1498 ~err:(or_null_of_js Error.t_0_of_js x1499)
                 ...
                 [|((match x1503 with
                   ...
                   Ojs.fun_to_js 3
                     (fun (x1508 : Ojs.t) ->
                        fun (x1510 : Ojs.t) ->
                          fun (x1511 : Ojs.t) ->
                            x1507 ~err:(or_null_of_js Error.t_0_of_js x1508)
                              ~publicKey:(Ojs.string_of_js x1510)
                              ~privateKey:(Buffer.t_0_of_js x1511)))|])
    let (generateKeyPair :
      type_:[ `ed25519 ] ->
        options:([ `der ], [ `pem ]) crypto_ED25519KeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                 ...
                 [|((match x1512 with
                   ...
                   Ojs.fun_to_js 3
                     (fun (x1517 : Ojs.t) ->
                        fun (x1519 : Ojs.t) ->
                          fun (x1520 : Ojs.t) ->
                            x1516 ~err:(or_null_of_js Error.t_0_of_js x1517)
                              ~publicKey:(Buffer.t_0_of_js x1519)
                 ...
                 [|((match x1521 with
                   ...
                   Ojs.fun_to_js 3
                     (fun (x1526 : Ojs.t) ->
                        fun (x1528 : Ojs.t) ->
                          fun (x1529 : Ojs.t) ->
                            x1525 ~err:(or_null_of_js Error.t_0_of_js x1526)
                              ~publicKey:(Buffer.t_0_of_js x1528)
                              ~privateKey:(Buffer.t_0_of_js x1529)))|])
    let (generateKeyPair :
      type_:[ `ed25519 ] ->
                 ...
                 [|((match x1530 with
                   ...
                   Ojs.fun_to_js 3
                     (fun (x1534 : Ojs.t) ->
                        fun (x1536 : Ojs.t) ->
                          fun (x1537 : Ojs.t) ->
                            x1533 ~err:(or_null_of_js Error.t_0_of_js x1534)
                                  ...
                                  fun (x1554 : Ojs.t) ->
                                    fun (x1555 : Ojs.t) ->
                                      x1551
                                        ...
                                        ~privateKey:(Buffer.t_0_of_js x1555)))|])
    let (generateKeyPair :
      type_:[ `ed448 ] ->
        options:([ `der ], [ `pem ]) crypto_ED448KeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                                  ...
                                  fun (x1563 : Ojs.t) ->
                                    fun (x1564 : Ojs.t) ->
                                      x1560
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1561)
                                        ~publicKey:(Buffer.t_0_of_js x1563)
                                  ...
                                  fun (x1572 : Ojs.t) ->
                                    fun (x1573 : Ojs.t) ->
                                      x1569
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1570)
                                        ~publicKey:(Buffer.t_0_of_js x1572)
                                        ~privateKey:(Buffer.t_0_of_js x1573)))|])
    let (generateKeyPair :
      type_:[ `ed448 ] ->
                 ...
                 [|((match x1574 with | `ed448 -> Ojs.string_to_js "ed448"));(
                   ...
                   Ojs.fun_to_js 3
                     (fun (x1578 : Ojs.t) ->
                        fun (x1580 : Ojs.t) ->
                          fun (x1581 : Ojs.t) ->
                            x1577 ~err:(or_null_of_js Error.t_0_of_js x1578)
                                  ...
                                  fun (x1598 : Ojs.t) ->
                                    fun (x1599 : Ojs.t) ->
                                      x1595
                                        ...
                                        ~privateKey:(Buffer.t_0_of_js x1599)))|])
    let (generateKeyPair :
      type_:[ `x25519 ] ->
        options:([ `der ], [ `pem ]) crypto_X25519KeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                                  ...
                                  fun (x1607 : Ojs.t) ->
                                    fun (x1608 : Ojs.t) ->
                                      x1604
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1605)
                                        ~publicKey:(Buffer.t_0_of_js x1607)
                                  ...
                                  fun (x1616 : Ojs.t) ->
                                    fun (x1617 : Ojs.t) ->
                                      x1613
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1614)
                                        ~publicKey:(Buffer.t_0_of_js x1616)
                                        ~privateKey:(Buffer.t_0_of_js x1617)))|])
    let (generateKeyPair :
      type_:[ `x25519 ] ->
                 ...
                 [|((match x1618 with | `x25519 -> Ojs.string_to_js "x25519"));(
                   ...
                   Ojs.fun_to_js 3
                     (fun (x1622 : Ojs.t) ->
                        fun (x1624 : Ojs.t) ->
                          fun (x1625 : Ojs.t) ->
                            x1621 ~err:(or_null_of_js Error.t_0_of_js x1622)
                                  ...
                                  fun (x1642 : Ojs.t) ->
                                    fun (x1643 : Ojs.t) ->
                                      x1639
                                        ...
                                        ~privateKey:(Buffer.t_0_of_js x1643)))|])
    let (generateKeyPair :
      type_:[ `x448 ] ->
        options:([ `der ], [ `pem ]) crypto_X448KeyPairOptions ->
          callback:(err:Error.t_0 or_null ->
                                  ...
                                  fun (x1651 : Ojs.t) ->
                                    fun (x1652 : Ojs.t) ->
                                      x1648
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1649)
                                        ~publicKey:(Buffer.t_0_of_js x1651)
                                  ...
                                  fun (x1660 : Ojs.t) ->
                                    fun (x1661 : Ojs.t) ->
                                      x1657
                                        ~err:(or_null_of_js Error.t_0_of_js
                                                x1658)
                                        ~publicKey:(Buffer.t_0_of_js x1660)
                                        ~privateKey:(Buffer.t_0_of_js x1661)))|])
    let (generateKeyPair :
      type_:[ `x448 ] ->
                 ...
                 [|((match x1662 with | `x448 -> Ojs.string_to_js "x448"));(
                   ...
                   Ojs.fun_to_js 3
                     (fun (x1666 : Ojs.t) ->
                        fun (x1668 : Ojs.t) ->
                          fun (x1669 : Ojs.t) ->
                            x1665 ~err:(or_null_of_js Error.t_0_of_js x1666)
          ...
          fun ~type_:(x1670 : [ `rsa ]) ->
            fun
              ...
              Promise.t_of_js anonymous_interface_5_of_js
                (Ojs.call
                   (Ojs.get_prop_ascii
                      (Ojs.get_prop_ascii Ojs.global "crypto")
                      "generateKeyPair") "__promisify__"
    ...
    let (sign :
      ...
      fun ~algorithm:(x1843 : string or_null_or_undefined) ->
        fun ~data:(x1845 : NodeJS.ArrayBufferView.t_0) ->
          fun
            ~key:(x1846 :
                   ([ `U_s11_der of crypto_SignKeyObjectInput 
                    | `U_s18_ieee_p1363 of crypto_SignKeyObjectInput ],
            ...
            ->
            Buffer.t_0_of_js
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "sign"
                 [|(or_null_or_undefined_to_js Ojs.string_to_js x1843);(
                   NodeJS.ArrayBufferView.t_0_to_js x1845);(union2_to_js
                                                              (fun
                                                                 (x1847 :
                                                                   [
                                                                    `U_s11_der
    ...
    let (verify :
      ...
      fun ~algorithm:(x1857 : string or_null_or_undefined) ->
        fun ~data:(x1859 : NodeJS.ArrayBufferView.t_0) ->
          fun
            ~key:(x1860 :
                   ([ `U_s11_der of crypto_VerifyKeyObjectInput 
                    | `U_s18_ieee_p1363 of crypto_VerifyKeyObjectInput ],
                     ...
                     | `U_s28_spki of crypto_VerifyPublicKeyInput ]) union2)
            ->
            fun ~signature:(x1870 : NodeJS.ArrayBufferView.t_0) ->
              Ojs.bool_of_js
                (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "verify"
                   [|(or_null_or_undefined_to_js Ojs.string_to_js x1857);(
                     NodeJS.ArrayBufferView.t_0_to_js x1859);(union2_to_js
                                                                (fun
                                                                   (x1861 :
                                                                    [
                                                                    `U_s11_der
                                                                ...
                                                                (fun
                                                                   ...
                                                                   `U_s28_spki
                                                                    ...
                                                                    x1869)
                                                                x1860);(
                     NodeJS.ArrayBufferView.t_0_to_js x1870)|])
    let (diffieHellman : options:anonymous_interface_1 -> Buffer.t_0) =
      fun ~options:(x1871 : anonymous_interface_1) ->
        Buffer.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "crypto") "diffieHellman"
