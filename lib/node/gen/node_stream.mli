...
module Stream : sig
  ...
  module Internal : sig
    ...
    module ReadableOptions : sig
      ...
      val read : t -> this:stream_internal_Readable -> size:float -> unit
        [@@js.call "read"]
    ...
    module Readable : sig
      ...
      val get_readableEncoding : t -> BufferEncoding.t_0 or_null
      ...
      val get_readableHighWaterMark : t -> float
      ...
      val setEncoding : t -> encoding:BufferEncoding.t_0 -> t
        [@@js.call "setEncoding"]
      ...
      val unpipe : t -> ?destination:NodeJS.WritableStream.t_0 -> unit -> t
        [@@js.call "unpipe"]
      ...
      val wrap : t -> oldStream:NodeJS.ReadableStream.t_0 -> t
        [@@js.call "wrap"]

      val push : t -> chunk:any -> ?encoding:BufferEncoding.t_0 -> unit -> bool
        [@@js.call "push"]
    ...
    module WritableOptions : sig
      ...
      val get_defaultEncoding : t -> BufferEncoding.t_0
        [@@js.get "defaultEncoding"]

      val set_defaultEncoding : t -> BufferEncoding.t_0 -> unit
    ...
    module Writable : sig
      ...
      val get_writableHighWaterMark : t -> float
      ...
      val setDefaultEncoding : t -> encoding:BufferEncoding.t_0 -> t
    ...
    module DuplexOptions : sig
      ...
      val set_readableHighWaterMark : t -> float -> unit
        [@@js.set "readableHighWaterMark"]

      val get_writableHighWaterMark : t -> float
        [@@js.get "writableHighWaterMark"]

      val set_writableHighWaterMark : t -> float -> unit
      ...
      val read : t -> this:stream_internal_Duplex -> size:float -> unit
        [@@js.call "read"]
    ...
    val pipeline
      :  stream1:NodeJS.ReadableStream.t_0
      -> stream2:(NodeJS.ReadWriteStream.t_0, NodeJS.WritableStream.t_0) union2
      -> streams:
           (* FIXME: type 'Array<union<?NodeJS.ReadWriteStream |
              ?NodeJS.WritableStream | (~err:union<?NodeJS.ErrnoException |
              Null> -> Void)>>' cannot be used for variadic argument *)
    ...
    module Pipeline : sig
      val __promisify__
        :  stream1:NodeJS.ReadableStream.t_0
        -> stream2:NodeJS.WritableStream.t_0
        -> unit Promise.t
        [@@js.global "__promisify__"]
      ...
      val __promisify__
        :  stream1:NodeJS.ReadableStream.t_0
        -> stream2:NodeJS.ReadWriteStream.t_0
        -> stream3:NodeJS.WritableStream.t_0
        -> unit Promise.t
        [@@js.global "__promisify__"]
      ...
      val __promisify__
        ...
        -> stream2:NodeJS.ReadWriteStream.t_0
        -> stream3:NodeJS.ReadWriteStream.t_0
        -> stream4:NodeJS.WritableStream.t_0
        -> unit Promise.t
        [@@js.global "__promisify__"]
      ...
      val __promisify__
        ...
        -> stream3:NodeJS.ReadWriteStream.t_0
        -> stream4:NodeJS.ReadWriteStream.t_0
        -> stream5:NodeJS.WritableStream.t_0
        -> unit Promise.t
        [@@js.global "__promisify__"]
      ...
      val __promisify__
        :  stream1:NodeJS.ReadableStream.t_0
        -> stream2:
             (NodeJS.ReadWriteStream.t_0, NodeJS.WritableStream.t_0) union2
        -> streams:
             (* FIXME: type 'Array<union<?NodeJS.ReadWriteStream |
                ?NodeJS.WritableStream>>' cannot be used for variadic argument *)
             (any list[@js.variadic])
        -> unit Promise.t
        [@@js.global "__promisify__"]
    end
