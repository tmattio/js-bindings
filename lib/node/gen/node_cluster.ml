...
open AnonymousInterfaces
open Types
module Node_cluster = struct  end
module Cluster =
  struct
    ...
    module Worker =
      struct
        ...
        let (get_process : t -> Child.ChildProcess.t_0) =
          fun (x54 : t) ->
            Child.ChildProcess.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x54) "process")
        let (set_process : t -> Child.ChildProcess.t_0 -> unit) =
          fun (x55 : t) ->
            fun (x56 : Child.ChildProcess.t_0) ->
              Ojs.set_prop_ascii (t_to_js x55) "process"
                (Child.ChildProcess.t_0_to_js x56)
        let (send :
          t ->
            message:Child.Serializable.t_0 ->
              ?sendHandle:Child.SendHandle.t_0 ->
                ?callback:(error:Error.t_0 or_null -> unit) -> unit -> bool)
          =
          fun (x65 : t) ->
            fun ~message:(x57 : Child.Serializable.t_0) ->
              fun ?sendHandle:(x58 : Child.SendHandle.t_0 option) ->
                fun
                  ?callback:(x59 : (error:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    Ojs.bool_of_js
                      (let x66 = t_to_js x65 in
                       Ojs.call (Ojs.get_prop_ascii x66 "send") "apply"
                         [|x66;((let x60 =
                                 ...
                                 ignore
                                   (Ojs.call x60 "push"
                                      [|(Child.Serializable.t_0_to_js x57)|]);
                                 (match x58 with
                                  | Some x64 ->
                                      ignore
                                        (Ojs.call x60 "push"
                                           [|(Child.SendHandle.t_0_to_js x64)|])
                                  | None -> ());
                                 (match x59 with
                                  | Some x61 ->
                                      ignore
                         ...
                         (fun (x106 : Ojs.t) ->
                            fun (x107 : Ojs.t) ->
                              x105 ~message:(any_of_js x106)
                                ~handle:(union2_of_js Net.Server.t_0_of_js
                                           Net.Socket.t_0_of_js x107)))|])
        let (addListener'''''' :
        ...
        let (emit''''' :
          t ->
            event:[ `message ] ->
              message:any ->
                handle:(Net.Server.t_0, Net.Socket.t_0) union2 -> bool)
          =
          fun (x138 : t) ->
            fun ~event:(x133 : [ `message ]) ->
              fun ~message:(x134 : any) ->
                fun ~handle:(x135 : (Net.Server.t_0, Net.Socket.t_0) union2)
                  ->
                  Ojs.bool_of_js
                    (Ojs.call (t_to_js x138) "emit"
                       [|((match x133 with
                           | `message -> Ojs.string_to_js "message"));(
                         any_to_js x134);(union2_to_js Net.Server.t_0_to_js
                                            Net.Socket.t_0_to_js x135)|])
        ...
        let (on'' :
          ...
          fun (x152 : t) ->
            fun ~event:(x149 : [ `error ]) ->
              fun ~listener:(x150 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x152) "on"
                     [|((match x149 with | `error -> Ojs.string_to_js "error"));(
                       Ojs.fun_to_js 1
                         (fun (x151 : Ojs.t) ->
                            x150 ~error:(Error.t_0_of_js x151)))|])
        let (on''' :
          t ->
            event:[ `exit ] ->
              listener:(code:float -> signal:string -> unit) -> t)
        ...
        let (cast : t -> EventEmitter.t_0) =
          fun (x265 : t) -> EventEmitter.t_0_of_js (t_to_js x265)
      end
    module Cluster =
      struct
        ...
        let (get_workers : t -> cluster_Worker NodeJS.Dict.t_1) =
          fun (x301 : t) ->
            NodeJS.Dict.t_1_of_js cluster_Worker_of_js
              (Ojs.get_prop_ascii (t_to_js x301) "workers")
        let (set_workers : t -> cluster_Worker NodeJS.Dict.t_1 -> unit) =
          fun (x303 : t) ->
            fun (x304 : cluster_Worker NodeJS.Dict.t_1) ->
              Ojs.set_prop_ascii (t_to_js x303) "workers"
                (NodeJS.Dict.t_1_to_js cluster_Worker_to_js x304)
            ...
            fun ~event:(x332 : [ `message ]) ->
              fun
                ~listener:(x333 :
                            worker:cluster_Worker ->
                              message:any ->
                                handle:(Net.Server.t_0, Net.Socket.t_0)
                                  union2 -> unit)
                ->
                t_of_js
            ...
            fun ~event:(x370 : [ `message ]) ->
              fun ~worker:(x371 : cluster_Worker) ->
                fun ~message:(x372 : any) ->
                  fun
                    ~handle:(x373 : (Net.Server.t_0, Net.Socket.t_0) union2)
                    ->
                    Ojs.bool_of_js
                      (Ojs.call (t_to_js x376) "emit"
                         [|((match x370 with
                           ...
                           union2_to_js Net.Server.t_0_to_js
                             Net.Socket.t_0_to_js x373)|])
        let (emit'''''' :
        ...
        let (cast : t -> EventEmitter.t_0) =
          fun (x543 : t) -> EventEmitter.t_0_of_js (t_to_js x543)
      end
    let (sCHED_NONE : float) =
      Ojs.float_of_js
        (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "cluster")
           "SCHED_NONE")
    let (sCHED_RR : float) =
      Ojs.float_of_js
        (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "cluster")
    ...
    let (disconnect : ?callback:(unit -> unit) -> unit -> unit) =
      fun ?callback:(x544 : (unit -> unit) option) ->
        fun () ->
          ignore
            (let x547 = Ojs.get_prop_ascii Ojs.global "cluster" in
    ...
    let (fork : ?env:any -> unit -> cluster_Worker) =
      fun ?env:(x548 : any option) ->
        fun () ->
          cluster_Worker_of_js
            (let x551 = Ojs.get_prop_ascii Ojs.global "cluster" in
    ...
    let (setupMaster : ?settings:cluster_ClusterSettings -> unit -> unit) =
      fun ?settings:(x552 : cluster_ClusterSettings option) ->
        fun () ->
          ignore
            (let x555 = Ojs.get_prop_ascii Ojs.global "cluster" in
    ...
    let (worker : cluster_Worker) =
      cluster_Worker_of_js
        (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "cluster")
           "worker")
    let (workers : cluster_Worker NodeJS.Dict.t_1) =
      NodeJS.Dict.t_1_of_js cluster_Worker_of_js
        (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "cluster")
           "workers")
    let (addListener :
      ...
      fun ~event:(x557 : string) ->
        fun ~listener:(x558 : args:any list -> unit) ->
          cluster_Cluster_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster") "addListener"
    ...
    let (addListener :
      event:[ `message ] ->
        listener:(worker:cluster_Worker ->
                    message:any ->
                      handle:(Net.Server.t_0, Net.Socket.t_0) union2 -> unit)
          -> cluster_Cluster)
      =
    ...
    let (emit : event:symbol or_string -> args:any list -> bool) =
      fun ~event:(x589 : symbol or_string) ->
        fun ~args:(x590 : any list) ->
          Ojs.bool_of_js
            (let x594 = Ojs.get_prop_ascii Ojs.global "cluster" in
    ...
    let (emit : event:[ `disconnect ] -> worker:cluster_Worker -> bool) =
      fun ~event:(x595 : [ `disconnect ]) ->
        fun ~worker:(x596 : cluster_Worker) ->
          Ojs.bool_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster") "emit"
               [|((match x595 with
                   | `disconnect -> Ojs.string_to_js "disconnect"));(
      ...
      fun ~event:(x606 : [ `message ]) ->
        fun ~worker:(x607 : cluster_Worker) ->
          fun ~message:(x608 : any) ->
            fun ~handle:(x609 : (Net.Server.t_0, Net.Socket.t_0) union2) ->
              Ojs.bool_of_js
                (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster") "emit"
                   [|((match x606 with
                       | `message -> Ojs.string_to_js "message"));(cluster_Worker_to_js
                                                                    x607);(
                     any_to_js x608);(union2_to_js Net.Server.t_0_to_js
                                        Net.Socket.t_0_to_js x609)|])
    ...
    let (on :
      ...
      fun ~event:(x616 : string) ->
        fun ~listener:(x617 : args:any list -> unit) ->
          cluster_Cluster_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster") "on"
    ...
    let (once :
      ...
      fun ~event:(x648 : string) ->
        fun ~listener:(x649 : args:any list -> unit) ->
          cluster_Cluster_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster") "once"
    ...
    let (removeListener :
      ...
      fun ~event:(x680 : string) ->
        fun ~listener:(x681 : args:any list -> unit) ->
          cluster_Cluster_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster")
               "removeListener"
    ...
    let (removeAllListeners : ?event:string -> unit -> cluster_Cluster) =
      fun ?event:(x684 : string option) ->
        fun () ->
          cluster_Cluster_of_js
            (let x687 = Ojs.get_prop_ascii Ojs.global "cluster" in
    ...
    let (setMaxListeners : n:float -> cluster_Cluster) =
      fun ~n:(x688 : float) ->
        cluster_Cluster_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster")
             "setMaxListeners" [|(Ojs.float_to_js x688)|])
    ...
    let (listeners : event:string -> untyped_function list) =
      fun ~event:(x689 : string) ->
        Ojs.list_of_js untyped_function_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster") "listeners"
             [|(Ojs.string_to_js x689)|])
    let (listenerCount : type_:string -> float) =
      fun ~type_:(x691 : string) ->
        Ojs.float_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster") "listenerCount"
    ...
    let (eventNames : unit -> string list) =
      fun () ->
        Ojs.list_of_js Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "cluster") "eventNames"
             [||])
  end
