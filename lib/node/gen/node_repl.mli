...
module Repl : sig
  ...
  module ReplOptions : sig
    ...
    val get_completer : t -> (AsyncCompleter.t_0, Completer.t_0) union2
      [@@js.get "completer"]

    val set_completer : t -> (AsyncCompleter.t_0, Completer.t_0) union2 -> unit
      [@@js.set "completer"]
  ...
  module REPLEval : sig
    ...
    val apply
      ...
      -> context:Context.t_0
      -> file:string
      -> cb:(err:Error.t_0 or_null -> result:any -> unit)
      -> unit
      [@@js.apply]
  end
  [@@js.scope "REPLEval"]
  ...
  module REPLServer : sig
    ...
    val get_inputStream : t -> NodeJS.ReadableStream.t_0
      [@@js.get "inputStream"]

    val get_outputStream : t -> NodeJS.WritableStream.t_0
      [@@js.get "outputStream"]
    ...
    val get_commands : t -> repl_REPLCommand NodeJS.ReadOnlyDict.t_1
      [@@js.get "commands"]
    ...
    val setupHistory
      :  t
      -> path:string
      -> cb:(err:Error.t_0 or_null -> repl:t -> unit)
      -> unit
    ...
    val addListener'''''''''
      :  t
      -> event:([ `reset ][@js.enum])
      -> listener:(context:Context.t_0 -> unit)
      -> t
      [@@js.call "addListener"]
