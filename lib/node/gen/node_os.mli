...
module Internal : sig
  ...
  module Types : sig
    ...
    and os_SignalConstants =
      (* FIXME: unknown type '{ [key in NodeJS.Signals]: number; }' *) any
...
module Os : sig
  ...
  val networkInterfaces : unit -> os_NetworkInterfaceInfo list NodeJS.Dict.t_1
    [@@js.global "networkInterfaces"]

  val homedir : unit -> string [@@js.global "homedir"]

  val userInfo : options:anonymous_interface_1 -> Buffer.t_0 os_UserInfo
    [@@js.global "userInfo"]
