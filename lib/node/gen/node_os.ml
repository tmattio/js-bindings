    ...
    let (get_encoding : t -> BufferEncoding.t_0) =
      fun (x10 : t) ->
        BufferEncoding.t_0_of_js
          (Ojs.get_prop_ascii (t_to_js x10) "encoding")
    let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
      fun (x11 : t) ->
        fun (x12 : BufferEncoding.t_0) ->
          Ojs.set_prop_ascii (t_to_js x11) "encoding"
            (BufferEncoding.t_0_to_js x12)
  end
...
module Os =
  struct
    ...
    let (hostname : unit -> string) =
      fun () ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "hostname" [||])
    let (loadavg : unit -> float list) =
      fun () ->
        Ojs.list_of_js Ojs.float_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "loadavg" [||])
    let (uptime : unit -> float) =
      fun () ->
        Ojs.float_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "uptime" [||])
    let (freemem : unit -> float) =
      fun () ->
        Ojs.float_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "freemem" [||])
    let (totalmem : unit -> float) =
      fun () ->
        Ojs.float_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "totalmem" [||])
    let (cpus : unit -> os_CpuInfo list) =
      fun () ->
        Ojs.list_of_js os_CpuInfo_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "cpus" [||])
    let (type_ : unit -> string) =
      fun () ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "type" [||])
    let (release : unit -> string) =
      fun () ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "release" [||])
    let (networkInterfaces :
      unit -> os_NetworkInterfaceInfo list NodeJS.Dict.t_1) =
      fun () ->
        NodeJS.Dict.t_1_of_js
          (fun (x116 : Ojs.t) ->
             Ojs.list_of_js os_NetworkInterfaceInfo_of_js x116)
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "networkInterfaces"
             [||])
    let (homedir : unit -> string) =
      fun () ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "homedir" [||])
    let (userInfo : options:anonymous_interface_1 -> Buffer.t_0 os_UserInfo)
      =
      fun ~options:(x118 : anonymous_interface_1) ->
        os_UserInfo_of_js Buffer.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "userInfo"
      ...
      fun ?options:(x120 : anonymous_interface_0 option) ->
        fun () ->
          os_UserInfo_of_js Ojs.string_of_js
            (let x123 = Ojs.get_prop_ascii Ojs.global "os" in
    ...
    module Constants =
      struct
        let (uV_UDP_REUSEADDR : float) =
          Ojs.float_of_js
            (Ojs.get_prop_ascii
               (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "os")
                  "constants") "UV_UDP_REUSEADDR")
        module Signals = struct  end
            ...
            let (e2BIG : float) =
              Ojs.float_of_js
                (Ojs.get_prop_ascii
                   (Ojs.get_prop_ascii
                      (Ojs.get_prop_ascii
                         (Ojs.get_prop_ascii Ojs.global "os") "constants")
                      "errno") "E2BIG")
            let (eACCES : float) =
              Ojs.float_of_js
                (Ojs.get_prop_ascii
    ...
    let (arch : unit -> string) =
      fun () ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "arch" [||])
    let (version : unit -> string) =
      fun () ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "version" [||])
    let (platform : unit -> NodeJS.Platform.t_0) =
      fun () ->
        NodeJS.Platform.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "platform" [||])
    let (tmpdir : unit -> string) =
      fun () ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "tmpdir" [||])
    let (eOL : string) =
      Ojs.string_of_js
        (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "os") "EOL")
    let (endianness : unit -> [ `BE  | `LE ]) =
      fun () ->
        let x127 =
          Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "endianness" [||] in
    ...
    let (getPriority : ?pid:float -> unit -> float) =
      fun ?pid:(x128 : float option) ->
        fun () ->
          Ojs.float_of_js
            (let x131 = Ojs.get_prop_ascii Ojs.global "os" in
    ...
    let (setPriority : priority:float -> unit) =
      fun ~priority:(x132 : float) ->
        ignore
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "os") "setPriority"
