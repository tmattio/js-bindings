...
module Internal : sig
  ...
  module Types : sig
    ...
    and _NodeJS_ReadWriteStream =
      [ `NodeJS_ReadWriteStream
      | `NodeJS_ReadableStream
    ...
    and _NodeJS_RequireExtensions =
      ...
      | `NodeJS_Dict of m:_NodeJS_Module -> filename:string -> any
      ]
      intf
    [@@js.custom { of_js = Obj.magic; to_js = Obj.magic }]
...
module ErrorConstructor : sig
  ...
  val prepareStackTrace
    :  t
    -> err:Error.t
    -> stackTraces:_NodeJS_CallSite list
    -> any
...
val process : NodeJS.Process.t [@@js.global "process"]
...
val clearTimeout : timeoutId:_NodeJS_Timeout -> unit
...
val clearInterval : intervalId:_NodeJS_Timeout -> unit
...
val clearImmediate : immediateId:_NodeJS_Immediate -> unit
...
module Buffer : sig
  ...
  val from
    :  arrayBuffer:
         (ArrayBuffer.t, SharedArrayBuffer.t) union2 _WithImplicitCoercion
    -> ?byteOffset:float
    -> ?length:float
    -> unit
    -> t
  ...
  val from' : data:(Uint8Array.t, float list) union2 -> t [@@js.global "from"]
  ...
  val concat : list:Uint8Array.t list -> ?totalLength:float -> unit -> t
    [@@js.global "concat"]

  val compare : buf1:Uint8Array.t -> buf2:Uint8Array.t -> float
    [@@js.global "compare"]
  ...
  val write : t -> string:string -> ?encoding:_BufferEncoding -> unit -> float
    [@@js.call "write"]
  ...
  val writeIntLE : t -> value:float -> offset:float -> byteLength:float -> float
    [@@js.call "writeIntLE"]

  val writeIntBE : t -> value:float -> offset:float -> byteLength:float -> float
    [@@js.call "writeIntBE"]

  val readBigUInt64BE : t -> ?offset:float -> unit -> bigint
    [@@js.call "readBigUInt64BE"]

  val readBigUInt64LE : t -> ?offset:float -> unit -> bigint
    [@@js.call "readBigUInt64LE"]

  val readBigInt64BE : t -> ?offset:float -> unit -> bigint
    [@@js.call "readBigInt64BE"]

  val readBigInt64LE : t -> ?offset:float -> unit -> bigint
    [@@js.call "readBigInt64LE"]

  val readUIntLE : t -> offset:float -> byteLength:float -> float
    [@@js.call "readUIntLE"]

  val readUIntBE : t -> offset:float -> byteLength:float -> float
    [@@js.call "readUIntBE"]

  val readIntLE : t -> offset:float -> byteLength:float -> float
    [@@js.call "readIntLE"]

  val readIntBE : t -> offset:float -> byteLength:float -> float
    [@@js.call "readIntBE"]

  val readUInt8 : t -> ?offset:float -> unit -> float [@@js.call "readUInt8"]

  val readUInt16LE : t -> ?offset:float -> unit -> float
    [@@js.call "readUInt16LE"]

  val readUInt16BE : t -> ?offset:float -> unit -> float
    [@@js.call "readUInt16BE"]

  val readUInt32LE : t -> ?offset:float -> unit -> float
    [@@js.call "readUInt32LE"]

  val readUInt32BE : t -> ?offset:float -> unit -> float
    [@@js.call "readUInt32BE"]

  val readInt8 : t -> ?offset:float -> unit -> float [@@js.call "readInt8"]

  val readInt16LE : t -> ?offset:float -> unit -> float
    [@@js.call "readInt16LE"]

  val readInt16BE : t -> ?offset:float -> unit -> float
    [@@js.call "readInt16BE"]

  val readInt32LE : t -> ?offset:float -> unit -> float
    [@@js.call "readInt32LE"]

  val readInt32BE : t -> ?offset:float -> unit -> float
    [@@js.call "readInt32BE"]

  val readFloatLE : t -> ?offset:float -> unit -> float
    [@@js.call "readFloatLE"]

  val readFloatBE : t -> ?offset:float -> unit -> float
    [@@js.call "readFloatBE"]

  val readDoubleLE : t -> ?offset:float -> unit -> float
    [@@js.call "readDoubleLE"]

  val readDoubleBE : t -> ?offset:float -> unit -> float
...
module NodeJS : sig
  module InspectOptions : sig
    ...
    val set_maxArrayLength : t -> float or_null -> unit
      [@@js.set "maxArrayLength"]

    val get_maxStringLength : t -> float or_null [@@js.get "maxStringLength"]

    val set_maxStringLength : t -> float or_null -> unit
    ...
    val get_sorted : t -> (a:string -> b:string -> float) or_boolean
      [@@js.get "sorted"]

    val set_sorted : t -> (a:string -> b:string -> float) or_boolean -> unit
      [@@js.set "sorted"]
  end
  ...
  module CallSite : sig
    ...
    val getFunction : t -> untyped_function or_undefined
      [@@js.call "getFunction"]
  ...
  module ReadableStream : sig
    ...
    val setEncoding : t -> encoding:_BufferEncoding -> t
      [@@js.call "setEncoding"]
    ...
    val unpipe : t -> ?destination:_NodeJS_WritableStream -> unit -> t
      [@@js.call "unpipe"]
  ...
  module Global : sig
    ...
    val set_Boolean
      :  t
      -> (* FIXME: unknown type 'typeof Boolean' *) any
      -> unit
      [@@js.set "Boolean"]
    ...
    val get_NaN : t -> (* FIXME: unknown type 'typeof NaN' *) any
      [@@js.get "NaN"]
    ...
    val set_Promise
      :  t
      -> (* FIXME: unknown type 'typeof Promise' *) any
      -> unit
      [@@js.set "Promise"]
    ...
    val clearImmediate : t -> immediateId:_NodeJS_Immediate -> unit
      [@@js.call "clearImmediate"]

    val clearInterval : t -> intervalId:_NodeJS_Timeout -> unit
      [@@js.call "clearInterval"]

    val clearTimeout : t -> timeoutId:_NodeJS_Timeout -> unit
  ...
  module Immediate : sig
    ...
    val set__onImmediate : t -> untyped_function -> unit
      [@@js.set "_onImmediate"]
  ...
  module Require : sig
    ...
    val set_extensions : t -> _NodeJS_RequireExtensions -> unit
      [@@js.set "extensions"]
  ...
  module RequireExtensions : sig
    ...
    val _json : t -> m:_NodeJS_Module -> filename:string -> any
      [@@js.call ".json"]

    val _node : t -> m:_NodeJS_Module -> filename:string -> any
      [@@js.call ".node"]

    val cast : t -> (m:_NodeJS_Module -> filename:string -> any) _NodeJS_Dict
      [@@js.cast]
  end
