    ...
    let (get_encoding : t -> BufferEncoding.t_0) =
      fun (x39 : t) ->
        BufferEncoding.t_0_of_js
          (Ojs.get_prop_ascii (t_to_js x39) "encoding")
    let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
      fun (x40 : t) ->
        fun (x41 : BufferEncoding.t_0) ->
          Ojs.set_prop_ascii (t_to_js x40) "encoding"
            (BufferEncoding.t_0_to_js x41)
    let (get_flag : t -> OpenMode.t_0) =
      fun (x42 : t) ->
        OpenMode.t_0_of_js (Ojs.get_prop_ascii (t_to_js x42) "flag")
    let (set_flag : t -> OpenMode.t_0 -> unit) =
      fun (x43 : t) ->
        fun (x44 : OpenMode.t_0) ->
          Ojs.set_prop_ascii (t_to_js x43) "flag" (OpenMode.t_0_to_js x44)
  end
module AnonymousInterface6 =
  struct
    ...
    let (get_flag : t -> OpenMode.t_0) =
      fun (x52 : t) ->
        OpenMode.t_0_of_js (Ojs.get_prop_ascii (t_to_js x52) "flag")
    let (set_flag : t -> OpenMode.t_0 -> unit) =
      fun (x53 : t) ->
        fun (x54 : OpenMode.t_0) ->
          Ojs.set_prop_ascii (t_to_js x53) "flag" (OpenMode.t_0_to_js x54)
  end
...
module AnonymousInterface8 =
  struct
    ...
    let (get_flag : t -> OpenMode.t_0) =
      fun (x67 : t) ->
        OpenMode.t_0_of_js (Ojs.get_prop_ascii (t_to_js x67) "flag")
    let (set_flag : t -> OpenMode.t_0 -> unit) =
      fun (x68 : t) ->
        fun (x69 : OpenMode.t_0) ->
          Ojs.set_prop_ascii (t_to_js x68) "flag" (OpenMode.t_0_to_js x69)
  end
module AnonymousInterface9 =
  struct
    ...
    let (get_mode : t -> Mode.t_0) =
      fun (x72 : t) ->
        Mode.t_0_of_js (Ojs.get_prop_ascii (t_to_js x72) "mode")
    let (set_mode : t -> Mode.t_0 -> unit) =
      fun (x73 : t) ->
        fun (x74 : Mode.t_0) ->
          Ojs.set_prop_ascii (t_to_js x73) "mode" (Mode.t_0_to_js x74)
    let (get_flag : t -> OpenMode.t_0) =
      fun (x75 : t) ->
        OpenMode.t_0_of_js (Ojs.get_prop_ascii (t_to_js x75) "flag")
    let (set_flag : t -> OpenMode.t_0 -> unit) =
      fun (x76 : t) ->
        fun (x77 : OpenMode.t_0) ->
          Ojs.set_prop_ascii (t_to_js x76) "flag" (OpenMode.t_0_to_js x77)
  end
  ...
  struct
    module FileHandle =
      struct
        ...
        let (appendFile :
          t ->
            data:Uint8Array.t or_string ->
              ?options:BufferEncoding.t_0 or_null -> unit -> unit Promise.t)
          =
          fun (x111 : t) ->
            fun ~data:(x105 : Uint8Array.t or_string) ->
              fun ?options:(x106 : BufferEncoding.t_0 or_null option) ->
                fun () ->
        ...
        let (chmod : t -> mode:Mode.t_0 -> unit Promise.t) =
          fun (x119 : t) ->
            fun ~mode:(x118 : Mode.t_0) ->
              Promise.t_of_js Ojs.unit_of_js
                (Ojs.call (t_to_js x119) "chmod" [|(Mode.t_0_to_js x118)|])
            ...
            fun
              ...
              Promise.t_of_js Ojs.string_of_js
                (Ojs.call (t_to_js x149) "readFile"
                   [|(union2_to_js BufferEncoding.t_0_to_js
        ...
        let (readFile'' :
          ...
          =
          fun (x155 : t) ->
            fun ?options:(x151 : BufferEncoding.t_0 or_null option) ->
              fun () ->
                Promise.t_of_js
                  (fun (x157 : Ojs.t) ->
                     or_string_of_js Buffer.t_0_of_js x157)
                              ...
                              (match x151 with
                               | Some x153 ->
                                   ignore
                                     (Ojs.call x152 "push"
                                        [|(or_null_to_js
                                             BufferEncoding.t_0_to_js x153)|])
                               | None -> ());
                              x152))|])
        let (stat :
          t ->
            ?opts:(StatOptions.t_0, anonymous_interface_0) intersection2 ->
              unit -> Stats.t_0 Promise.t)
          =
          fun (x164 : t) ->
            fun
              ?opts:(x159 :
                      (StatOptions.t_0, anonymous_interface_0) intersection2
                        option)
              ->
              fun () ->
                Promise.t_of_js Stats.t_0_of_js
        ...
        let (stat' :
          ...
          fun (x170 : t) ->
            fun
              ~opts:(x167 :
                      (StatOptions.t_0, anonymous_interface_1) intersection2)
              ->
              Promise.t_of_js BigIntStats.t_0_of_js
                (Ojs.call (t_to_js x170) "stat"
                   [|(intersection2_to_js StatOptions.t_0_to_js
                        anonymous_interface_1_to_js x167)|])
        let (stat'' :
          t ->
            ?opts:StatOptions.t_0 ->
              unit -> (BigIntStats.t_0, Stats.t_0) union2 Promise.t)
          =
          fun (x175 : t) ->
            fun ?opts:(x172 : StatOptions.t_0 option) ->
              fun () ->
                Promise.t_of_js
                  (fun (x177 : Ojs.t) ->
                     union2_of_js BigIntStats.t_0_of_js Stats.t_0_of_js x177)
          ...
          fun (x217 : t) ->
            fun ~data:(x208 : Uint8Array.t or_string) ->
              fun ?position:(x209 : float or_null option) ->
                fun ?encoding:(x210 : BufferEncoding.t_0 or_null option) ->
                  fun () ->
        ...
        let (writeFile :
          ...
          fun (x226 : t) ->
            fun ~data:(x220 : Uint8Array.t or_string) ->
              fun ?options:(x221 : BufferEncoding.t_0 or_null option) ->
                fun () ->
                  Promise.t_of_js Ojs.unit_of_js
                                ...
                                (match x221 with
                                 | Some x223 ->
                                     ignore
                                       (Ojs.call x222 "push"
                                          [|(or_null_to_js
                                               BufferEncoding.t_0_to_js x223)|])
                                 | None -> ());
                                x222))|])
        let (writev :
          t ->
            buffers:NodeJS.ArrayBufferView.t_0 list ->
              ?position:float -> unit -> WriteVResult.t_0 Promise.t)
          =
          fun (x234 : t) ->
            fun ~buffers:(x229 : NodeJS.ArrayBufferView.t_0 list) ->
              fun ?position:(x230 : float option) ->
                fun () ->
                  Promise.t_of_js WriteVResult.t_0_of_js
        ...
        let (readv :
          t ->
            buffers:NodeJS.ArrayBufferView.t_0 list ->
              ?position:float -> unit -> ReadVResult.t_0 Promise.t)
          =
          fun (x242 : t) ->
            fun ~buffers:(x237 : NodeJS.ArrayBufferView.t_0 list) ->
              fun ?position:(x238 : float option) ->
                fun () ->
                  Promise.t_of_js ReadVResult.t_0_of_js
    ...
    let (access : path:PathLike.t_0 -> ?mode:float -> unit -> unit Promise.t)
      =
      fun ~path:(x247 : PathLike.t_0) ->
        fun ?mode:(x248 : float option) ->
          fun () ->
            Promise.t_of_js Ojs.unit_of_js
              (let x251 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (copyFile :
      src:PathLike.t_0 ->
        dest:PathLike.t_0 -> ?flags:float -> unit -> unit Promise.t)
      =
      fun ~src:(x253 : PathLike.t_0) ->
        fun ~dest:(x254 : PathLike.t_0) ->
          fun ?flags:(x255 : float option) ->
            fun () ->
              Promise.t_of_js Ojs.unit_of_js
                (let x258 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
                 Ojs.call (Ojs.get_prop_ascii x258 "copyFile") "apply"
                   [|x258;((let x256 =
                            ...
                            ignore
                              (Ojs.call x256 "push"
                                 [|(PathLike.t_0_to_js x253)|]);
                            ignore
                              (Ojs.call x256 "push"
                                 [|(PathLike.t_0_to_js x254)|]);
                            (match x255 with
                             | Some x257 ->
                                 ignore
                                   (Ojs.call x256 "push"
    ...
    let (open_ :
      path:PathLike.t_0 ->
        flags:string or_number ->
          ?mode:Mode.t_0 -> unit -> node_fs_promises_FileHandle Promise.t)
      =
      fun ~path:(x260 : PathLike.t_0) ->
        fun ~flags:(x261 : string or_number) ->
          fun ?mode:(x262 : Mode.t_0 option) ->
            fun () ->
              Promise.t_of_js node_fs_promises_FileHandle_of_js
                (let x266 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
            ...
            fun ?length:(x271 : float or_null option) ->
              fun ?position:(x272 : float or_null option) ->
                fun () ->
                  Promise.t_of_js anonymous_interface_2_of_js
                    (let x280 =
                       Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
      ...
      fun ~handle:(x296 : node_fs_promises_FileHandle) ->
        fun ~string:(x297 : string) ->
          fun ?position:(x298 : float or_null option) ->
            fun ?encoding:(x299 : BufferEncoding.t_0 or_null option) ->
              fun () ->
                Promise.t_of_js anonymous_interface_4_of_js
                  (let x305 =
                     Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
                              ...
                              (match x299 with
                               | Some x301 ->
                                   ignore
                                     (Ojs.call x300 "push"
                                        [|(or_null_to_js
                                             BufferEncoding.t_0_to_js x301)|])
                               | None -> ());
                              x300))|])
    let (rename :
      oldPath:PathLike.t_0 -> newPath:PathLike.t_0 -> unit Promise.t) =
      fun ~oldPath:(x307 : PathLike.t_0) ->
        fun ~newPath:(x308 : PathLike.t_0) ->
          Promise.t_of_js Ojs.unit_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "rename"
               [|(PathLike.t_0_to_js x307);(PathLike.t_0_to_js x308)|])
    let (truncate :
      path:PathLike.t_0 -> ?len:float -> unit -> unit Promise.t) =
      fun ~path:(x310 : PathLike.t_0) ->
        fun ?len:(x311 : float option) ->
          fun () ->
            Promise.t_of_js Ojs.unit_of_js
              (let x314 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (ftruncate :
      ...
      fun ~handle:(x316 : node_fs_promises_FileHandle) ->
        fun ?len:(x317 : float option) ->
          fun () ->
            Promise.t_of_js Ojs.unit_of_js
              (let x320 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (rmdir :
      path:PathLike.t_0 ->
        ?options:RmDirOptions.t_0 -> unit -> unit Promise.t)
      =
      fun ~path:(x322 : PathLike.t_0) ->
        fun ?options:(x323 : RmDirOptions.t_0 option) ->
          fun () ->
            Promise.t_of_js Ojs.unit_of_js
              (let x326 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
               Ojs.call (Ojs.get_prop_ascii x326 "rmdir") "apply"
                 [|x326;((let x324 =
                          ...
                          ignore
                            (Ojs.call x324 "push"
                               [|(PathLike.t_0_to_js x322)|]);
                          (match x323 with
                           | Some x325 ->
                               ignore
                                 (Ojs.call x324 "push"
                                    [|(RmDirOptions.t_0_to_js x325)|])
                           | None -> ());
                          x324))|])
    let (rm :
      path:PathLike.t_0 -> ?options:RmOptions.t_0 -> unit -> unit Promise.t)
      =
      fun ~path:(x328 : PathLike.t_0) ->
        fun ?options:(x329 : RmOptions.t_0 option) ->
          fun () ->
            Promise.t_of_js Ojs.unit_of_js
              (let x332 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
               Ojs.call (Ojs.get_prop_ascii x332 "rm") "apply"
                 [|x332;((let x330 =
                          ...
                          ignore
                            (Ojs.call x330 "push"
                               [|(PathLike.t_0_to_js x328)|]);
                          (match x329 with
                           | Some x331 ->
                               ignore
                                 (Ojs.call x330 "push"
                                    [|(RmOptions.t_0_to_js x331)|])
                           | None -> ());
                          x330))|])
    let (fdatasync : handle:node_fs_promises_FileHandle -> unit Promise.t) =
      fun ~handle:(x334 : node_fs_promises_FileHandle) ->
        Promise.t_of_js Ojs.unit_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
             "fdatasync" [|(node_fs_promises_FileHandle_to_js x334)|])
    let (fsync : handle:node_fs_promises_FileHandle -> unit Promise.t) =
      fun ~handle:(x336 : node_fs_promises_FileHandle) ->
        Promise.t_of_js Ojs.unit_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
             "fsync" [|(node_fs_promises_FileHandle_to_js x336)|])
    let (mkdir :
      path:PathLike.t_0 ->
        options:(MakeDirectoryOptions.t_0, anonymous_interface_11)
          intersection2 -> string or_undefined Promise.t)
      =
      fun ~path:(x338 : PathLike.t_0) ->
        fun
          ~options:(x339 :
                     (MakeDirectoryOptions.t_0, anonymous_interface_11)
                       intersection2)
          ->
          Promise.t_of_js
            ...
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "mkdir"
               [|(PathLike.t_0_to_js x338);(intersection2_to_js
                                              MakeDirectoryOptions.t_0_to_js
                                              anonymous_interface_11_to_js
                                              x339)|])
    let (mkdir :
      path:PathLike.t_0 ->
        ?options:Mode.t_0 or_null -> unit -> unit Promise.t)
      =
      fun ~path:(x344 : PathLike.t_0) ->
        fun ?options:(x345 : Mode.t_0 or_null option) ->
          fun () ->
            Promise.t_of_js Ojs.unit_of_js
              (let x349 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
               Ojs.call (Ojs.get_prop_ascii x349 "mkdir") "apply"
                 [|x349;((let x346 =
                          ...
                          ignore
                            (Ojs.call x346 "push"
                               [|(PathLike.t_0_to_js x344)|]);
                          (match x345 with
                           | Some x347 ->
                               ignore
                                 (Ojs.call x346 "push"
                                    [|(or_null_to_js Mode.t_0_to_js x347)|])
                           | None -> ());
                          x346))|])
    let (mkdir :
      path:PathLike.t_0 ->
      ...
      =
      fun ~path:(x351 : PathLike.t_0) ->
        fun
          ?options:(x352 :
                     (MakeDirectoryOptions.t_0, Mode.t_0) union2 or_null
                       option)
          ->
          fun () ->
            Promise.t_of_js
              (fun (x359 : Ojs.t) -> or_undefined_of_js Ojs.string_of_js x359)
              (let x358 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
                               ...
                               ignore
                                 (Ojs.call x353 "push"
                                    [|(or_null_to_js
                                         (fun
                                            (x355 :
                                              (MakeDirectoryOptions.t_0,
                                                Mode.t_0) union2)
                                            ->
                                            union2_to_js
                                              MakeDirectoryOptions.t_0_to_js
                                              Mode.t_0_to_js x355) x354)|])
                           | None -> ());
                          x353))|])
    let (readdir :
      path:PathLike.t_0 ->
        ?options:BufferEncoding.t_0 or_null -> unit -> string list Promise.t)
      =
      fun ~path:(x361 : PathLike.t_0) ->
        fun ?options:(x362 : BufferEncoding.t_0 or_null option) ->
          fun () ->
            Promise.t_of_js
              (fun (x367 : Ojs.t) -> Ojs.list_of_js Ojs.string_of_js x367)
              (let x366 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
               Ojs.call (Ojs.get_prop_ascii x366 "readdir") "apply"
                 [|x366;((let x363 =
                          ...
                          ignore
                            (Ojs.call x363 "push"
                               [|(PathLike.t_0_to_js x361)|]);
                          (match x362 with
                           | Some x364 ->
                               ignore
                                 (Ojs.call x363 "push"
                                    [|(or_null_to_js BufferEncoding.t_0_to_js
                                         x364)|])
                           | None -> ());
                          x363))|])
    let (readdir :
      ...
      =
      fun ~path:(x369 : PathLike.t_0) ->
        fun ~options:(x370 : (anonymous_interface_7, [ `buffer ]) or_enum) ->
          Promise.t_of_js
            (fun (x373 : Ojs.t) -> Ojs.list_of_js Buffer.t_0_of_js x373)
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "readdir"
               [|(PathLike.t_0_to_js x369);(or_enum_to_js
    ...
    let (readdir :
      ...
      =
      fun ~path:(x375 : PathLike.t_0) ->
        fun ?options:(x376 : BufferEncoding.t_0 or_null option) ->
          fun () ->
            Promise.t_of_js
              (fun (x381 : Ojs.t) ->
                 Ojs.list_of_js
                   (fun (x382 : Ojs.t) ->
                      or_string_of_js Buffer.t_0_of_js x382) x381)
              (let x380 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (readdir :
      path:PathLike.t_0 ->
        options:(BaseEncodingOptions.t_0, anonymous_interface_13)
          intersection2 -> Dirent.t_0 list Promise.t)
      =
      fun ~path:(x384 : PathLike.t_0) ->
        fun
          ~options:(x385 :
                     (BaseEncodingOptions.t_0, anonymous_interface_13)
                       intersection2)
          ->
          Promise.t_of_js
            (fun (x388 : Ojs.t) -> Ojs.list_of_js Dirent.t_0_of_js x388)
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "readdir"
               [|(PathLike.t_0_to_js x384);(intersection2_to_js
                                              BaseEncodingOptions.t_0_to_js
                                              anonymous_interface_13_to_js
                                              x385)|])
    let (readlink :
      path:PathLike.t_0 ->
      ...
      =
      fun ~path:(x390 : PathLike.t_0) ->
        fun
          ?options:(x391 :
                     (BaseEncodingOptions.t_0, BufferEncoding.t_0) union2
                       or_null option)
          ->
          fun () ->
            Promise.t_of_js Ojs.string_of_js
              (let x397 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
                                 ...
                                 (Ojs.call x392 "push"
                                    [|(or_null_to_js
                                         (fun
                                            ...
                                            union2_to_js
                                              BaseEncodingOptions.t_0_to_js
                                              BufferEncoding.t_0_to_js x394)
                                         x393)|])
                           | None -> ());
                          x392))|])
    let (readlink :
      path:PathLike.t_0 ->
        options:BufferEncodingOption.t_0 -> Buffer.t_0 Promise.t)
      =
      fun ~path:(x399 : PathLike.t_0) ->
        fun ~options:(x400 : BufferEncodingOption.t_0) ->
          Promise.t_of_js Buffer.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "readlink"
               [|(PathLike.t_0_to_js x399);(BufferEncodingOption.t_0_to_js
                                              x400)|])
    let (readlink :
      path:PathLike.t_0 ->
        ?options:BaseEncodingOptions.t_0 or_string or_null ->
          unit -> Buffer.t_0 or_string Promise.t)
      =
      fun ~path:(x402 : PathLike.t_0) ->
        fun
          ?options:(x403 : BaseEncodingOptions.t_0 or_string or_null option)
          ->
          fun () ->
            Promise.t_of_js
              (fun (x409 : Ojs.t) -> or_string_of_js Buffer.t_0_of_js x409)
              (let x408 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (symlink :
      target:PathLike.t_0 ->
        path:PathLike.t_0 -> ?type_:string or_null -> unit -> unit Promise.t)
      =
      fun ~target:(x411 : PathLike.t_0) ->
        fun ~path:(x412 : PathLike.t_0) ->
          fun ?type_:(x413 : string or_null option) ->
            fun () ->
              Promise.t_of_js Ojs.unit_of_js
                (let x417 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
                 Ojs.call (Ojs.get_prop_ascii x417 "symlink") "apply"
                   [|x417;((let x414 =
                            ...
                            ignore
                              (Ojs.call x414 "push"
                                 [|(PathLike.t_0_to_js x411)|]);
                            ignore
                              (Ojs.call x414 "push"
                                 [|(PathLike.t_0_to_js x412)|]);
                            (match x413 with
                             | Some x415 ->
                                 ignore
                                   (Ojs.call x414 "push"
    ...
    let (lstat :
      ...
      fun ~path:(x419 : PathLike.t_0) ->
        fun
          ...
          fun () ->
            Promise.t_of_js Stats.t_0_of_js
              (let x425 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
      ...
      fun ~path:(x427 : PathLike.t_0) ->
        fun
          ...
          Promise.t_of_js BigIntStats.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "lstat"
               [|(PathLike.t_0_to_js x427);(intersection2_to_js
                                              StatOptions.t_0_to_js
    ...
    let (lstat :
      path:PathLike.t_0 ->
        ?opts:StatOptions.t_0 ->
          unit -> (BigIntStats.t_0, Stats.t_0) union2 Promise.t)
      =
      fun ~path:(x432 : PathLike.t_0) ->
        fun ?opts:(x433 : StatOptions.t_0 option) ->
          fun () ->
            Promise.t_of_js
              (fun (x437 : Ojs.t) ->
                 union2_of_js BigIntStats.t_0_of_js Stats.t_0_of_js x437)
              (let x436 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
               Ojs.call (Ojs.get_prop_ascii x436 "lstat") "apply"
                 [|x436;((let x434 =
                          ...
                          ignore
                            (Ojs.call x434 "push"
                               [|(PathLike.t_0_to_js x432)|]);
                          (match x433 with
                           | Some x435 ->
                               ignore
                                 (Ojs.call x434 "push"
                                    [|(StatOptions.t_0_to_js x435)|])
                           | None -> ());
                          x434))|])
    let (stat :
      path:PathLike.t_0 ->
      ...
      fun ~path:(x440 : PathLike.t_0) ->
        fun
          ...
          fun () ->
            Promise.t_of_js Stats.t_0_of_js
              (let x446 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
      ...
      fun ~path:(x448 : PathLike.t_0) ->
        fun
          ...
          Promise.t_of_js BigIntStats.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "stat"
               [|(PathLike.t_0_to_js x448);(intersection2_to_js
                                              StatOptions.t_0_to_js
                                              anonymous_interface_1_to_js
                                              x449)|])
    let (stat :
      path:PathLike.t_0 ->
        ?opts:StatOptions.t_0 ->
          unit -> (BigIntStats.t_0, Stats.t_0) union2 Promise.t)
      =
      fun ~path:(x453 : PathLike.t_0) ->
        fun ?opts:(x454 : StatOptions.t_0 option) ->
          fun () ->
            Promise.t_of_js
              (fun (x458 : Ojs.t) ->
                 union2_of_js BigIntStats.t_0_of_js Stats.t_0_of_js x458)
              (let x457 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
               Ojs.call (Ojs.get_prop_ascii x457 "stat") "apply"
                 [|x457;((let x455 =
                          ...
                          ignore
                            (Ojs.call x455 "push"
                               [|(PathLike.t_0_to_js x453)|]);
                          (match x454 with
                           | Some x456 ->
                               ignore
                                 (Ojs.call x455 "push"
                                    [|(StatOptions.t_0_to_js x456)|])
                           | None -> ());
                          x455))|])
    let (link :
      existingPath:PathLike.t_0 -> newPath:PathLike.t_0 -> unit Promise.t) =
      fun ~existingPath:(x461 : PathLike.t_0) ->
        fun ~newPath:(x462 : PathLike.t_0) ->
          Promise.t_of_js Ojs.unit_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "link" [|(PathLike.t_0_to_js x461);(PathLike.t_0_to_js x462)|])
    let (unlink : path:PathLike.t_0 -> unit Promise.t) =
      fun ~path:(x464 : PathLike.t_0) ->
        Promise.t_of_js Ojs.unit_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
             "unlink" [|(PathLike.t_0_to_js x464)|])
    let (fchmod :
      handle:node_fs_promises_FileHandle -> mode:Mode.t_0 -> unit Promise.t)
      =
      fun ~handle:(x466 : node_fs_promises_FileHandle) ->
        fun ~mode:(x467 : Mode.t_0) ->
          Promise.t_of_js Ojs.unit_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "fchmod"
               [|(node_fs_promises_FileHandle_to_js x466);(Mode.t_0_to_js
                                                             x467)|])
    let (chmod : path:PathLike.t_0 -> mode:Mode.t_0 -> unit Promise.t) =
      fun ~path:(x469 : PathLike.t_0) ->
        fun ~mode:(x470 : Mode.t_0) ->
          Promise.t_of_js Ojs.unit_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "chmod" [|(PathLike.t_0_to_js x469);(Mode.t_0_to_js x470)|])
    let (lchmod : path:PathLike.t_0 -> mode:Mode.t_0 -> unit Promise.t) =
      fun ~path:(x472 : PathLike.t_0) ->
        fun ~mode:(x473 : Mode.t_0) ->
          Promise.t_of_js Ojs.unit_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "lchmod" [|(PathLike.t_0_to_js x472);(Mode.t_0_to_js x473)|])
    let (lchown :
      path:PathLike.t_0 -> uid:float -> gid:float -> unit Promise.t) =
      fun ~path:(x475 : PathLike.t_0) ->
        fun ~uid:(x476 : float) ->
          fun ~gid:(x477 : float) ->
            Promise.t_of_js Ojs.unit_of_js
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
                 "lchown"
                 [|(PathLike.t_0_to_js x475);(Ojs.float_to_js x476);(
                   Ojs.float_to_js x477)|])
    let (lutimes :
      path:PathLike.t_0 ->
        atime:Date.t or_string or_number ->
          mtime:Date.t or_string or_number -> unit Promise.t)
      =
      fun ~path:(x479 : PathLike.t_0) ->
        fun ~atime:(x480 : Date.t or_string or_number) ->
          fun ~mtime:(x483 : Date.t or_string or_number) ->
            Promise.t_of_js Ojs.unit_of_js
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
                 "lutimes"
                 [|(PathLike.t_0_to_js x479);(or_number_to_js
                                                (fun
                                                   (x481 : Date.t or_string)
                                                   ->
                                                   or_string_to_js
                                                     Date.t_to_js x481) x480);(
                   or_number_to_js
                     (fun (x484 : Date.t or_string) ->
                        or_string_to_js Date.t_to_js x484) x483)|])
    let (fchown :
      handle:node_fs_promises_FileHandle ->
    ...
    let (chown :
      path:PathLike.t_0 -> uid:float -> gid:float -> unit Promise.t) =
      fun ~path:(x491 : PathLike.t_0) ->
        fun ~uid:(x492 : float) ->
          fun ~gid:(x493 : float) ->
            Promise.t_of_js Ojs.unit_of_js
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
                 "chown"
                 [|(PathLike.t_0_to_js x491);(Ojs.float_to_js x492);(
    ...
    let (utimes :
      path:PathLike.t_0 ->
        atime:Date.t or_string or_number ->
          mtime:Date.t or_string or_number -> unit Promise.t)
      =
      fun ~path:(x495 : PathLike.t_0) ->
        fun ~atime:(x496 : Date.t or_string or_number) ->
          fun ~mtime:(x499 : Date.t or_string or_number) ->
            Promise.t_of_js Ojs.unit_of_js
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
                 "utimes"
                 [|(PathLike.t_0_to_js x495);(or_number_to_js
                                                (fun
                                                   (x497 : Date.t or_string)
                                                   ->
                                                   or_string_to_js
                                                     Date.t_to_js x497) x496);(
                   or_number_to_js
                     (fun (x500 : Date.t or_string) ->
                        or_string_to_js Date.t_to_js x500) x499)|])
    let (futimes :
      handle:node_fs_promises_FileHandle ->
        atime:Date.t or_string or_number ->
          mtime:Date.t or_string or_number -> unit Promise.t)
    ...
    let (realpath :
      ...
      fun ~path:(x511 : PathLike.t_0) ->
        fun
          ...
          fun () ->
            Promise.t_of_js Ojs.string_of_js
              (let x518 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (realpath :
      path:PathLike.t_0 ->
        options:BufferEncodingOption.t_0 -> Buffer.t_0 Promise.t)
      =
      fun ~path:(x520 : PathLike.t_0) ->
        fun ~options:(x521 : BufferEncodingOption.t_0) ->
          Promise.t_of_js Buffer.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "realpath"
               [|(PathLike.t_0_to_js x520);(BufferEncodingOption.t_0_to_js
                                              x521)|])
    let (realpath :
      path:PathLike.t_0 ->
        ?options:(BaseEncodingOptions.t_0, BufferEncoding.t_0) union2 or_null
      ...
      fun ~path:(x523 : PathLike.t_0) ->
        fun
          ...
          fun () ->
            Promise.t_of_js
              (fun (x531 : Ojs.t) -> or_string_of_js Buffer.t_0_of_js x531)
              (let x530 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (mkdtemp :
      ...
      fun ~prefix:(x533 : string) ->
        fun
          ...
          fun () ->
            Promise.t_of_js Ojs.string_of_js
              (let x540 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (mkdtemp :
      ...
      fun ~prefix:(x542 : string) ->
        fun ~options:(x543 : BufferEncodingOption.t_0) ->
          Promise.t_of_js Buffer.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               "mkdtemp"
               [|(Ojs.string_to_js x542);(BufferEncodingOption.t_0_to_js x543)|])
    let (mkdtemp :
      prefix:string ->
        ?options:(BaseEncodingOptions.t_0, BufferEncoding.t_0) union2 or_null
          -> unit -> Buffer.t_0 or_string Promise.t)
      ...
      fun ~prefix:(x545 : string) ->
        fun
          ...
          fun () ->
            Promise.t_of_js
              (fun (x553 : Ojs.t) -> or_string_of_js Buffer.t_0_of_js x553)
              (let x552 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (writeFile :
      path:(node_fs_promises_FileHandle, PathLike.t_0) union2 ->
        data:Uint8Array.t or_string ->
          ?options:BufferEncoding.t_0 or_null -> unit -> unit Promise.t)
      =
      fun ~path:(x555 : (node_fs_promises_FileHandle, PathLike.t_0) union2)
        ->
        fun ~data:(x556 : Uint8Array.t or_string) ->
          fun ?options:(x557 : BufferEncoding.t_0 or_null option) ->
            fun () ->
              Promise.t_of_js Ojs.unit_of_js
                (let x564 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (appendFile :
      path:(node_fs_promises_FileHandle, PathLike.t_0) union2 ->
        data:Uint8Array.t or_string ->
          ?options:BufferEncoding.t_0 or_null -> unit -> unit Promise.t)
      =
      fun ~path:(x566 : (node_fs_promises_FileHandle, PathLike.t_0) union2)
        ->
        fun ~data:(x567 : Uint8Array.t or_string) ->
          fun ?options:(x568 : BufferEncoding.t_0 or_null option) ->
            fun () ->
              Promise.t_of_js Ojs.unit_of_js
                (let x575 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (readFile :
      path:(node_fs_promises_FileHandle, PathLike.t_0) union2 ->
        ?options:anonymous_interface_6 or_null ->
          unit -> Buffer.t_0 Promise.t)
      =
      fun ~path:(x577 : (node_fs_promises_FileHandle, PathLike.t_0) union2)
        ->
        fun ?options:(x578 : anonymous_interface_6 or_null option) ->
          fun () ->
            Promise.t_of_js Buffer.t_0_of_js
              (let x584 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
    ...
    let (readFile :
      path:(node_fs_promises_FileHandle, PathLike.t_0) union2 ->
        options:(BufferEncoding.t_0, anonymous_interface_5) union2 ->
          string Promise.t)
      =
      fun ~path:(x586 : (node_fs_promises_FileHandle, PathLike.t_0) union2)
        ->
        fun
          ~options:(x589 :
                     (BufferEncoding.t_0, anonymous_interface_5) union2)
          ...
          Promise.t_of_js Ojs.string_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "node:fs/promises")
               ...
               [|(union2_to_js node_fs_promises_FileHandle_to_js
                    PathLike.t_0_to_js x586);(union2_to_js
                                                BufferEncoding.t_0_to_js
    ...
    let (readFile :
      path:(node_fs_promises_FileHandle, PathLike.t_0) union2 ->
        ?options:BufferEncoding.t_0 or_null ->
          unit -> Buffer.t_0 or_string Promise.t)
      =
      fun ~path:(x593 : (node_fs_promises_FileHandle, PathLike.t_0) union2)
        ->
        fun ?options:(x594 : BufferEncoding.t_0 or_null option) ->
          fun () ->
            Promise.t_of_js
              (fun (x601 : Ojs.t) -> or_string_of_js Buffer.t_0_of_js x601)
              (let x600 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
               Ojs.call (Ojs.get_prop_ascii x600 "readFile") "apply"
                 [|x600;((let x595 =
                          ...
                          x595))|])
    let (opendir :
      path:string -> ?options:OpenDirOptions.t_0 -> unit -> Dir.t_0 Promise.t)
      =
      fun ~path:(x603 : string) ->
        fun ?options:(x604 : OpenDirOptions.t_0 option) ->
          fun () ->
            Promise.t_of_js Dir.t_0_of_js
              (let x607 = Ojs.get_prop_ascii Ojs.global "node:fs/promises" in
