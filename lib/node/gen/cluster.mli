...
module Cluster : sig
  ...
  module Worker : sig
    ...
    val get_process : t -> Child_process.Child_process.ChildProcess.t
      [@@js.get "process"]

    val set_process : t -> Child_process.Child_process.ChildProcess.t -> unit
      [@@js.set "process"]

    val send
      :  t
      -> message:Child_process.Child_process.Serializable.t
      -> ?sendHandle:Child_process.Child_process.SendHandle.t
  ...
  module Cluster : sig
    ...
    val get_workers : t -> cluster_Worker Dict.t [@@js.get "workers"]

    val set_workers : t -> cluster_Worker Dict.t -> unit [@@js.set "workers"]
  ...
  val workers : cluster_Worker Dict.t [@@js.global "workers"]
