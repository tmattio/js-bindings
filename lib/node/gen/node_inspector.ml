...
module Node_inspector = struct  end
module Inspector =
  struct
    ...
    module Session =
      struct
        ...
        let (create : unit -> t) =
          fun () ->
            t_of_js
              (Ojs.new_obj
                 (Ojs.get_prop_ascii
                    (Ojs.get_prop_ascii Ojs.global "inspector") "Session")
                 [||])
        let (connect : t -> unit) =
          ...
          t ->
            method_:[ `Runtime_releaseObject ] ->
              ?params:inspector_Runtime_ReleaseObjectParameterType ->
                ?callback:(err:Error.t_0 or_null -> unit) -> unit -> unit)
          =
          fun (x1594 : t) ->
            fun ~method_:(x1586 : [ `Runtime_releaseObject ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x1588 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''' :
          ...
          fun (x1602 : t) ->
            fun ~method_:(x1596 : [ `Runtime_releaseObject ]) ->
              fun ?callback:(x1597 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x1612 : t) ->
            fun ~method_:(x1604 : [ `Runtime_releaseObjectGroup ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x1606 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''' :
          ...
          fun (x1620 : t) ->
            fun ~method_:(x1614 : [ `Runtime_releaseObjectGroup ]) ->
              fun ?callback:(x1615 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''' :
          ...
          fun (x1628 : t) ->
            fun ~method_:(x1622 : [ `Runtime_runIfWaitingForDebugger ]) ->
              fun ?callback:(x1623 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''' :
          ...
          fun (x1636 : t) ->
            fun ~method_:(x1630 : [ `Runtime_enable ]) ->
              fun ?callback:(x1631 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''' :
          ...
          fun (x1644 : t) ->
            fun ~method_:(x1638 : [ `Runtime_disable ]) ->
              fun ?callback:(x1639 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''' :
          ...
          fun (x1652 : t) ->
            fun ~method_:(x1646 : [ `Runtime_discardConsoleEntries ]) ->
              fun ?callback:(x1647 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x1662 : t) ->
            fun
              ...
              fun
                ...
                ->
                fun
                  ?callback:(x1656 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''' :
          ...
          fun (x1670 : t) ->
            fun
              ...
              ->
              fun ?callback:(x1665 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''' :
          ...
          fun (x1767 : t) ->
            fun ~method_:(x1761 : [ `Debugger_disable ]) ->
              fun ?callback:(x1762 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x1777 : t) ->
            fun ~method_:(x1769 : [ `Debugger_setBreakpointsActive ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x1771 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''' :
          ...
          fun (x1785 : t) ->
            fun ~method_:(x1779 : [ `Debugger_setBreakpointsActive ]) ->
              fun ?callback:(x1780 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x1795 : t) ->
            fun ~method_:(x1787 : [ `Debugger_setSkipAllPauses ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x1789 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''' :
          ...
          fun (x1803 : t) ->
            fun ~method_:(x1797 : [ `Debugger_setSkipAllPauses ]) ->
              fun ?callback:(x1798 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x1853 : t) ->
            fun ~method_:(x1845 : [ `Debugger_removeBreakpoint ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x1847 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1861 : t) ->
            fun ~method_:(x1855 : [ `Debugger_removeBreakpoint ]) ->
              fun ?callback:(x1856 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x1891 : t) ->
            fun ~method_:(x1883 : [ `Debugger_continueToLocation ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x1885 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1899 : t) ->
            fun ~method_:(x1893 : [ `Debugger_continueToLocation ]) ->
              fun ?callback:(x1894 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x1909 : t) ->
            fun ~method_:(x1901 : [ `Debugger_pauseOnAsyncCall ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x1903 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1917 : t) ->
            fun ~method_:(x1911 : [ `Debugger_pauseOnAsyncCall ]) ->
              fun ?callback:(x1912 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1925 : t) ->
            fun ~method_:(x1919 : [ `Debugger_stepOver ]) ->
              fun ?callback:(x1920 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x1935 : t) ->
            fun ~method_:(x1927 : [ `Debugger_stepInto ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x1929 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1943 : t) ->
            fun ~method_:(x1937 : [ `Debugger_stepInto ]) ->
              fun ?callback:(x1938 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1951 : t) ->
            fun ~method_:(x1945 : [ `Debugger_stepOut ]) ->
              fun ?callback:(x1946 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1959 : t) ->
            fun ~method_:(x1953 : [ `Debugger_pause ]) ->
              fun ?callback:(x1954 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1967 : t) ->
            fun ~method_:(x1961 : [ `Debugger_scheduleStepIntoAsync ]) ->
              fun ?callback:(x1962 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''' :
          ...
          fun (x1975 : t) ->
            fun ~method_:(x1969 : [ `Debugger_resume ]) ->
              fun ?callback:(x1970 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2085 : t) ->
            fun ~method_:(x2077 : [ `Debugger_setPauseOnExceptions ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2079 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2093 : t) ->
            fun ~method_:(x2087 : [ `Debugger_setPauseOnExceptions ]) ->
              fun ?callback:(x2088 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2123 : t) ->
            fun ~method_:(x2115 : [ `Debugger_setVariableValue ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2117 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2131 : t) ->
            fun ~method_:(x2125 : [ `Debugger_setVariableValue ]) ->
              fun ?callback:(x2126 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2141 : t) ->
            fun ~method_:(x2133 : [ `Debugger_setReturnValue ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2135 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2149 : t) ->
            fun ~method_:(x2143 : [ `Debugger_setReturnValue ]) ->
              fun ?callback:(x2144 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2159 : t) ->
            fun ~method_:(x2151 : [ `Debugger_setAsyncCallStackDepth ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2153 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2167 : t) ->
            fun ~method_:(x2161 : [ `Debugger_setAsyncCallStackDepth ]) ->
              fun ?callback:(x2162 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2177 : t) ->
            fun ~method_:(x2169 : [ `Debugger_setBlackboxPatterns ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2171 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2185 : t) ->
            fun ~method_:(x2179 : [ `Debugger_setBlackboxPatterns ]) ->
              fun ?callback:(x2180 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2195 : t) ->
            fun ~method_:(x2187 : [ `Debugger_setBlackboxedRanges ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2189 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2203 : t) ->
            fun ~method_:(x2197 : [ `Debugger_setBlackboxedRanges ]) ->
              fun ?callback:(x2198 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2211 : t) ->
            fun ~method_:(x2205 : [ `Console_enable ]) ->
              fun ?callback:(x2206 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2219 : t) ->
            fun ~method_:(x2213 : [ `Console_disable ]) ->
              fun ?callback:(x2214 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2227 : t) ->
            fun ~method_:(x2221 : [ `Console_clearMessages ]) ->
              fun ?callback:(x2222 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2235 : t) ->
            fun ~method_:(x2229 : [ `Profiler_enable ]) ->
              fun ?callback:(x2230 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2243 : t) ->
            fun ~method_:(x2237 : [ `Profiler_disable ]) ->
              fun ?callback:(x2238 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2253 : t) ->
            fun ~method_:(x2245 : [ `Profiler_setSamplingInterval ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2247 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2261 : t) ->
            fun ~method_:(x2255 : [ `Profiler_setSamplingInterval ]) ->
              fun ?callback:(x2256 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2269 : t) ->
            fun ~method_:(x2263 : [ `Profiler_start ]) ->
              fun ?callback:(x2264 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2288 : t) ->
            fun ~method_:(x2280 : [ `Profiler_startPreciseCoverage ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2282 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2296 : t) ->
            fun ~method_:(x2290 : [ `Profiler_startPreciseCoverage ]) ->
              fun ?callback:(x2291 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2304 : t) ->
            fun ~method_:(x2298 : [ `Profiler_stopPreciseCoverage ]) ->
              fun ?callback:(x2299 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2330 : t) ->
            fun ~method_:(x2324 : [ `Profiler_startTypeProfile ]) ->
              fun ?callback:(x2325 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2338 : t) ->
            fun ~method_:(x2332 : [ `Profiler_stopTypeProfile ]) ->
              fun ?callback:(x2333 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2355 : t) ->
            fun ~method_:(x2349 : [ `HeapProfiler_enable ]) ->
              fun ?callback:(x2350 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2363 : t) ->
            fun ~method_:(x2357 : [ `HeapProfiler_disable ]) ->
              fun ?callback:(x2358 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2373 : t) ->
            fun ~method_:(x2365 : [ `HeapProfiler_startTrackingHeapObjects ])
              ...
              fun
                ...
                ->
                fun
                  ?callback:(x2367 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2381 : t) ->
            fun ~method_:(x2375 : [ `HeapProfiler_startTrackingHeapObjects ])
              ->
              fun ?callback:(x2376 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2391 : t) ->
            fun ~method_:(x2383 : [ `HeapProfiler_stopTrackingHeapObjects ])
              ...
              fun
                ...
                ->
                fun
                  ?callback:(x2385 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2399 : t) ->
            fun ~method_:(x2393 : [ `HeapProfiler_stopTrackingHeapObjects ])
              ->
              fun ?callback:(x2394 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2409 : t) ->
            fun ~method_:(x2401 : [ `HeapProfiler_takeHeapSnapshot ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2403 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2417 : t) ->
            fun ~method_:(x2411 : [ `HeapProfiler_takeHeapSnapshot ]) ->
              fun ?callback:(x2412 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2425 : t) ->
            fun ~method_:(x2419 : [ `HeapProfiler_collectGarbage ]) ->
              fun ?callback:(x2420 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2455 : t) ->
            fun ~method_:(x2447 : [ `HeapProfiler_addInspectedHeapObject ])
              ...
              fun
                ...
                ->
                fun
                  ?callback:(x2449 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2463 : t) ->
            fun ~method_:(x2457 : [ `HeapProfiler_addInspectedHeapObject ])
              ->
              fun ?callback:(x2458 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2493 : t) ->
            fun ~method_:(x2485 : [ `HeapProfiler_startSampling ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2487 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2501 : t) ->
            fun ~method_:(x2495 : [ `HeapProfiler_startSampling ]) ->
              fun ?callback:(x2496 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2538 : t) ->
            fun ~method_:(x2530 : [ `NodeTracing_start ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2532 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2546 : t) ->
            fun ~method_:(x2540 : [ `NodeTracing_start ]) ->
              fun ?callback:(x2541 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2554 : t) ->
            fun ~method_:(x2548 : [ `NodeTracing_stop ]) ->
              fun ?callback:(x2549 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2564 : t) ->
            fun ~method_:(x2556 : [ `NodeWorker_sendMessageToWorker ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2558 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2572 : t) ->
            fun ~method_:(x2566 : [ `NodeWorker_sendMessageToWorker ]) ->
              fun ?callback:(x2567 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2582 : t) ->
            fun ~method_:(x2574 : [ `NodeWorker_enable ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2576 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2590 : t) ->
            fun ~method_:(x2584 : [ `NodeWorker_enable ]) ->
              fun ?callback:(x2585 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2598 : t) ->
            fun ~method_:(x2592 : [ `NodeWorker_disable ]) ->
              fun ?callback:(x2593 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2608 : t) ->
            fun ~method_:(x2600 : [ `NodeWorker_detach ]) ->
              fun
                ...
                ->
                fun
                  ?callback:(x2602 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
        ...
        let (post''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          fun (x2616 : t) ->
            fun ~method_:(x2610 : [ `NodeWorker_detach ]) ->
              fun ?callback:(x2611 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
          ...
          fun (x2626 : t) ->
            fun
              ...
              fun
                ...
                ->
                fun
                  ?callback:(x2620 : (err:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    ignore
          ...
          fun (x2634 : t) ->
            fun
              ~method_:(x2628 :
                         [ `NodeRuntime_notifyWhenWaitingForDisconnect ])
              ->
              fun ?callback:(x2629 : (err:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  ignore
        ...
        let (cast : t -> EventEmitter.t_0) =
          fun (x3391 : t) -> EventEmitter.t_0_of_js (t_to_js x3391)
      end
      ...
      fun ?port:(x3392 : float option) ->
        fun ?host:(x3393 : string option) ->
          fun ?wait:(x3394 : bool option) ->
            fun () ->
              ignore
                (let x3399 = Ojs.get_prop_ascii Ojs.global "inspector" in
    ...
    let (close : unit -> unit) =
      fun () ->
        ignore
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "inspector") "close" [||])
    let (url : unit -> string or_undefined) =
      fun () ->
        or_undefined_of_js Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "inspector") "url" [||])
    let (waitForDebugger : unit -> unit) =
      fun () ->
        ignore
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "inspector")
             "waitForDebugger" [||])
  end
