  ...
  struct
        ...
        let (apply :
          ...
          fun (x24 : t) ->
            fun ~hostname:(x17 : string) ->
              fun ~options:(x18 : Dns.LookupOneOptions.t_0) ->
                fun
                  ~callback:(x19 :
                  ...
                  ignore
                    (Ojs.apply (t_to_js x24)
                       [|(Ojs.string_to_js x17);(Dns.LookupOneOptions.t_0_to_js
                                                   x18);(Ojs.fun_to_js 3
                                                           (fun (x20 : Ojs.t)
                                                              ->
                                                              fun
    ...
    module Socket =
      struct
        ...
        let (create : ?options:net_SocketConstructorOpts -> unit -> t) =
          fun ?options:(x101 : net_SocketConstructorOpts option) ->
            fun () ->
              t_of_js
                (Ojs.new_obj_arr
                   (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "net")
                      "Socket")
                   (let x102 =
        ...
        let (write :
          t ->
            buffer:Uint8Array.t or_string ->
              ?cb:(?err:Error.t_0 -> unit -> unit) -> unit -> bool)
          =
          fun (x111 : t) ->
            fun ~buffer:(x104 : Uint8Array.t or_string) ->
              fun ?cb:(x105 : (?err:Error.t_0 -> unit -> unit) option) ->
                fun () ->
                  Ojs.bool_of_js
        ...
        let (write' :
          ...
          fun (x122 : t) ->
            fun ~str:(x113 : Uint8Array.t or_string) ->
              fun ?encoding:(x114 : BufferEncoding.t_0 option) ->
                fun ?cb:(x115 : (?err:Error.t_0 -> unit -> unit) option) ->
                  fun () ->
                    Ojs.bool_of_js
                     ...
                     Ojs.call (Ojs.get_prop_ascii x148 "connect") "apply"
                       [|x148;((let x145 =
                                ...
                                (match x144 with
                                 ...
                                 | None -> ());
                                x145))|])
        let (setEncoding : t -> ?encoding:BufferEncoding.t_0 -> unit -> t) =
          fun (x152 : t) ->
            fun ?encoding:(x149 : BufferEncoding.t_0 option) ->
              fun () ->
                t_of_js
        ...
        let (end_'' :
          ...
          fun (x208 : t) ->
            fun ~str:(x201 : Uint8Array.t or_string) ->
              fun ?encoding:(x202 : BufferEncoding.t_0 option) ->
        ...
        let (addListener''' :
          t -> event:[ `data ] -> listener:(data:Buffer.t_0 -> unit) -> t) =
          fun (x225 : t) ->
            fun ~event:(x222 : [ `data ]) ->
              fun ~listener:(x223 : data:Buffer.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x225) "addListener"
                     [|((match x222 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x224 : Ojs.t) ->
                            x223 ~data:(Buffer.t_0_of_js x224)))|])
        let (addListener'''' :
        ...
        let (addListener'''''' :
          ...
          fun (x235 : t) ->
            fun ~event:(x232 : [ `error ]) ->
              fun ~listener:(x233 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x235) "addListener"
                     [|((match x232 with | `error -> Ojs.string_to_js "error"));(
                       Ojs.fun_to_js 1
                         (fun (x234 : Ojs.t) ->
                            x233 ~err:(Error.t_0_of_js x234)))|])
        let (addListener''''''' :
          t ->
            event:[ `lookup ] ->
              listener:(err:Error.t_0 ->
                          address:string ->
            ...
            fun ~event:(x257 : [ `connect ]) ->
              Ojs.bool_of_js
                (Ojs.call (t_to_js x258) "emit"
                   [|((match x257 with
                       | `connect -> Ojs.string_to_js "connect"))|])
        let (emit''' : t -> event:[ `data ] -> data:Buffer.t_0 -> bool) =
          fun (x261 : t) ->
            fun ~event:(x259 : [ `data ]) ->
              fun ~data:(x260 : Buffer.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x261) "emit"
                     [|((match x259 with | `data -> Ojs.string_to_js "data"));(
                       Buffer.t_0_to_js x260)|])
                      ...
                      Ojs.bool_of_js
                        (Ojs.call (t_to_js x275) "emit"
                           [|((match x269 with
                             ...
                             Error.t_0_to_js x270);(Ojs.string_to_js x271);(
        ...
        let (on''' :
          ...
          fun (x293 : t) ->
            fun ~event:(x290 : [ `data ]) ->
              fun ~listener:(x291 : data:Buffer.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x293) "on"
                     [|((match x290 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x292 : Ojs.t) ->
                            x291 ~data:(Buffer.t_0_of_js x292)))|])
        ...
        let (once''' :
          ...
          fun (x330 : t) ->
            fun ~event:(x327 : [ `data ]) ->
              fun ~listener:(x328 : data:Buffer.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x330) "once"
                     [|((match x327 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x329 : Ojs.t) ->
                            x328 ~data:(Buffer.t_0_of_js x329)))|])
        let (once'''' :
          t -> event:[ `drain ] -> listener:(unit -> unit) -> t) =
          fun (x333 : t) ->
        ...
        let (cast : t -> Stream.Duplex.t_0) =
          fun (x426 : t) -> Stream.Duplex.t_0_of_js (t_to_js x426)
      end
    ...
    module Server =
      struct
            ...
            fun
              ...
              fun () ->
                t_of_js
                  (Ojs.new_obj_arr
                     (Ojs.get_prop_ascii
                        (Ojs.get_prop_ascii Ojs.global "net") "Server")
                     (let x469 =
                        Ojs.new_obj (Ojs.get_prop_ascii Ojs.global "Array")
                          [||] in
                      (match x467 with
                    ...
                    (let x542 = t_to_js x541 in
                     Ojs.call (Ojs.get_prop_ascii x542 "listen") "apply"
                       [|x542;((let x539 =
                                ...
                                x539))|])
        let (close :
          t -> ?callback:(?err:Error.t_0 -> unit -> unit) -> unit -> t) =
          fun (x548 : t) ->
            fun ?callback:(x543 : (?err:Error.t_0 -> unit -> unit) option) ->
              fun () ->
                t_of_js
        ...
        let (getConnections :
          t -> cb:(error:Error.t_0 or_null -> count:float -> unit) -> unit) =
          fun (x557 : t) ->
            fun ~cb:(x553 : error:Error.t_0 or_null -> count:float -> unit)
              ->
              ignore
                (Ojs.call (t_to_js x557) "getConnections"
                   [|(Ojs.fun_to_js 2
                        (fun (x554 : Ojs.t) ->
                           fun (x556 : Ojs.t) ->
                             x553 ~error:(or_null_of_js Error.t_0_of_js x554)
        ...
        let (cast : t -> EventEmitter.t_0) =
          fun (x681 : t) -> EventEmitter.t_0_of_js (t_to_js x681)
      end
    ...
    let (createServer :
      ...
      fun ?connectionListener:(x698 : (socket:net_Socket -> unit) option) ->
        fun () ->
          net_Server_of_js
            (let x702 = Ojs.get_prop_ascii Ojs.global "net" in
    ...
    let (createServer :
      ...
      fun ?options:(x703 : net_ServerOpts option) ->
        fun ?connectionListener:(x704 : (socket:net_Socket -> unit) option)
          ...
          fun () ->
            net_Server_of_js
              (let x709 = Ojs.get_prop_ascii Ojs.global "net" in
    ...
    let (connect :
      ...
      fun ~options:(x710 : net_NetConnectOpts) ->
        fun ?connectionListener:(x711 : (unit -> unit) option) ->
          fun () ->
            net_Socket_of_js
              (let x714 = Ojs.get_prop_ascii Ojs.global "net" in
      ...
      fun ~port:(x715 : float) ->
        fun ?host:(x716 : string option) ->
          fun ?connectionListener:(x717 : (unit -> unit) option) ->
            fun () ->
              net_Socket_of_js
                (let x721 = Ojs.get_prop_ascii Ojs.global "net" in
    ...
    let (connect :
      ...
      fun ~path:(x722 : string) ->
        fun ?connectionListener:(x723 : (unit -> unit) option) ->
          fun () ->
            net_Socket_of_js
              (let x726 = Ojs.get_prop_ascii Ojs.global "net" in
    ...
    let (createConnection :
      ...
      fun ~options:(x727 : net_NetConnectOpts) ->
        fun ?connectionListener:(x728 : (unit -> unit) option) ->
          fun () ->
            net_Socket_of_js
              (let x731 = Ojs.get_prop_ascii Ojs.global "net" in
      ...
      fun ~port:(x732 : float) ->
        fun ?host:(x733 : string option) ->
          fun ?connectionListener:(x734 : (unit -> unit) option) ->
            fun () ->
              net_Socket_of_js
                (let x738 = Ojs.get_prop_ascii Ojs.global "net" in
    ...
    let (createConnection :
      ...
      fun ~path:(x739 : string) ->
        fun ?connectionListener:(x740 : (unit -> unit) option) ->
          fun () ->
            net_Socket_of_js
              (let x743 = Ojs.get_prop_ascii Ojs.global "net" in
    ...
    let (isIP : input:string -> float) =
      fun ~input:(x744 : string) ->
        Ojs.float_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "net") "isIP"
             [|(Ojs.string_to_js x744)|])
    let (isIPv4 : input:string -> bool) =
      fun ~input:(x745 : string) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "net") "isIPv4"
             [|(Ojs.string_to_js x745)|])
    let (isIPv6 : input:string -> bool) =
      fun ~input:(x746 : string) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "net") "isIPv6"
