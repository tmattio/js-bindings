...
(* module RequireResolve : sig type t = _RequireResolve

   val t_to_js : t -> Ojs.t

   val t_of_js : Ojs.t -> t

   val cast : t -> _NodeJS_RequireResolve [@@js.cast] end [@@js.scope
   "RequireResolve"] *)
...
module ReadableStream : sig
  ...
  val pipe : t -> destination:'T -> ?options:anonymous_interface_0 -> unit -> 'T
    [@@js.call "pipe"]
...
module RequireResolve : sig
  ...
  val apply : t -> id:string -> ?options:anonymous_interface_1 -> unit -> string
    [@@js.apply]
...
module RequireExtensions : sig
  ...
  (* val _json : t -> m:_NodeJS_Module -> filename:string -> any [@@js.call
     ".json"] *)

  (* val _node : t -> m:_NodeJS_Module -> filename:string -> any [@@js.call
     ".node"] *)
