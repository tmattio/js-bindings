...
module Internal : sig
  ...
  module Types : sig
    ...
    and child_process_ExecFileException =
      (child_process_ExecException, NodeJS.ErrnoException.t_0) intersection2
...
module Child_process : sig
  ...
  module ChildProcess : sig
    ...
    val get_stdio
      :  t
      -> Writable.t_0 or_null
         * Readable.t_0 or_null
         * Readable.t_0 or_null
         * (Readable.t_0, Writable.t_0) union2 or_null_or_undefined
         * (Readable.t_0, Writable.t_0) union2 or_null_or_undefined
      [@@js.get "stdio"]
    ...
    val kill : t -> ?signal:NodeJS.Signals.t_0 or_number -> unit -> bool
      [@@js.call "kill"]
    ...
    val addListener'
      ...
      -> event:([ `close ][@js.enum])
      -> listener:
           (code:float or_null -> signal:NodeJS.Signals.t_0 or_null -> unit)
      -> t
      [@@js.call "addListener"]
    ...
    val emit'
      ...
      -> event:([ `close ][@js.enum])
      -> code:float or_null
      -> signal:NodeJS.Signals.t_0 or_null
      -> bool
      [@@js.call "emit"]
  ...
  module ExecOptions : sig
    ...
    val get_killSignal : t -> NodeJS.Signals.t_0 or_number
      [@@js.get "killSignal"]

    val set_killSignal : t -> NodeJS.Signals.t_0 or_number -> unit
      [@@js.set "killSignal"]
  ...
  val exec
    ...
    -> ?callback:
         (error:child_process_ExecException or_null
          -> stdout:Buffer.t_0 or_string
          -> stderr:Buffer.t_0 or_string
          -> unit)
    -> unit
    -> child_process_ChildProcess
    [@@js.global "exec"]
  ...
  val exec
    :  command:string
    -> options:
         (BaseEncodingOptions.t_0, child_process_ExecOptions) intersection2
         or_null_or_undefined
    -> ?callback:
         (error:child_process_ExecException or_null
          -> stdout:Buffer.t_0 or_string
  ...
  val execFile
    :  file:string
    -> options:
         (BaseEncodingOptions.t_0, child_process_ExecFileOptions) intersection2
         or_null_or_undefined
    -> child_process_ChildProcess
    [@@js.global "execFile"]
  ...
  module SpawnSyncOptions : sig
    ...
    val set_input : t -> NodeJS.ArrayBufferView.t_0 or_string -> unit
      [@@js.set "input"]
    ...
    val set_encoding
      :  t
      -> (BufferEncoding.t_0, ([ `buffer ][@js.enum])) or_enum or_null
      -> unit
      [@@js.set "encoding"]
  ...
  module SpawnSyncReturns : sig
    ...
    val set_signal : 'T t -> NodeJS.Signals.t_0 or_null -> unit
      [@@js.set "signal"]
  ...
  val spawnSync : command:string -> Buffer.t_0 child_process_SpawnSyncReturns
    [@@js.global "spawnSync"]
  ...
  val spawnSync
    ...
    -> unit
    -> Buffer.t_0 child_process_SpawnSyncReturns
    [@@js.global "spawnSync"]
