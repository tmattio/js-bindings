  ...
  struct
    module InspectOptions =
      struct
        ...
        let (cast : t -> NodeJS.InspectOptions.t_0) =
          fun (x31 : t) -> NodeJS.InspectOptions.t_0_of_js (t_to_js x31)
      end
    module Style =
      struct
        type t = util_Style
    ...
    let (format : ?format:any -> param:any list -> string) =
      fun ?format:(x45 : any option) ->
        fun ~param:(x46 : any list) ->
          Ojs.string_of_js
            (let x50 = Ojs.get_prop_ascii Ojs.global "util" in
      ...
      fun ~inspectOptions:(x51 : util_InspectOptions) ->
        fun ?format:(x52 : any option) ->
          fun ~param:(x53 : any list) ->
            Ojs.string_of_js
              (let x57 = Ojs.get_prop_ascii Ojs.global "util" in
    ...
    let (log : string:string -> unit) =
      fun ~string:(x58 : string) ->
        ignore
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "log"
        ...
        fun ?showHidden:(x60 : bool option) ->
          fun ?depth:(x61 : float or_null option) ->
            fun ?color:(x62 : bool option) ->
              fun () ->
                Ojs.string_of_js
                  (let x68 = Ojs.get_prop_ascii Ojs.global "util" in
    ...
    let (inspect : object_:any -> options:util_InspectOptions -> string) =
      fun ~object_:(x69 : any) ->
        fun ~options:(x70 : util_InspectOptions) ->
          Ojs.string_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "inspect"
               [|(any_to_js x69);(util_InspectOptions_to_js x70)|])
    module Inspect =
      struct
        let (colors : (float * float) NodeJS.Dict.t_1) =
          NodeJS.Dict.t_1_of_js
            ...
            (Ojs.get_prop_ascii
               (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "util")
                  "inspect") "colors")
        let (styles : any) =
          any_of_js
            (Ojs.get_prop_ascii
    ...
    let (isArray : object_:any -> bool) =
      fun ~object_:(x73 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isArray"
             [|(any_to_js x73)|])
    let (isRegExp : object_:any -> bool) =
      fun ~object_:(x74 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isRegExp"
             [|(any_to_js x74)|])
    let (isDate : object_:any -> bool) =
      fun ~object_:(x75 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isDate"
             [|(any_to_js x75)|])
    let (isError : object_:any -> bool) =
      fun ~object_:(x76 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isError"
             [|(any_to_js x76)|])
    let (inherits : constructor:any -> superConstructor:any -> unit) =
      fun ~constructor:(x77 : any) ->
        fun ~superConstructor:(x78 : any) ->
          ignore
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "inherits"
      ...
      fun ~key:(x79 : string) ->
        fun ~msg:(x80 : string) ->
          fun ~param:(x81 : any list) ->
            ignore
              (Ojs.call
                 (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "debuglog"
                    [|(Ojs.string_to_js x79)|]) "apply"
                 [|Ojs.null;((let x82 =
                                Ojs.new_obj
                                  (Ojs.get_prop_ascii Ojs.global "Array")
                                  [||] in
    ...
    let (isBoolean : object_:any -> bool) =
      fun ~object_:(x84 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isBoolean"
             [|(any_to_js x84)|])
    let (isBuffer : object_:any -> bool) =
      fun ~object_:(x85 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isBuffer"
             [|(any_to_js x85)|])
    let (isFunction : object_:any -> bool) =
      fun ~object_:(x86 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isFunction"
             [|(any_to_js x86)|])
    let (isNull : object_:any -> bool) =
      fun ~object_:(x87 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isNull"
             [|(any_to_js x87)|])
    let (isNullOrUndefined : object_:any -> bool) =
      fun ~object_:(x88 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util")
             "isNullOrUndefined" [|(any_to_js x88)|])
    let (isNumber : object_:any -> bool) =
      fun ~object_:(x89 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isNumber"
             [|(any_to_js x89)|])
    let (isObject : object_:any -> bool) =
      fun ~object_:(x90 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isObject"
             [|(any_to_js x90)|])
    let (isPrimitive : object_:any -> bool) =
      fun ~object_:(x91 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isPrimitive"
             [|(any_to_js x91)|])
    let (isString : object_:any -> bool) =
      fun ~object_:(x92 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isString"
             [|(any_to_js x92)|])
    let (isSymbol : object_:any -> bool) =
      fun ~object_:(x93 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isSymbol"
             [|(any_to_js x93)|])
    let (isUndefined : object_:any -> bool) =
      fun ~object_:(x94 : any) ->
        Ojs.bool_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "isUndefined"
             [|(any_to_js x94)|])
      ...
      fun ~fn:(x95 : 'T) ->
        fun ~message:(x96 : string) ->
          fun ?code:(x97 : string option) ->
            fun () ->
              Obj.magic
                (let x100 = Ojs.get_prop_ascii Ojs.global "util" in
    ...
    let (isDeepStrictEqual : val1:any -> val2:any -> bool) =
      fun ~val1:(x101 : any) ->
        fun ~val2:(x102 : any) ->
          Ojs.bool_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "util")
               "isDeepStrictEqual" [|(any_to_js x101);(any_to_js x102)|])
    let (callbackify :
      fn:(unit -> unit Promise.t) ->
        callback:(err:NodeJS.ErrnoException.t_0 -> unit) -> unit)
      =
      fun ~fn:(x103 : unit -> unit Promise.t) ->
        fun ~callback:(x105 : err:NodeJS.ErrnoException.t_0 -> unit) ->
          ignore
            (Ojs.apply
               (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "callbackify"
                  [|(Ojs.fun_to_js 1
                       (fun _ -> Promise.t_to_js Ojs.unit_to_js (x103 ())))|])
               [|(Ojs.fun_to_js 1
                    (fun (x106 : Ojs.t) ->
                       x105 ~err:(NodeJS.ErrnoException.t_0_of_js x106)))|])
    let (callbackify :
          ...
          ignore
            (Ojs.apply
               ...
               [|(Ojs.fun_to_js 2
                    (fun (x110 : Ojs.t) ->
                       fun (x111 : Ojs.t) ->
                         x109 ~err:(NodeJS.ErrnoException.t_0_of_js x110)
    ...
    let (callbackify :
      ...
      fun ~fn:(x112 : arg1:'T1 -> unit Promise.t) ->
        fun ~arg1:(x115 : 'T1) ->
          fun ~callback:(x116 : err:NodeJS.ErrnoException.t_0 -> unit) ->
            ignore
              (Ojs.apply
                 (Ojs.call (Ojs.get_prop_ascii Ojs.global "util")
                    "callbackify"
                 ...
                 [|(Obj.magic x115);(Ojs.fun_to_js 1
                                       (fun (x117 : Ojs.t) ->
                                          x116
                                            ~err:(NodeJS.ErrnoException.t_0_of_js
                                                    x117)))|])
    let (callbackify :
    ...
    let (callbackify :
      ...
      fun ~fn:(x125 : arg1:'T1 -> arg2:'T2 -> unit Promise.t) ->
        fun ~arg1:(x129 : 'T1) ->
          fun ~arg2:(x130 : 'T2) ->
            fun ~callback:(x131 : err:NodeJS.ErrnoException.t_0 -> unit) ->
              ignore
                (Ojs.apply
                   (Ojs.call (Ojs.get_prop_ascii Ojs.global "util")
                      "callbackify"
    ...
    let (callbackify :
      ...
      fun ~fn:(x143 : arg1:'T1 -> arg2:'T2 -> arg3:'T3 -> unit Promise.t) ->
        fun ~arg1:(x148 : 'T1) ->
          fun ~arg2:(x149 : 'T2) ->
            fun ~arg3:(x150 : 'T3) ->
              fun ~callback:(x151 : err:NodeJS.ErrnoException.t_0 -> unit) ->
                ignore
                  (Ojs.apply
                     (Ojs.call (Ojs.get_prop_ascii Ojs.global "util")
                        "callbackify"
                     ...
                     [|(Obj.magic x148);(Obj.magic x149);(Obj.magic x150);(
                       Ojs.fun_to_js 1
                         (fun (x152 : Ojs.t) ->
                            x151 ~err:(NodeJS.ErrnoException.t_0_of_js x152)))|])
    let (callbackify :
                       ...
                       Ojs.fun_to_js 2
                         (fun (x162 : Ojs.t) ->
                            fun (x164 : Ojs.t) ->
                              x161
                                ~err:(or_null_of_js
                                        NodeJS.ErrnoException.t_0_of_js x162)
                                ~result:(Obj.magic x164)))|])
    let (callbackify :
      ...
      fun
        ...
        fun ~arg1:(x171 : 'T1) ->
          fun ~arg2:(x172 : 'T2) ->
            fun ~arg3:(x173 : 'T3) ->
              fun ~arg4:(x174 : 'T4) ->
                fun ~callback:(x175 : err:NodeJS.ErrnoException.t_0 -> unit)
                  ->
                  ignore
                    (Ojs.apply
                       (Ojs.call (Ojs.get_prop_ascii Ojs.global "util")
          ...
          fun ~arg2:(x199 : 'T2) ->
            fun ~arg3:(x200 : 'T3) ->
              fun ~arg4:(x201 : 'T4) ->
                fun ~arg5:(x202 : 'T5) ->
                  fun
                    ~callback:(x203 : err:NodeJS.ErrnoException.t_0 -> unit)
                    ->
                    ignore
                      (Ojs.apply
                         (Ojs.call (Ojs.get_prop_ascii Ojs.global "util")
              ...
              fun ~arg4:(x232 : 'T4) ->
                fun ~arg5:(x233 : 'T5) ->
                  fun ~arg6:(x234 : 'T6) ->
                    fun
                      ~callback:(x235 :
                                  err:NodeJS.ErrnoException.t_0 -> unit)
                      ->
                      ignore
                        (Ojs.apply
                           (Ojs.call (Ojs.get_prop_ascii Ojs.global "util")
    ...
    let (promisify : fn:'TCustom util_CustomPromisify -> 'TCustom) =
      fun ~fn:(x281 : 'TCustom util_CustomPromisify) ->
        Obj.magic
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "util") "promisify"
            ...
            fun ?options:(x459 : anonymous_interface_1 option) ->
              fun () ->
                t_of_js
                  (Ojs.new_obj_arr
                     (Ojs.get_prop_ascii
                        (Ojs.get_prop_ascii Ojs.global "util") "TextDecoder")
                     (let x460 =
                        Ojs.new_obj (Ojs.get_prop_ascii Ojs.global "Array")
                          [||] in
                      (match x458 with
