...
module Crypto : sig
  ...
  module Certificate : sig
    ...
    val exportChallenge : t -> spkac:crypto_BinaryLike -> Buffer.t_0
    ...
    val verifySpkac : t -> spkac:NodeJS.ArrayBufferView.t_0 -> bool
      [@@js.call "verifySpkac"]
  end
  ...
  val createHmac
    ...
    -> ?options:Stream.TransformOptions.t_0
    -> unit
    -> crypto_Hmac
  ...
  module KeyExportOptions : sig
    ...
    val set_passphrase : 'T t -> Buffer.t_0 or_string -> unit
      [@@js.set "passphrase"]
  end
  ...
  module Cipher : sig
    ...
    val update'
      :  t
      -> data:string
      -> input_encoding:crypto_Encoding
      -> Buffer.t_0
      [@@js.call "update"]

    val update''
      :  t
      -> data:NodeJS.ArrayBufferView.t_0
    ...
    val final' : t -> output_encoding:BufferEncoding.t_0 -> string
      [@@js.call "final"]
  ...
  module Decipher : sig
    ...
    val update : t -> data:NodeJS.ArrayBufferView.t_0 -> Buffer.t_0
      [@@js.call "update"]
  ...
  module DecipherCCM : sig
    ...
    val setAuthTag : t -> buffer:NodeJS.ArrayBufferView.t_0 -> t
      [@@js.call "setAuthTag"]
  ...
  module PrivateKeyInput : sig
    ...
    val set_passphrase : t -> Buffer.t_0 or_string -> unit
      [@@js.set "passphrase"]
  end
  ...
  val createPrivateKey
    :  key:(Buffer.t_0, crypto_PrivateKeyInput) union2 or_string
    -> crypto_KeyObject
  ...
  val createSecretKey : key:NodeJS.ArrayBufferView.t_0 -> crypto_KeyObject
    [@@js.global "createSecretKey"]

  val createSign
    :  algorithm:string
    -> ?options:Stream.WritableOptions.t_0
    -> unit
    -> crypto_Signer
    ...
    val verify
      ...
      -> object_:
           ...
           , ([ `U_s21_pkcs1 of crypto_VerifyPublicKeyInput
             ...
             [@js.union on_field "type"]) )
           union2
      -> signature:NodeJS.ArrayBufferView.t_0
      -> bool
      [@@js.call "verify"]
  ...
  val createDiffieHellman
    :  prime_length:float
    -> ?generator:NodeJS.ArrayBufferView.t_0 or_number
    -> unit
    -> crypto_DiffieHellman
    [@@js.global "createDiffieHellman"]

  val createDiffieHellman
    :  prime:NodeJS.ArrayBufferView.t_0
    -> crypto_DiffieHellman
    [@@js.global "createDiffieHellman"]
  ...
  module DiffieHellman : sig
    ...
    val computeSecret
      :  t
      -> other_public_key:NodeJS.ArrayBufferView.t_0
      -> Buffer.t_0
    ...
    val setPublicKey : t -> public_key:NodeJS.ArrayBufferView.t_0 -> unit
    ...
    val setPrivateKey : t -> private_key:NodeJS.ArrayBufferView.t_0 -> unit
  ...
  val pbkdf2
    ...
    -> keylen:float
    -> digest:string
    -> callback:(err:Error.t_0 or_null -> derivedKey:Buffer.t_0 -> any)
    -> unit
    [@@js.global "pbkdf2"]
  ...
  val randomBytes
    :  size:float
    -> callback:(err:Error.t_0 or_null -> buf:Buffer.t_0 -> unit)
    -> unit
    [@@js.global "randomBytes"]

  val pseudoRandomBytes : size:float -> Buffer.t_0
  ...
  val randomInt
    :  max:float
    -> callback:(err:Error.t_0 or_null -> value:float -> unit)
    -> unit
    [@@js.global "randomInt"]
  ...
  val randomFill
    :  buffer:'T
    -> callback:(err:Error.t_0 or_null -> buf:'T -> unit)
    -> unit
  ...
  val scrypt
    ...
    -> salt:crypto_BinaryLike
    -> keylen:float
    -> callback:(err:Error.t_0 or_null -> derivedKey:Buffer.t_0 -> unit)
    -> unit
    [@@js.global "scrypt"]
  ...
  val timingSafeEqual
    :  a:NodeJS.ArrayBufferView.t_0
    -> b:NodeJS.ArrayBufferView.t_0
    -> bool
  ...
  val diffieHellman : options:anonymous_interface_1 -> Buffer.t_0
