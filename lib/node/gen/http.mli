...
module Http : sig
  ...
  module ClientRequestArgs : sig
    ...
    val createConnection
      :  t
      -> options:t
      -> oncreate:(err:Error.t -> socket:Net.Net.Socket.t -> unit)
      -> Net.Net.Socket.t
  ...
  module Server : sig
    ...
    val cast : t -> Net.Net.Server.t [@@js.cast]
  end
  [@@js.scope "Server"]
  ...
  module OutgoingMessage : sig
    ...
    val get_connection : t -> Net.Net.Socket.t or_null [@@js.get "connection"]

    val set_connection : t -> Net.Net.Socket.t or_null -> unit
      [@@js.set "connection"]

    val get_socket : t -> Net.Net.Socket.t or_null [@@js.get "socket"]

    val set_socket : t -> Net.Net.Socket.t or_null -> unit [@@js.set "socket"]
  ...
  module ServerResponse : sig
    ...
    val assignSocket : t -> socket:Net.Net.Socket.t -> unit
      [@@js.call "assignSocket"]

    val detachSocket : t -> socket:Net.Net.Socket.t -> unit
  ...
  module ClientRequest : sig
    ...
    val create
      :  url:(http_ClientRequestArgs, Url.Url.Url.t) union2 or_string
    ...
    val onSocket : t -> socket:Net.Net.Socket.t -> unit [@@js.call "onSocket"]
    ...
    val addListener'''''
      ...
      -> listener:(socket:Net.Net.Socket.t -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module IncomingMessage : sig
    ...
    val create : socket:Net.Net.Socket.t -> t [@@js.create]
    ...
    val get_connection : t -> Net.Net.Socket.t [@@js.get "connection"]

    val set_connection : t -> Net.Net.Socket.t -> unit [@@js.set "connection"]

    val get_socket : t -> Net.Net.Socket.t [@@js.get "socket"]

    val set_socket : t -> Net.Net.Socket.t -> unit [@@js.set "socket"]
  ...
  module Agent : sig
    ...
    val get_freeSockets : t -> Net.Net.Socket.t list ReadOnlyDict.t
      [@@js.get "freeSockets"]

    val get_sockets : t -> Net.Net.Socket.t list ReadOnlyDict.t
      [@@js.get "sockets"]
  ...
  val request
    :  options:(http_RequestOptions, Url.Url.Url.t) union2 or_string
