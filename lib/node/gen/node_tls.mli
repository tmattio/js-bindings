...
module Tls : sig
  ...
  module PeerCertificate : sig
    ...
    val get_infoAccess : t -> string list NodeJS.Dict.t_1
      [@@js.get "infoAccess"]

    val set_infoAccess : t -> string list NodeJS.Dict.t_1 -> unit
      [@@js.set "infoAccess"]
  ...
  module TLSSocket : sig
    ...
    val set_authorizationError : t -> Error.t_0 -> unit
    ...
    val getPeerFinished : t -> Buffer.t_0 or_undefined
    ...
    val setMaxSendFragment : t -> size:float -> bool
    ...
    val addListener'
      ...
      -> listener:(response:Buffer.t_0 -> unit)
      -> t
      [@@js.call "addListener"]
    ...
    val addListener'''
      ...
      -> listener:(session:Buffer.t_0 -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module PSKCallbackNegotation : sig
    ...
    val get_psk : t -> (DataView.t_0, NodeJS.TypedArray.t) union2
      [@@js.get "psk"]

    val set_psk : t -> (DataView.t_0, NodeJS.TypedArray.t) union2 -> unit
      [@@js.set "psk"]
    ...
    val addListener''
      ...
      -> listener:
           (sessionId:Buffer.t_0
            ...
            -> callback:(err:Error.t_0 -> resp:Buffer.t_0 -> unit)
            -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module SecureContextOptions : sig
    ...
    val get_ca : t -> (Buffer.t_0, Buffer.t_0 or_string list) union2 or_string
      [@@js.get "ca"]
    ...
    val get_cert : t -> (Buffer.t_0, Buffer.t_0 or_string list) union2 or_string
      [@@js.get "cert"]
    ...
    val get_crl : t -> (Buffer.t_0, Buffer.t_0 or_string list) union2 or_string
      [@@js.get "crl"]
    ...
    val get_key
      :  t
      -> (Buffer.t_0, (Buffer.t_0, tls_KeyObject) union2 list) union2 or_string
      [@@js.get "key"]
    ...
    val get_pfx
      :  t
      -> (Buffer.t_0, (Buffer.t_0, tls_PxfObject) union2 or_string list) union2
         or_string
      [@@js.get "pfx"]
