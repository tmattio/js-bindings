...
open AnonymousInterfaces
open Types
module Node_readline = struct  end
module Readline =
  struct
    module Key =
      struct
    ...
    module Interface =
      struct
        ...
        let (create :
          ...
          =
          fun ~input:(x36 : NodeJS.ReadableStream.t_0) ->
            fun ?output:(x37 : NodeJS.WritableStream.t_0 option) ->
              fun
                ?completer:(x38 :
                ...
                fun ?terminal:(x39 : bool option) ->
                  fun () ->
                    t_of_js
                      (Ojs.new_obj_arr
                         (Ojs.get_prop_ascii
                            (Ojs.get_prop_ascii Ojs.global "readline")
                            "Interface")
                         (let x40 =
                            Ojs.new_obj
                          ...
                          ignore
                            (Ojs.call x40 "push"
                               [|(NodeJS.ReadableStream.t_0_to_js x36)|]);
                          (match x37 with
                           | Some x45 ->
                               ignore
                                 (Ojs.call x40 "push"
                                    [|(NodeJS.WritableStream.t_0_to_js x45)|])
                           | None -> ());
                          (match x38 with
                           | Some x42 ->
                               ignore
        ...
        let (create' : options:readline_ReadLineOptions -> t) =
          fun ~options:(x46 : readline_ReadLineOptions) ->
            t_of_js
              (Ojs.new_obj
                 (Ojs.get_prop_ascii
                    (Ojs.get_prop_ascii Ojs.global "readline") "Interface")
        ...
        let (write :
          t -> data:Buffer.t_0 or_string -> ?key:readline_Key -> unit -> unit)
          =
          fun (x66 : t) ->
            fun ~data:(x61 : Buffer.t_0 or_string) ->
                    ...
                    (let x67 = t_to_js x66 in
                     Ojs.call (Ojs.get_prop_ascii x67 "write") "apply"
                       [|x67;((let x63 =
                               ...
                               ignore
                                 (Ojs.call x63 "push"
                                    [|(or_string_to_js Buffer.t_0_to_js x61)|]);
                               (match x62 with
                                | Some x64 ->
                                    ignore
                                      (Ojs.call x63 "push"
        ...
        let (cast : t -> EventEmitter.t_0) =
          fun (x226 : t) -> EventEmitter.t_0_of_js (t_to_js x226)
      end
    module ReadLine =
      struct
    ...
    module ReadLineOptions =
      struct
        ...
        let (set_input : t -> NodeJS.ReadableStream.t_0 -> unit) =
          fun (x248 : t) ->
            fun (x249 : NodeJS.ReadableStream.t_0) ->
              Ojs.set_prop_ascii (t_to_js x248) "input"
                (NodeJS.ReadableStream.t_0_to_js x249)
        ...
        let (set_output : t -> NodeJS.WritableStream.t_0 -> unit) =
          fun (x251 : t) ->
            fun (x252 : NodeJS.WritableStream.t_0) ->
              Ojs.set_prop_ascii (t_to_js x251) "output"
                (NodeJS.WritableStream.t_0_to_js x252)
        let (get_completer :
    ...
    let (createInterface :
      ...
      =
      fun ~input:(x281 : NodeJS.ReadableStream.t_0) ->
        fun ?output:(x282 : NodeJS.WritableStream.t_0 option) ->
          fun
            ?completer:(x283 :
            ...
            fun ?terminal:(x284 : bool option) ->
              fun () ->
                readline_Interface_of_js
                  (let x291 = Ojs.get_prop_ascii Ojs.global "readline" in
                   Ojs.call (Ojs.get_prop_ascii x291 "createInterface")
                     ...
                     [|x291;((let x285 =
                              ...
                              ignore
                                (Ojs.call x285 "push"
                                   [|(NodeJS.ReadableStream.t_0_to_js x281)|]);
                              (match x282 with
                               | Some x290 ->
                                   ignore
                                     (Ojs.call x285 "push"
    ...
    let (createInterface :
      ...
      fun ~options:(x292 : readline_ReadLineOptions) ->
        readline_Interface_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "readline")
             "createInterface" [|(readline_ReadLineOptions_to_js x292)|])
    let (emitKeypressEvents :
      stream:NodeJS.ReadableStream.t_0 ->
        ?readlineInterface:readline_Interface -> unit -> unit)
      =
      fun ~stream:(x293 : NodeJS.ReadableStream.t_0) ->
        fun ?readlineInterface:(x294 : readline_Interface option) ->
          fun () ->
            ignore
              (let x297 = Ojs.get_prop_ascii Ojs.global "readline" in
               Ojs.call (Ojs.get_prop_ascii x297 "emitKeypressEvents")
                 ...
                 [|x297;((let x295 =
                          ...
                          ignore
                            (Ojs.call x295 "push"
                               [|(NodeJS.ReadableStream.t_0_to_js x293)|]);
                          (match x294 with
                           | Some x296 ->
                               ignore
                                 (Ojs.call x295 "push"
    ...
    let (clearLine :
      ...
      =
      fun ~stream:(x308 : NodeJS.WritableStream.t_0) ->
        fun ~dir:(x309 : readline_Direction) ->
          fun ?callback:(x310 : (unit -> unit) option) ->
            fun () ->
              Ojs.bool_of_js
                (let x313 = Ojs.get_prop_ascii Ojs.global "readline" in
                 Ojs.call (Ojs.get_prop_ascii x313 "clearLine") "apply"
                   [|x313;((let x311 =
                            ...
                            ignore
                              (Ojs.call x311 "push"
                                 [|(NodeJS.WritableStream.t_0_to_js x308)|]);
                            ignore
                              (Ojs.call x311 "push"
    ...
    let (clearScreenDown :
      stream:NodeJS.WritableStream.t_0 ->
        ?callback:(unit -> unit) -> unit -> bool)
      =
      fun ~stream:(x314 : NodeJS.WritableStream.t_0) ->
        fun ?callback:(x315 : (unit -> unit) option) ->
          fun () ->
            Ojs.bool_of_js
              (let x318 = Ojs.get_prop_ascii Ojs.global "readline" in
               Ojs.call (Ojs.get_prop_ascii x318 "clearScreenDown") "apply"
                 [|x318;((let x316 =
                          ...
                          ignore
                            (Ojs.call x316 "push"
                               [|(NodeJS.WritableStream.t_0_to_js x314)|]);
                          (match x315 with
                           | Some x317 ->
                               ignore
                                 (Ojs.call x316 "push"
    ...
    let (cursorTo :
      ...
      =
      fun ~stream:(x319 : NodeJS.WritableStream.t_0) ->
        fun ~x:(x320 : float) ->
          fun ?y:(x321 : float option) ->
            fun ?callback:(x322 : (unit -> unit) option) ->
              fun () ->
                Ojs.bool_of_js
                  (let x326 = Ojs.get_prop_ascii Ojs.global "readline" in
                   Ojs.call (Ojs.get_prop_ascii x326 "cursorTo") "apply"
                     [|x326;((let x323 =
                              ...
                              ignore
                                (Ojs.call x323 "push"
                                   [|(NodeJS.WritableStream.t_0_to_js x319)|]);
                              ignore
                                (Ojs.call x323 "push"
    ...
    let (moveCursor :
      ...
      =
      fun ~stream:(x327 : NodeJS.WritableStream.t_0) ->
        fun ~dx:(x328 : float) ->
          fun ~dy:(x329 : float) ->
            fun ?callback:(x330 : (unit -> unit) option) ->
              fun () ->
                Ojs.bool_of_js
                  (let x333 = Ojs.get_prop_ascii Ojs.global "readline" in
                   Ojs.call (Ojs.get_prop_ascii x333 "moveCursor") "apply"
                     [|x333;((let x331 =
                              ...
                              ignore
                                (Ojs.call x331 "push"
                                   [|(NodeJS.WritableStream.t_0_to_js x327)|]);
                              ignore
                                (Ojs.call x331 "push"
