...
module Util : sig
  ...
  val callbackify
    ...
    -> (callback:(err:NodeJS.ErrnoException.t_0 -> unit) -> unit[@js.dummy])
    [@@js.global "callbackify"]

  val callbackify
    :  fn:(unit -> 'TResult Promise.t)
    -> (callback:(err:NodeJS.ErrnoException.t_0 -> result:'TResult -> unit)
        -> unit
       [@js.dummy])
    [@@js.global "callbackify"]
  ...
  val callbackify
    ...
    -> (arg1:'T1 -> callback:(err:NodeJS.ErrnoException.t_0 -> unit) -> unit
       [@js.dummy])
    [@@js.global "callbackify"]
  ...
  val callbackify
    ...
    -> (arg1:'T1
        -> arg2:'T2
        -> callback:(err:NodeJS.ErrnoException.t_0 -> unit)
        -> unit
       [@js.dummy])
    [@@js.global "callbackify"]
  ...
  val callbackify
    ...
    -> (arg1:'T1
        -> arg2:'T2
        -> callback:
             (err:NodeJS.ErrnoException.t_0 or_null -> result:'TResult -> unit)
        -> unit
       [@js.dummy])
    [@@js.global "callbackify"]
  ...
  module TextDecoder : sig
    ...
    val decode
      :  t
      -> ?input:(ArrayBuffer.t, NodeJS.ArrayBufferView.t_0) union2 or_null
