...
module Internal : sig
  ...
  module Types : sig
    ...
    and fs_WriteFileOptions =
      (fs_BaseEncodingOptions, anonymous_interface_15) intersection2 or_string
      or_null
...
module AnonymousInterface10 : sig
  ...
  val set_encoding : t -> BufferEncoding.t_0 or_null -> unit
    [@@js.set "encoding"]
...
module Fs : sig
  ...
  module Dir : sig
    ...
    val read : t -> fs_Dirent or_null Promise.t [@@js.call "read"]

    val read'
      :  t
      -> cb:
           (err:NodeJS.ErrnoException.t_0 or_null
            -> dirEnt:fs_Dirent or_null
            -> unit)
      -> unit
      [@@js.call "read"]
  ...
  module FSWatcher : sig
    ...
    val addListener'
      ...
      -> listener:(eventType:string -> filename:Buffer.t_0 or_string -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  val renameSync : oldPath:fs_PathLike -> newPath:fs_PathLike -> unit
  ...
  val truncate : path:fs_PathLike -> callback:fs_NoParamCallback -> unit
    [@@js.global "truncate"]
  ...
  val truncateSync : path:fs_PathLike -> ?len:float or_null -> unit -> unit
  ...
  val ftruncate : fd:float -> callback:fs_NoParamCallback -> unit
    [@@js.global "ftruncate"]
  ...
  val chownSync : path:fs_PathLike -> uid:float -> gid:float -> unit
    [@@js.global "chownSync"]
  ...
  val lchownSync : path:fs_PathLike -> uid:float -> gid:float -> unit
  ...
  module Chmod : sig
    val __promisify__ : path:fs_PathLike -> mode:fs_Mode -> unit Promise.t
      [@@js.global "__promisify__"]
  end
  [@@js.scope "chmod"]

  val chmodSync : path:fs_PathLike -> mode:fs_Mode -> unit
    [@@js.global "chmodSync"]

  val fchmod : fd:float -> mode:fs_Mode -> callback:fs_NoParamCallback -> unit
    [@@js.global "fchmod"]

  module Fchmod : sig
    val __promisify__ : fd:float -> mode:fs_Mode -> unit Promise.t
      [@@js.global "__promisify__"]
  end
  [@@js.scope "fchmod"]
  ...
  val lchmodSync : path:fs_PathLike -> mode:fs_Mode -> unit
    [@@js.global "lchmodSync"]

  val stat
    :  path:fs_PathLike
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> stats:fs_Stats -> unit)
    -> unit
    [@@js.global "stat"]
  ...
  val stat
    :  path:fs_PathLike
    -> options:
         (fs_StatOptions, anonymous_interface_0) intersection2 or_undefined
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> stats:fs_Stats -> unit)
    -> unit
    [@@js.global "stat"]
  ...
  val stat
    ...
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> stats:fs_BigIntStats -> unit)
    -> unit
    [@@js.global "stat"]
  ...
  val stat
    ...
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null
          -> stats:(fs_BigIntStats, fs_Stats) union2
          -> unit)
    -> unit
    [@@js.global "stat"]
  ...
  module Stat : sig
    ...
    val __promisify__
      ...
      -> unit
      -> (fs_BigIntStats, fs_Stats) union2 Promise.t
      [@@js.global "__promisify__"]
  end
  [@@js.scope "stat"]
  ...
  val statSync
    ...
    -> ?options:fs_StatOptions
    -> unit
    -> (fs_BigIntStats, fs_Stats) union2
    [@@js.global "statSync"]
  ...
  val linkSync : existingPath:fs_PathLike -> newPath:fs_PathLike -> unit
    [@@js.global "linkSync"]
  ...
  val readlink
    ...
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> linkString:string -> unit)
    -> unit
    [@@js.global "readlink"]
  ...
  val readlink
    ...
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null
          -> linkString:Buffer.t_0 or_string
          -> unit)
    -> unit
    [@@js.global "readlink"]
  ...
  val realpath
    ...
    -> options:
         ...
         or_null_or_undefined
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> resolvedPath:string -> unit)
    -> unit
    [@@js.global "realpath"]
  ...
  val realpath
    ...
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null
          -> resolvedPath:Buffer.t_0 or_string
          -> unit)
    -> unit
    [@@js.global "realpath"]
  ...
  val unlink : path:fs_PathLike -> callback:fs_NoParamCallback -> unit
    [@@js.global "unlink"]

  module Unlink : sig
    val __promisify__ : path:fs_PathLike -> unit Promise.t
      [@@js.global "__promisify__"]
  end
  [@@js.scope "unlink"]
  ...
  val rmdir : path:fs_PathLike -> callback:fs_NoParamCallback -> unit
    [@@js.global "rmdir"]

  val rmdir
    :  path:fs_PathLike
    -> options:fs_RmDirOptions
    -> callback:fs_NoParamCallback
    -> unit
    [@@js.global "rmdir"]
  ...
  val rmdirSync : path:fs_PathLike -> ?options:fs_RmDirOptions -> unit -> unit
    [@@js.global "rmdirSync"]
  ...
  val rm : path:fs_PathLike -> callback:fs_NoParamCallback -> unit
    [@@js.global "rm"]

  val rm
    :  path:fs_PathLike
    -> options:fs_RmOptions
    -> callback:fs_NoParamCallback
    -> unit
    [@@js.global "rm"]
  ...
  val rmSync : path:fs_PathLike -> ?options:fs_RmOptions -> unit -> unit
    [@@js.global "rmSync"]
  ...
  val mkdir
    :  path:fs_PathLike
    -> options:(fs_MakeDirectoryOptions, anonymous_interface_18) intersection2
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> ?path:string -> unit -> unit)
    -> unit
    [@@js.global "mkdir"]
  ...
  val mkdir
    :  path:fs_PathLike
    -> options:(fs_MakeDirectoryOptions, fs_Mode) union2 or_null_or_undefined
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> ?path:string -> unit -> unit)
    -> unit
    [@@js.global "mkdir"]

  val mkdir : path:fs_PathLike -> callback:fs_NoParamCallback -> unit
    [@@js.global "mkdir"]
  ...
  val mkdirSync : path:fs_PathLike -> ?options:fs_Mode or_null -> unit -> unit
    [@@js.global "mkdirSync"]
  ...
  val mkdtemp
    ...
    -> options:
         (fs_BaseEncodingOptions, BufferEncoding.t_0) union2
         or_null_or_undefined
    -> callback:(err:NodeJS.ErrnoException.t_0 or_null -> folder:string -> unit)
    -> unit
    [@@js.global "mkdtemp"]
  ...
  val mkdtemp
    ...
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> folder:Buffer.t_0 -> unit)
    -> unit
    [@@js.global "mkdtemp"]
  ...
  val readdir
    ...
    -> options:
         ...
         or_null_or_undefined
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> files:string list -> unit)
    -> unit
    [@@js.global "readdir"]
  ...
  val readdir
    ...
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null
          -> files:Buffer.t_0 or_string list
          -> unit)
    -> unit
    [@@js.global "readdir"]
  ...
  val readdir
    :  path:fs_PathLike
    -> options:(fs_BaseEncodingOptions, anonymous_interface_20) intersection2
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> files:fs_Dirent list -> unit)
    -> unit
    [@@js.global "readdir"]
  ...
  val close : fd:float -> callback:fs_NoParamCallback -> unit
    [@@js.global "close"]
  ...
  val fsync : fd:float -> callback:fs_NoParamCallback -> unit
    [@@js.global "fsync"]
  ...
  val readFile
    ...
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null -> data:Buffer.t_0 -> unit)
    -> unit
    [@@js.global "readFile"]
  ...
  val readFile
    ...
    -> callback:(err:NodeJS.ErrnoException.t_0 or_null -> data:string -> unit)
    -> unit
    [@@js.global "readFile"]
  ...
  val readFile
    :  path:fs_PathLike or_number
    -> options:
         (fs_BaseEncodingOptions, anonymous_interface_12) intersection2
         or_string
         or_null_or_undefined
    -> callback:
         (err:NodeJS.ErrnoException.t_0 or_null
          -> data:Buffer.t_0 or_string
          -> unit)
    -> unit
    [@@js.global "readFile"]
  ...
  val watchFile
    ...
    -> listener:(curr:fs_Stats -> prev:fs_Stats -> unit)
    -> unit
    [@@js.global "watchFile"]
  ...
  val exists : path:fs_PathLike -> callback:(exists:bool -> unit) -> unit
    [@@js.global "exists"]

  module Exists : sig
    val __promisify__ : path:fs_PathLike -> bool Promise.t
      [@@js.global "__promisify__"]
  end
  [@@js.scope "exists"]
  ...
  val access : path:fs_PathLike -> callback:fs_NoParamCallback -> unit
    [@@js.global "access"]
  ...
  val accessSync : path:fs_PathLike -> ?mode:float -> unit -> unit
  ...
  val fdatasync : fd:float -> callback:fs_NoParamCallback -> unit
    [@@js.global "fdatasync"]
  ...
  module WriteVResult : sig
    ...
    val set_buffers : t -> NodeJS.ArrayBufferView.t_0 list -> unit
      [@@js.set "buffers"]
  end
  ...
  val opendirSync : path:string -> ?options:fs_OpenDirOptions -> unit -> fs_Dir
