...
module AnonymousInterface0 =
  struct
    ...
    let (get_options : t -> Util.Util.InspectOptions.t) =
      fun (x3 : t) ->
        Util.Util.InspectOptions.t_of_js
          (Ojs.get_prop_ascii (t_to_js x3) "options")
    let (set_options : t -> Util.Util.InspectOptions.t -> unit) =
      fun (x4 : t) ->
        fun (x5 : Util.Util.InspectOptions.t) ->
          Ojs.set_prop_ascii (t_to_js x4) "options"
            (Util.Util.InspectOptions.t_to_js x5)
  end
module Repl =
  struct
    module ReplOptions =
        ...
        let (get_completer :
          t ->
            (Readline.Readline.AsyncCompleter.t,
              Readline.Readline.Completer.t) union2)
          =
          fun (x38 : t) ->
            union2_of_js Readline.Readline.AsyncCompleter.t_of_js
              Readline.Readline.Completer.t_of_js
              (Ojs.get_prop_ascii (t_to_js x38) "completer")
        let (set_completer :
          t ->
            (Readline.Readline.AsyncCompleter.t,
              Readline.Readline.Completer.t) union2 -> unit)
          =
          fun (x41 : t) ->
            fun
              (x42 :
              ...
              Ojs.set_prop_ascii (t_to_js x41) "completer"
                (union2_to_js Readline.Readline.AsyncCompleter.t_to_js
                   Readline.Readline.Completer.t_to_js x42)
          ...
          fun (x61 : t) ->
            fun ~this:(x53 : repl_REPLServer) ->
              fun ~evalCmd:(x54 : string) ->
                fun ~context:(x55 : Vm.Vm.Context.t) ->
                  fun ~file:(x56 : string) ->
    ...
    module REPLServer =
      struct
        ...
        let (get_context : t -> Vm.Vm.Context.t) =
          fun (x84 : t) ->
            Vm.Vm.Context.t_of_js
        ...
        let (addListener''''''''' :
          t ->
            event:[ `reset ] ->
              listener:(context:Vm.Vm.Context.t -> unit) -> t)
          =
          fun (x155 : t) ->
            fun ~event:(x152 : [ `reset ]) ->
              fun ~listener:(x153 : context:Vm.Vm.Context.t -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x155) "addListener"
                     [|((match x152 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x154 : Ojs.t) ->
                            x153 ~context:(Vm.Vm.Context.t_of_js x154)))|])
        ...
        let (emit''''''''' :
          t -> event:[ `reset ] -> context:Vm.Vm.Context.t -> bool) =
          fun (x182 : t) ->
            fun ~event:(x180 : [ `reset ]) ->
              fun ~context:(x181 : Vm.Vm.Context.t) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x182) "emit"
                     [|((match x180 with | `reset -> Ojs.string_to_js "reset"));(
                       Vm.Vm.Context.t_to_js x181)|])
        ...
        let (on''''''''' :
          ...
          fun (x216 : t) ->
            fun ~event:(x213 : [ `reset ]) ->
              fun ~listener:(x214 : context:Vm.Vm.Context.t -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x216) "on"
                     [|((match x213 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x215 : Ojs.t) ->
                            x214 ~context:(Vm.Vm.Context.t_of_js x215)))|])
        let (once :
          t -> event:string -> listener:(args:any list -> unit) -> t) =
          fun (x221 : t) ->
        ...
        let (once''''''''' :
          ...
          fun (x250 : t) ->
            fun ~event:(x247 : [ `reset ]) ->
              fun ~listener:(x248 : context:Vm.Vm.Context.t -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x250) "once"
                     [|((match x247 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x249 : Ojs.t) ->
                            x248 ~context:(Vm.Vm.Context.t_of_js x249)))|])
        let (prependListener :
          t -> event:string -> listener:(args:any list -> unit) -> t) =
          fun (x255 : t) ->
        ...
        let (prependListener''''''''' :
          ...
          fun (x284 : t) ->
            fun ~event:(x281 : [ `reset ]) ->
              fun ~listener:(x282 : context:Vm.Vm.Context.t -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x284) "prependListener"
                     [|((match x281 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x283 : Ojs.t) ->
                            x282 ~context:(Vm.Vm.Context.t_of_js x283)))|])
        ...
        let (prependOnceListener''''''''' :
          ...
          fun (x318 : t) ->
            fun ~event:(x315 : [ `reset ]) ->
              fun ~listener:(x316 : context:Vm.Vm.Context.t -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x318) "prependOnceListener"
                     [|((match x315 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x317 : Ojs.t) ->
                            x316 ~context:(Vm.Vm.Context.t_of_js x317)))|])
        let (cast : t -> Readline.Readline.Interface.t) =
          fun (x319 : t) ->
            Readline.Readline.Interface.t_of_js (t_to_js x319)
      end
