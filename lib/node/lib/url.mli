...
module Url : sig
  module UrlObject : sig
    ...
    val get_query
      :  t
      -> Querystring.Querystring.ParsedUrlQueryInput.t or_string or_null
      [@@js.get "query"]
  ...
  module Url : sig
    ...
    val get_query
      :  t
      -> Querystring.Querystring.ParsedUrlQuery.t or_string or_null
      [@@js.get "query"]
  ...
  module UrlWithParsedQuery : sig
    ...
    val get_query : t -> Querystring.Querystring.ParsedUrlQuery.t
      [@@js.get "query"]

    val set_query : t -> Querystring.Querystring.ParsedUrlQuery.t -> unit
      [@@js.set "query"]
