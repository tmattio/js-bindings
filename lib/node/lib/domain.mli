...
module Domain : sig
  module Global : sig
    ...
    val add
      :  t
      -> emitter:(Events.Events.EventEmitter.t, Timer.t) union2
      -> unit
      [@@js.call "add"]
  ...
  module Domain : sig
    ...
    val get_members : t -> (Events.Events.EventEmitter.t, Timer.t) union2 list
      [@@js.get "members"]

    val set_members
      :  t
      -> (Events.Events.EventEmitter.t, Timer.t) union2 list
      -> unit
      [@@js.set "members"]
