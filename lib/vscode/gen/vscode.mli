...
module Make (M: Missing) : sig
  ...
  module[@js.scope "vscode"] Vscode : sig
    ...
    module[@js.scope "WorkspaceEditEntryMetadata"] WorkspaceEditEntryMetadata : sig
      ...
      val set_iconPath: t -> (vscode_ThemeIcon, vscode_Uri, anonymous_interface_14) union3 -> unit [@@js.set "iconPath"]
    end
    ...
    module[@js.scope "WebviewPanel"] WebviewPanel : sig
      ...
      val set_iconPath: t -> (vscode_Uri, anonymous_interface_14) union2 -> unit [@@js.set "iconPath"]
    ...
    module[@js.scope "window"] Window : sig
      ...
      val showInformationMessage: message:string -> items:(string list [@js.variadic]) -> string or_undefined _Thenable [@@js.global "showInformationMessage"]
      val showInformationMessage: message:string -> options:vscode_MessageOptions -> items:(string list [@js.variadic]) -> string or_undefined _Thenable [@@js.global "showInformationMessage"]
      val showInformationMessage: message:string -> items:('T list [@js.variadic]) -> 'T or_undefined _Thenable [@@js.global "showInformationMessage"]
      val showInformationMessage: message:string -> options:vscode_MessageOptions -> items:('T list [@js.variadic]) -> 'T or_undefined _Thenable [@@js.global "showInformationMessage"]
      val showWarningMessage: message:string -> items:(string list [@js.variadic]) -> string or_undefined _Thenable [@@js.global "showWarningMessage"]
      val showWarningMessage: message:string -> options:vscode_MessageOptions -> items:(string list [@js.variadic]) -> string or_undefined _Thenable [@@js.global "showWarningMessage"]
      val showWarningMessage: message:string -> items:('T list [@js.variadic]) -> 'T or_undefined _Thenable [@@js.global "showWarningMessage"]
      val showWarningMessage: message:string -> options:vscode_MessageOptions -> items:('T list [@js.variadic]) -> 'T or_undefined _Thenable [@@js.global "showWarningMessage"]
    ...
    module[@js.scope "TreeItem"] TreeItem : sig
      ...
      val set_iconPath: t -> (vscode_ThemeIcon, vscode_Uri, anonymous_interface_15) union3 or_string -> unit [@@js.set "iconPath"]
