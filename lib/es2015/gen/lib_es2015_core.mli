...
(* unknown identifiers: - ArrayLike<T1> - Date - TemplateStringsArray *)
[@@@js.stop]
...
module Make (M : Missing) : sig
  ...
  module DateConstructor : sig
    ...
    val create : t -> value:Date.t_0 or_string or_number -> Date.t_0
      [@@js.apply_newable]
  end
  ...
  module String : sig
    ...
    val normalize
      :  t
      -> form:([ `L_s0_NFC | `L_s1_NFD | `L_s2_NFKC | `L_s3_NFKD ][@js.enum])
      -> string
      [@@js.call "normalize"]
