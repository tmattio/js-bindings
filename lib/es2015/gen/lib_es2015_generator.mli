...
(* unknown identifiers: - Iterator<T1, T2, T3> - IteratorResult<T1, T2> *)
[@@@js.stop]
...
module Make (M : Missing) : sig
  ...
  module Generator : sig
    ...
    val _Symbol_iterator_ : ('T, 'TReturn, 'TNext) t -> ('T, 'TReturn, 'TNext) t
      [@@js.call "[Symbol.iterator]"]

    val cast : ('T, 'TReturn, 'TNext) t -> ('T, 'TReturn, 'TNext) Iterator.t_3
      [@@js.cast]
  end
  [@@js.scope "Generator"]
  ...
  module GeneratorFunctionConstructor : sig
    ...
    val create : t -> args:(string list[@js.variadic]) -> _GeneratorFunction
      [@@js.apply_newable]

    val apply : t -> args:(string list[@js.variadic]) -> _GeneratorFunction
      [@@js.apply]
