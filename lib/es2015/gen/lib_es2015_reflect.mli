...
(* unknown identifiers: - ArrayLike<T1> - PropertyDescriptor - PropertyKey *)
[@@@js.stop]
...
module Make (M : Missing) : sig
  ...
  module Reflect : sig
    val apply_
      ...
      -> thisArgument:any
      -> argumentsList:any ArrayLike.t_1
      -> any
      [@@js.global "apply"]
    ...
    val defineProperty
      ...
      -> propertyKey:PropertyKey.t_0
      -> attributes:PropertyDescriptor.t_0
      -> bool
    ...
    val getOwnPropertyDescriptor
      :  target:untyped_object
      -> propertyKey:PropertyKey.t_0
      -> PropertyDescriptor.t_0 or_undefined
    ...
    val has : target:untyped_object -> propertyKey:PropertyKey.t_0 -> bool
      [@@js.global "has"]

    val isExtensible : target:untyped_object -> bool
      [@@js.global "isExtensible"]
