...
module type Missing  =
  sig
    ...
    sig
      ...
      val t_3_to_js :
        ('T1 -> Ojs.t) ->
          ('T2 -> Ojs.t) -> ('T3 -> Ojs.t) -> ('T1, 'T2, 'T3) t_3 -> Ojs.t
      val t_3_of_js :
        (Ojs.t -> 'T1) ->
          (Ojs.t -> 'T2) -> (Ojs.t -> 'T3) -> Ojs.t -> ('T1, 'T2, 'T3) t_3
    end
    module IteratorResult :
    sig
      type ('T1, 'T2) t_2
      val t_2_to_js :
        ('T1 -> Ojs.t) -> ('T2 -> Ojs.t) -> ('T1, 'T2) t_2 -> Ojs.t
      val t_2_of_js :
        (Ojs.t -> 'T1) -> (Ojs.t -> 'T2) -> Ojs.t -> ('T1, 'T2) t_2
    end
  end
  ...
  struct
      ...
      struct
        ...
        and t_3_to_js :
          ...
          fun (__T_to_js : __T -> Ojs.t) ->
            fun (__TReturn_to_js : __TReturn -> Ojs.t) ->
              fun (__TNext_to_js : __TNext -> Ojs.t) ->
                fun (x9 : (__T, __TReturn, __TNext) t) ->
        ...
        and t_2_to_js :
          ...
          fun (__T_to_js : __T -> Ojs.t) ->
            fun (__TReturn_to_js : __TReturn -> Ojs.t) ->
              fun (x17 : (__T, __TReturn, unknown) t) ->
        ...
        let (return :
          ('T, 'TReturn, 'TNext) t ->
            value:'TReturn -> ('T, 'TReturn) IteratorResult.t_2)
          =
          fun (x52 : ('T, 'TReturn, 'TNext) t) ->
            fun ~value:(x51 : 'TReturn) ->
              IteratorResult.t_2_of_js Obj.magic Obj.magic
                (Ojs.call (t_to_js Obj.magic Obj.magic Obj.magic x52)
                   "return" [|(Obj.magic x51)|])
        let (throw :
          ('T, 'TReturn, 'TNext) t ->
            e:any -> ('T, 'TReturn) IteratorResult.t_2)
          =
          fun (x59 : ('T, 'TReturn, 'TNext) t) ->
            fun ~e:(x58 : any) ->
              IteratorResult.t_2_of_js Obj.magic Obj.magic
                (Ojs.call (t_to_js Obj.magic Obj.magic Obj.magic x59) "throw"
                   [|(any_to_js x58)|])
        let (_Symbol_iterator_ :
          ('T, 'TReturn, 'TNext) t -> ('T, 'TReturn, 'TNext) t) =
          fun (x65 : ('T, 'TReturn, 'TNext) t) ->
            t_of_js Obj.magic Obj.magic Obj.magic
              (Ojs.call (t_to_js Obj.magic Obj.magic Obj.magic x65)
                 "[Symbol.iterator]" [||])
        let (cast :
          ('T, 'TReturn, 'TNext) t -> ('T, 'TReturn, 'TNext) Iterator.t_3) =
          fun (x72 : ('T, 'TReturn, 'TNext) t) ->
            Iterator.t_3_of_js Obj.magic Obj.magic Obj.magic
    ...
    module GeneratorFunction =
      struct
        ...
        let (create :
          t -> args:any list -> (unknown, any, unknown) _Generator) =
          fun (x86 : t) ->
            fun ~args:(x83 : any list) ->
              _Generator_of_js unknown_of_js any_of_js unknown_of_js
                (Ojs.new_obj_arr (t_to_js x86)
                   (let x84 =
        ...
        let (apply :
          t -> args:any list -> (unknown, any, unknown) _Generator) =
          fun (x93 : t) ->
            fun ~args:(x90 : any list) ->
              _Generator_of_js unknown_of_js any_of_js unknown_of_js
                (Ojs.call (t_to_js x93) "apply"
                   [|Ojs.null;((let x91 =
                                  Ojs.new_obj
                                    (Ojs.get_prop_ascii Ojs.global "Array")
                                    [||] in
        ...
        let (get_length : t -> float) =
          fun (x97 : t) ->
            Ojs.float_of_js (Ojs.get_prop_ascii (t_to_js x97) "length")
    ...
    module GeneratorFunctionConstructor =
      struct
        ...
        let (create : t -> args:string list -> _GeneratorFunction) =
          fun (x110 : t) ->
            fun ~args:(x107 : string list) ->
              _GeneratorFunction_of_js
                (Ojs.new_obj_arr (t_to_js x110)
                   (let x108 =
                      Ojs.new_obj (Ojs.get_prop_ascii Ojs.global "Array")
                        [||] in
                    List.iter
                      (fun (x109 : string) ->
                         ignore
                           (Ojs.call x108 "push" [|(Ojs.string_to_js x109)|]))
                      x107;
                    x108))
        let (apply : t -> args:string list -> _GeneratorFunction) =
          fun (x114 : t) ->
            fun ~args:(x111 : string list) ->
              _GeneratorFunction_of_js
                (Ojs.call (t_to_js x114) "apply"
                   [|Ojs.null;((let x112 =
                                  Ojs.new_obj
                                    (Ojs.get_prop_ascii Ojs.global "Array")
                                    [||] in
        ...
        let (get_name : t -> string) =
          fun (x116 : t) ->
            Ojs.string_of_js (Ojs.get_prop_ascii (t_to_js x116) "name")
        let (get_prototype : t -> _GeneratorFunction) =
          fun (x117 : t) ->
            _GeneratorFunction_of_js
              (Ojs.get_prop_ascii (t_to_js x117) "prototype")
      end
  end
