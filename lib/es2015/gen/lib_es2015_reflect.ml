      ...
      struct
        let (apply_ :
          target:untyped_function ->
            thisArgument:any -> argumentsList:any ArrayLike.t_1 -> any)
          =
          fun ~target:(x1 : untyped_function) ->
            fun ~thisArgument:(x2 : any) ->
              fun ~argumentsList:(x3 : any ArrayLike.t_1) ->
                any_of_js
                  (Ojs.call (Ojs.get_prop_ascii Ojs.global "Reflect") "apply"
                     [|(untyped_function_to_js x1);(any_to_js x2);(ArrayLike.t_1_to_js
                                                                    any_to_js
                                                                    x3)|])
        let (construct :
          target:untyped_function ->
          ...
          fun ~target:(x5 : untyped_function) ->
            fun ~argumentsList:(x6 : any ArrayLike.t_1) ->
                    ...
                    (let x11 = Ojs.get_prop_ascii Ojs.global "Reflect" in
                     Ojs.call (Ojs.get_prop_ascii x11 "construct") "apply"
                       [|x11;((let x8 =
                               ...
                               ignore
                                 (Ojs.call x8 "push"
                                    [|(ArrayLike.t_1_to_js any_to_js x6)|]);
                               (match x7 with
                                | Some x9 ->
                                    ignore
                                      (Ojs.call x8 "push"
        ...
        let (defineProperty :
          target:untyped_object ->
            propertyKey:PropertyKey.t_0 ->
              attributes:PropertyDescriptor.t_0 -> bool)
          =
          fun ~target:(x12 : untyped_object) ->
            fun ~propertyKey:(x13 : PropertyKey.t_0) ->
              fun ~attributes:(x14 : PropertyDescriptor.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (Ojs.get_prop_ascii Ojs.global "Reflect")
                     "defineProperty"
                     [|(untyped_object_to_js x12);(PropertyKey.t_0_to_js x13);(
                       PropertyDescriptor.t_0_to_js x14)|])
        let (deleteProperty :
          target:untyped_object -> propertyKey:PropertyKey.t_0 -> bool) =
          fun ~target:(x15 : untyped_object) ->
            fun ~propertyKey:(x16 : PropertyKey.t_0) ->
              Ojs.bool_of_js
                (Ojs.call (Ojs.get_prop_ascii Ojs.global "Reflect")
                   "deleteProperty"
                   [|(untyped_object_to_js x15);(PropertyKey.t_0_to_js x16)|])
        let (get_ :
          target:untyped_object ->
            propertyKey:PropertyKey.t_0 -> ?receiver:any -> unit -> any)
          =
          fun ~target:(x17 : untyped_object) ->
            fun ~propertyKey:(x18 : PropertyKey.t_0) ->
        ...
        let (getOwnPropertyDescriptor :
          ...
          fun ~target:(x23 : untyped_object) ->
            fun ~propertyKey:(x24 : PropertyKey.t_0) ->
              or_undefined_of_js PropertyDescriptor.t_0_of_js
                (Ojs.call (Ojs.get_prop_ascii Ojs.global "Reflect")
                   "getOwnPropertyDescriptor"
                   [|(untyped_object_to_js x23);(PropertyKey.t_0_to_js x24)|])
        let (getPrototypeOf :
          target:untyped_object -> untyped_object or_null) =
        ...
        let (has :
          ...
          fun ~target:(x28 : untyped_object) ->
            fun ~propertyKey:(x29 : PropertyKey.t_0) ->
              Ojs.bool_of_js
                (Ojs.call (Ojs.get_prop_ascii Ojs.global "Reflect") "has"
                   [|(untyped_object_to_js x28);(PropertyKey.t_0_to_js x29)|])
        let (isExtensible : target:untyped_object -> bool) =
          fun ~target:(x30 : untyped_object) ->
            Ojs.bool_of_js
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "Reflect")
                 "isExtensible" [|(untyped_object_to_js x30)|])
        ...
        let (set_ :
          ...
          fun ~target:(x35 : untyped_object) ->
            fun ~propertyKey:(x36 : PropertyKey.t_0) ->
              fun ~value:(x37 : any) ->
                      ...
                      (let x41 = Ojs.get_prop_ascii Ojs.global "Reflect" in
                       Ojs.call (Ojs.get_prop_ascii x41 "set") "apply"
                         [|x41;((let x39 =
                                 ...
                                 ignore
                                   (Ojs.call x39 "push"
                                      [|(PropertyKey.t_0_to_js x36)|]);
                                 ignore
                                   (Ojs.call x39 "push" [|(any_to_js x37)|]);
                                 (match x38 with
                                  | Some x40 ->
                                      ignore
                                        (Ojs.call x39 "push"
