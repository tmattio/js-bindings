...
(* unknown identifiers: - Array<T1> - Promise<T1> *)
[@@@js.stop]
...
module Make (M : Missing) : sig
  ...
  module Internal : sig
    ...
    module Types : sig
      ...
      [@@js.custom
        { of_js = (fun _TYield -> Obj.magic)
        ; to_js = (fun _TYield -> Obj.magic)
        }]
  ...
  module Iterable : sig
    ...
    val _Symbol_iterator_ : 'T t -> ('T, any, never or_undefined) _Iterator
  ...
  module Array : sig
    ...
    val _Symbol_iterator_ : 'T t -> 'T _IterableIterator
      [@@js.call "[Symbol.iterator]"]
  ...
  module ArrayConstructor : sig
    ...
    val from : t -> iterable:('T Array.t_1, 'T _Iterable) union2 -> 'T list
      [@@js.call "from"]
  ...
  module IArguments : sig
    ...
    val _Symbol_iterator_ : t -> any _IterableIterator
      [@@js.call "[Symbol.iterator]"]
  end
  [@@js.scope "IArguments"]
  ...
  module Map : sig
    ...
    val _Symbol_iterator_ : ('K, 'V) t -> ('K * 'V) _IterableIterator
      [@@js.call "[Symbol.iterator]"]

    val entries : ('K, 'V) t -> ('K * 'V) _IterableIterator
      [@@js.call "entries"]
  ...
  module MapConstructor : sig
    ...
    val create : t -> iterable:('K * 'V) _Iterable -> ('K, 'V) _Map
      [@@js.apply_newable]
  end
  ...
  module WeakMapConstructor : sig
    ...
    val create : t -> iterable:('K * 'V) _Iterable -> ('K, 'V) _WeakMap
      [@@js.apply_newable]
  end
  ...
  module SetConstructor : sig
    ...
    val create : t -> ?iterable:'T _Iterable or_null -> unit -> 'T _Set
      [@@js.apply_newable]
  end
  ...
  module PromiseConstructor : sig
    ...
    val all : t -> values:'T Promise.t_1 _Iterable -> 'T list _Promise
      [@@js.call "all"]
    ...
    val race' : t -> values:'T Promise.t_1 _Iterable -> 'T _Promise
      [@@js.call "race"]
  end
  ...
  module String : sig
    ...
    val _Symbol_iterator_ : t -> string _IterableIterator
      [@@js.call "[Symbol.iterator]"]
  ...
  module Int8Array : sig
    ...
    val _Symbol_iterator_ : t -> float _IterableIterator
      [@@js.call "[Symbol.iterator]"]
  ...
  module Int8ArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Int8Array
      [@@js.apply_newable]
  ...
  module Uint8ArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Uint8Array
      [@@js.apply_newable]
  ...
  module Uint8ClampedArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Uint8ClampedArray
      [@@js.apply_newable]
  ...
  module Int16ArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Int16Array
      [@@js.apply_newable]
  ...
  module Uint16ArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Uint16Array
      [@@js.apply_newable]
  ...
  module Int32ArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Int32Array
      [@@js.apply_newable]
  ...
  module Uint32ArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Uint32Array
      [@@js.apply_newable]
  ...
  module Float32ArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Float32Array
      [@@js.apply_newable]
  ...
  module Float64ArrayConstructor : sig
    ...
    val create : t -> elements:float _Iterable -> _Float64Array
      [@@js.apply_newable]
