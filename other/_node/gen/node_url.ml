  ...
  struct
    module UrlObject =
      struct
        ...
        let (get_query : t -> ParsedUrlQueryInput.t_0 or_string or_null) =
          fun (x55 : t) ->
            or_null_of_js
              (fun (x56 : Ojs.t) ->
                 or_string_of_js ParsedUrlQueryInput.t_0_of_js x56)
              (Ojs.get_prop_ascii (t_to_js x55) "query")
        let (set_query :
          t -> ParsedUrlQueryInput.t_0 or_string or_null -> unit) =
          fun (x58 : t) ->
            fun (x59 : ParsedUrlQueryInput.t_0 or_string or_null) ->
              Ojs.set_prop_ascii (t_to_js x58) "query"
                (or_null_to_js
                   (fun (x60 : ParsedUrlQueryInput.t_0 or_string) ->
                      or_string_to_js ParsedUrlQueryInput.t_0_to_js x60) x59)
      end
    module Url =
      struct
        type t = url_Url
        ...
        let (get_query : t -> ParsedUrlQuery.t_0 or_string or_null) =
          fun (x117 : t) ->
            or_null_of_js
              (fun (x118 : Ojs.t) ->
                 or_string_of_js ParsedUrlQuery.t_0_of_js x118)
              (Ojs.get_prop_ascii (t_to_js x117) "query")
        let (set_query : t -> ParsedUrlQuery.t_0 or_string or_null -> unit) =
          fun (x120 : t) ->
            fun (x121 : ParsedUrlQuery.t_0 or_string or_null) ->
              Ojs.set_prop_ascii (t_to_js x120) "query"
                (or_null_to_js
                   (fun (x122 : ParsedUrlQuery.t_0 or_string) ->
                      or_string_to_js ParsedUrlQuery.t_0_to_js x122) x121)
      end
    module UrlWithParsedQuery =
      struct
        ...
        let (get_query : t -> ParsedUrlQuery.t_0) =
          fun (x126 : t) ->
            ParsedUrlQuery.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x126) "query")
        let (set_query : t -> ParsedUrlQuery.t_0 -> unit) =
          fun (x127 : t) ->
            fun (x128 : ParsedUrlQuery.t_0) ->
              Ojs.set_prop_ascii (t_to_js x127) "query"
                (ParsedUrlQuery.t_0_to_js x128)
        let (cast : t -> url_Url) =
    ...
    let (parse : urlStr:string -> url_UrlWithStringQuery) =
      fun ~urlStr:(x138 : string) ->
        url_UrlWithStringQuery_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "url") "parse"
      ...
      fun ~urlStr:(x139 : string) ->
        fun ~parseQueryString:(x140 : [ `L_b_false ] or_undefined) ->
          fun ?slashesDenoteHost:(x141 : bool option) ->
            fun () ->
              url_UrlWithStringQuery_of_js
                (let x145 = Ojs.get_prop_ascii Ojs.global "url" in
          ...
          fun ?slashesDenoteHost:(x148 : bool option) ->
            fun () ->
              url_UrlWithParsedQuery_of_js
                (let x151 = Ojs.get_prop_ascii Ojs.global "url" in
      ...
      fun ~urlStr:(x152 : string) ->
        fun ~parseQueryString:(x153 : bool) ->
          fun ?slashesDenoteHost:(x154 : bool option) ->
            fun () ->
              url_Url_of_js
                (let x157 = Ojs.get_prop_ascii Ojs.global "url" in
    ...
    let (format :
      ...
      fun ~uRL:(x158 : url_URL) ->
        fun ?options:(x159 : url_URLFormatOptions option) ->
          fun () ->
            Ojs.string_of_js
              (let x162 = Ojs.get_prop_ascii Ojs.global "url" in
            ...
            fun ?base:(x189 : t or_string option) ->
              fun () ->
                t_of_js
                  (Ojs.new_obj_arr
                     (Ojs.get_prop_ascii
                        (Ojs.get_prop_ascii Ojs.global "url") "URL")
                     (let x190 =
      ...
      struct
        ...
        let (create :
          ?init:(t, (string * string) Iterable.t,
            string list or_string NodeJS.Dict.t_1, (string * string) list)
            union4 or_string -> unit -> t)
          =
          fun
            ?init:(x229 :
                    (t, (string * string) Iterable.t,
                      string list or_string NodeJS.Dict.t_1,
                      (string * string) list) union4 or_string option)
            ->
            fun () ->
              t_of_js
                (Ojs.new_obj_arr
