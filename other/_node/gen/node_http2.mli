...
module Http2 : sig
  ...
  (* import { IncomingHttpHeaders as Http1IncomingHttpHeaders,
     OutgoingHttpHeaders, IncomingMessage, ServerResponse, } from 'node:http'; *)
  ...
  module StreamState : sig
    ...
    val set_sumDependencyWeight : t -> float -> unit
  ...
  module ServerStreamFileResponseOptions : sig
    ...
    val statCheck
      :  t
      -> stats:Fs.Stats.t_0
      -> headers:OutgoingHttpHeaders.t_0
  ...
  module ServerStreamFileResponseOptionsWithError : sig
    ...
    val onError : t -> err:NodeJS.ErrnoException.t_0 -> unit
      [@@js.call "onError"]
  ...
  module Http2Stream : sig
    ...
    val get_sentInfoHeaders : t -> OutgoingHttpHeaders.t_0 list
      [@@js.get "sentInfoHeaders"]

    val get_sentTrailers : t -> OutgoingHttpHeaders.t_0
      [@@js.get "sentTrailers"]
    ...
    val close : t -> ?code:float -> ?callback:(unit -> unit) -> unit -> unit
      [@@js.call "close"]
    ...
    val sendTrailers : t -> headers:OutgoingHttpHeaders.t_0 -> unit
    ...
    val addListener''
      :  t
      -> event:([ `data ][@js.enum])
      -> listener:(chunk:Buffer.t_0 or_string -> unit)
      -> t
      [@@js.call "addListener"]
    ...
    val addListener'''''''
      ...
      -> listener:(frameType:float -> errorCode:float -> unit)
      -> t
      [@@js.call "addListener"]
    ...
    val addListener''''''''
      :  t
      -> event:([ `pipe ][@js.enum])
      -> listener:(src:Stream.Readable.t_0 -> unit)
      -> t
      [@@js.call "addListener"]
    ...
    val addListener''''''''''''
      ...
      -> listener:(trailers:http2_IncomingHttpHeaders -> flags:float -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module ClientHttp2Stream : sig
    ...
    val addListener''
      :  t
      -> event:([ `push ][@js.enum])
      -> listener:(headers:http2_IncomingHttpHeaders -> flags:float -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module ServerHttp2Stream : sig
    ...
    val additionalHeaders : t -> headers:OutgoingHttpHeaders.t_0 -> unit
    ...
    val respondWithFD
      :  t
      -> fd:Fs.Promises.FileHandle.t_0 or_number
      -> ?headers:OutgoingHttpHeaders.t_0
  ...
  module Settings : sig
    ...
    val set_initialWindowSize : t -> float -> unit
  ...
  module SessionState : sig
    ...
    val get_effectiveLocalWindowSize : t -> float
      [@@js.get "effectiveLocalWindowSize"]

    val set_effectiveLocalWindowSize : t -> float -> unit
      [@@js.set "effectiveLocalWindowSize"]

    val get_effectiveRecvDataLength : t -> float
      [@@js.get "effectiveRecvDataLength"]

    val set_effectiveRecvDataLength : t -> float -> unit
    ...
    val set_outboundQueueSize : t -> float -> unit
      [@@js.set "outboundQueueSize"]

    val get_deflateDynamicTableSize : t -> float
      [@@js.get "deflateDynamicTableSize"]

    val set_deflateDynamicTableSize : t -> float -> unit
      [@@js.set "deflateDynamicTableSize"]

    val get_inflateDynamicTableSize : t -> float
      [@@js.get "inflateDynamicTableSize"]

    val set_inflateDynamicTableSize : t -> float -> unit
  ...
  module Http2Session : sig
    ...
    val get_socket : t -> (Net.Socket.t_0, Tls.TLSSocket.t_0) union2
      [@@js.get "socket"]
    ...
    val destroy : t -> ?error:Error.t_0 -> ?code:float -> unit -> unit
      [@@js.call "destroy"]
    ...
    val goaway
      ...
      -> ?code:float
      -> ?lastStreamID:float
      -> ?opaqueData:NodeJS.ArrayBufferView.t_0
      -> unit
      -> unit
      [@@js.call "goaway"]
    ...
    val ping'
      :  t
      -> payload:NodeJS.ArrayBufferView.t_0
      -> callback:
           (err:Error.t_0 or_null
            -> duration:float
            -> payload:Buffer.t_0
    ...
    val setLocalWindowSize : t -> windowSize:float -> unit
    ...
    val addListener''
      :  t
      -> event:([ `frameError ][@js.enum])
      -> listener:(frameType:float -> errorCode:float -> streamID:float -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module ClientHttp2Session : sig
    ...
    val addListener''
      ...
      -> listener:
           (session:t
            -> socket:(Net.Socket.t_0, Tls.TLSSocket.t_0) union2
            -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module AlternativeServiceOptions : sig
    ...
    val set_origin : t -> Url.URL.t_0 or_string or_number -> unit
      [@@js.set "origin"]
  end
  ...
  module ServerHttp2Session : sig
    ...
    val altsvc
      ...
      -> alt:string
      -> originOrStream:
           (http2_AlternativeServiceOptions, Url.URL.t_0) union2 or_string
           or_number
      -> unit
      [@@js.call "altsvc"]
  ...
  module SessionOptions : sig
    ...
    val get_maxDeflateDynamicTableSize : t -> float
      [@@js.get "maxDeflateDynamicTableSize"]

    val set_maxDeflateDynamicTableSize : t -> float -> unit
    ...
    val set_maxHeaderListPairs : t -> float -> unit
      [@@js.set "maxHeaderListPairs"]

    val get_maxOutstandingPings : t -> float [@@js.get "maxOutstandingPings"]

    val set_maxOutstandingPings : t -> float -> unit
      [@@js.set "maxOutstandingPings"]

    val get_maxSendHeaderBlockLength : t -> float
      [@@js.get "maxSendHeaderBlockLength"]

    val set_maxSendHeaderBlockLength : t -> float -> unit
    ...
    val get_peerMaxConcurrentStreams : t -> float
      [@@js.get "peerMaxConcurrentStreams"]

    val set_peerMaxConcurrentStreams : t -> float -> unit
    ...
    val selectPadding : t -> frameLen:float -> maxFrameLen:float -> float
      [@@js.call "selectPadding"]

    val createConnection
      :  t
      -> authority:Url.URL.t_0
      -> option:t
      -> Stream.Duplex.t_0
  ...
  module ClientSessionOptions : sig
    ...
    val get_maxReservedRemoteStreams : t -> float
      [@@js.get "maxReservedRemoteStreams"]

    val set_maxReservedRemoteStreams : t -> float -> unit
  ...
  module Http2Server : sig
    ...
    val setTimeout : t -> ?msec:float -> ?callback:(unit -> unit) -> unit -> t
      [@@js.call "setTimeout"]
  ...
  module Http2SecureServer : sig
    ...
    val addListener''''''
      ...
      -> listener:(socket:Tls.TLSSocket.t_0 -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module Http2ServerRequest : sig
    ...
    val create
      :  stream:http2_ServerHttp2Stream
      -> headers:http2_IncomingHttpHeaders
      -> options:Stream.ReadableOptions.t_0
    ...
    val get_connection : t -> (Net.Socket.t_0, Tls.TLSSocket.t_0) union2
      [@@js.get "connection"]
    ...
    val read : t -> ?size:float -> unit -> Buffer.t_0 or_string or_null
      [@@js.call "read"]

    val addListener
      :  t
      -> event:([ `aborted ][@js.enum])
      -> listener:(hadError:bool -> code:float -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module Http2ServerResponse : sig
    ...
    val addTrailers : t -> trailers:OutgoingHttpHeaders.t_0 -> unit
      [@@js.call "addTrailers"]
    ...
    val createPushResponse
      :  t
      -> headers:OutgoingHttpHeaders.t_0
      -> callback:(err:Error.t_0 or_null -> res:t -> unit)
      -> unit
  ...
  module Constants : sig
    ...
    val nGHTTP2_STREAM_STATE_IDLE : float
      [@@js.global "NGHTTP2_STREAM_STATE_IDLE"]

    val nGHTTP2_STREAM_STATE_OPEN : float
      [@@js.global "NGHTTP2_STREAM_STATE_OPEN"]

    val nGHTTP2_STREAM_STATE_RESERVED_LOCAL : float
      [@@js.global "NGHTTP2_STREAM_STATE_RESERVED_LOCAL"]

    val nGHTTP2_STREAM_STATE_RESERVED_REMOTE : float
      [@@js.global "NGHTTP2_STREAM_STATE_RESERVED_REMOTE"]

    val nGHTTP2_STREAM_STATE_HALF_CLOSED_LOCAL : float
      [@@js.global "NGHTTP2_STREAM_STATE_HALF_CLOSED_LOCAL"]

    val nGHTTP2_STREAM_STATE_HALF_CLOSED_REMOTE : float
      [@@js.global "NGHTTP2_STREAM_STATE_HALF_CLOSED_REMOTE"]

    val nGHTTP2_STREAM_STATE_CLOSED : float
    ...
    val nGHTTP2_FLAG_END_HEADERS : float
    ...
    val dEFAULT_SETTINGS_HEADER_TABLE_SIZE : float
      [@@js.global "DEFAULT_SETTINGS_HEADER_TABLE_SIZE"]

    val dEFAULT_SETTINGS_ENABLE_PUSH : float
      [@@js.global "DEFAULT_SETTINGS_ENABLE_PUSH"]

    val dEFAULT_SETTINGS_INITIAL_WINDOW_SIZE : float
      [@@js.global "DEFAULT_SETTINGS_INITIAL_WINDOW_SIZE"]

    val dEFAULT_SETTINGS_MAX_FRAME_SIZE : float
    ...
    val nGHTTP2_SETTINGS_HEADER_TABLE_SIZE : float
      [@@js.global "NGHTTP2_SETTINGS_HEADER_TABLE_SIZE"]

    val nGHTTP2_SETTINGS_ENABLE_PUSH : float
      [@@js.global "NGHTTP2_SETTINGS_ENABLE_PUSH"]

    val nGHTTP2_SETTINGS_MAX_CONCURRENT_STREAMS : float
      [@@js.global "NGHTTP2_SETTINGS_MAX_CONCURRENT_STREAMS"]

    val nGHTTP2_SETTINGS_INITIAL_WINDOW_SIZE : float
      [@@js.global "NGHTTP2_SETTINGS_INITIAL_WINDOW_SIZE"]

    val nGHTTP2_SETTINGS_MAX_FRAME_SIZE : float
      [@@js.global "NGHTTP2_SETTINGS_MAX_FRAME_SIZE"]

    val nGHTTP2_SETTINGS_MAX_HEADER_LIST_SIZE : float
    ...
    val pADDING_STRATEGY_CALLBACK : float
    ...
    val hTTP_STATUS_SWITCHING_PROTOCOLS : float
    ...
    val hTTP_STATUS_METHOD_NOT_ALLOWED : float
      [@@js.global "HTTP_STATUS_METHOD_NOT_ALLOWED"]

    val hTTP_STATUS_NOT_ACCEPTABLE : float
    ...
    val hTTP_STATUS_REQUEST_TIMEOUT : float
  ...
  val getPackedSettings : settings:http2_Settings -> Buffer.t_0
  ...
  val connect
    :  authority:Url.URL.t_0 or_string
    -> listener:
