    ...
    module Types =
      struct
        ...
        and child_process_ExecFileException =
          (child_process_ExecException, NodeJS.ErrnoException.t_0)
            intersection2
        ...
        and child_process_SendHandle =
          (Net.Server.t_0, Net.Socket.t_0) union2
        ...
        and child_process_StdioNull =
          (Stream.t_0, [ `ignore  | `inherit_ ]) or_enum
        and child_process_StdioOptions =
          ((Stream.t_0, [ `ignore  | `inherit_  | `ipc  | `pipe ]) or_enum
        ...
        and child_process_ExecFileException_of_js :
          ...
          fun (x4 : Ojs.t) ->
            intersection2_of_js child_process_ExecException_of_js
              NodeJS.ErrnoException.t_0_of_js x4
        and child_process_ExecFileException_to_js :
          ...
          fun
            ...
            intersection2_to_js child_process_ExecException_to_js
              NodeJS.ErrnoException.t_0_to_js x1
        ...
        and child_process_SendHandle_of_js :
          ...
          fun (x10 : Ojs.t) ->
            union2_of_js Net.Server.t_0_of_js Net.Socket.t_0_of_js x10
        and child_process_SendHandle_to_js :
          child_process_SendHandle -> Ojs.t =
          fun (x7 : (Net.Server.t_0, Net.Socket.t_0) union2) ->
            union2_to_js Net.Server.t_0_to_js Net.Socket.t_0_to_js x7
        ...
        and child_process_StdioNull_of_js : Ojs.t -> child_process_StdioNull
          =
          fun (x27 : Ojs.t) ->
            or_enum_of_js Stream.t_0_of_js
              (fun (x29 : Ojs.t) ->
                 let x30 = x29 in
        ...
        and child_process_StdioNull_to_js : child_process_StdioNull -> Ojs.t
          =
          fun (x24 : (Stream.t_0, [ `ignore  | `inherit_ ]) or_enum) ->
            or_enum_to_js Stream.t_0_to_js
        ...
        and child_process_StdioOptions_to_js :
          ...
          fun
            (x31 :
              ((Stream.t_0, [ `ignore  | `inherit_  | `ipc  | `pipe ])
                 or_enum or_number or_null_or_undefined list,
                [ `ignore  | `inherit_  | `pipe ]) or_enum)
            ->
            or_enum_to_js
              (fun
    ...
    let (get_encoding : t -> BufferEncoding.t_0) =
      fun (x56 : t) ->
        BufferEncoding.t_0_of_js
          (Ojs.get_prop_ascii (t_to_js x56) "encoding")
    let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
      fun (x57 : t) ->
        fun (x58 : BufferEncoding.t_0) ->
          Ojs.set_prop_ascii (t_to_js x57) "encoding"
            (BufferEncoding.t_0_to_js x58)
  end
...
module AnonymousInterface2 =
  struct
    ...
    let (get_stdout : t -> Buffer.t_0) =
      fun (x69 : t) ->
        Buffer.t_0_of_js (Ojs.get_prop_ascii (t_to_js x69) "stdout")
    let (set_stdout : t -> Buffer.t_0 -> unit) =
      fun (x70 : t) ->
        fun (x71 : Buffer.t_0) ->
          Ojs.set_prop_ascii (t_to_js x70) "stdout" (Buffer.t_0_to_js x71)
    let (get_stderr : t -> Buffer.t_0) =
      fun (x72 : t) ->
        Buffer.t_0_of_js (Ojs.get_prop_ascii (t_to_js x72) "stderr")
    let (set_stderr : t -> Buffer.t_0 -> unit) =
      fun (x73 : t) ->
        fun (x74 : Buffer.t_0) ->
          Ojs.set_prop_ascii (t_to_js x73) "stderr" (Buffer.t_0_to_js x74)
  end
...
module AnonymousInterface4 =
  struct
    ...
    let (get_stdout : t -> Buffer.t_0 or_string) =
      fun (x85 : t) ->
        or_string_of_js Buffer.t_0_of_js
          (Ojs.get_prop_ascii (t_to_js x85) "stdout")
    let (set_stdout : t -> Buffer.t_0 or_string -> unit) =
      fun (x87 : t) ->
        fun (x88 : Buffer.t_0 or_string) ->
          Ojs.set_prop_ascii (t_to_js x87) "stdout"
            (or_string_to_js Buffer.t_0_to_js x88)
    let (get_stderr : t -> Buffer.t_0 or_string) =
      fun (x90 : t) ->
        or_string_of_js Buffer.t_0_of_js
          (Ojs.get_prop_ascii (t_to_js x90) "stderr")
    let (set_stderr : t -> Buffer.t_0 or_string -> unit) =
      fun (x92 : t) ->
        fun (x93 : Buffer.t_0 or_string) ->
          Ojs.set_prop_ascii (t_to_js x92) "stderr"
            (or_string_to_js Buffer.t_0_to_js x93)
  end
module Node_child_process = struct  end
  ...
  struct
    ...
    module ChildProcess =
      struct
        ...
        let (get_stdin : t -> Writable.t_0 or_null) =
          fun (x101 : t) ->
            or_null_of_js Writable.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x101) "stdin")
        let (set_stdin : t -> Writable.t_0 or_null -> unit) =
          fun (x103 : t) ->
            fun (x104 : Writable.t_0 or_null) ->
              Ojs.set_prop_ascii (t_to_js x103) "stdin"
                (or_null_to_js Writable.t_0_to_js x104)
        let (get_stdout : t -> Readable.t_0 or_null) =
          fun (x106 : t) ->
            or_null_of_js Readable.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x106) "stdout")
        let (set_stdout : t -> Readable.t_0 or_null -> unit) =
          fun (x108 : t) ->
            fun (x109 : Readable.t_0 or_null) ->
              Ojs.set_prop_ascii (t_to_js x108) "stdout"
                (or_null_to_js Readable.t_0_to_js x109)
        let (get_stderr : t -> Readable.t_0 or_null) =
          fun (x111 : t) ->
            or_null_of_js Readable.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x111) "stderr")
        let (set_stderr : t -> Readable.t_0 or_null -> unit) =
          fun (x113 : t) ->
            fun (x114 : Readable.t_0 or_null) ->
              Ojs.set_prop_ascii (t_to_js x113) "stderr"
                (or_null_to_js Readable.t_0_to_js x114)
        let (get_channel : t -> Pipe.t_0 or_null) =
          fun (x116 : t) ->
            or_null_of_js Pipe.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x116) "channel")
        let (get_stdio :
          t ->
            (Writable.t_0 or_null * Readable.t_0 or_null * Readable.t_0
              or_null * (Readable.t_0, Writable.t_0) union2
              or_null_or_undefined * (Readable.t_0, Writable.t_0) union2
              or_null_or_undefined))
          =
          fun (x118 : t) ->
            let x119 = Ojs.get_prop_ascii (t_to_js x118) "stdio" in
            ((or_null_of_js Writable.t_0_of_js (Ojs.array_get x119 0)),
              (or_null_of_js Readable.t_0_of_js (Ojs.array_get x119 1)),
              (or_null_of_js Readable.t_0_of_js (Ojs.array_get x119 2)),
              (or_null_or_undefined_of_js
                 (fun (x123 : Ojs.t) ->
                    union2_of_js Readable.t_0_of_js Writable.t_0_of_js x123)
                 (Ojs.array_get x119 3)),
              (or_null_or_undefined_of_js
                 (fun (x126 : Ojs.t) ->
                    union2_of_js Readable.t_0_of_js Writable.t_0_of_js x126)
        ...
        let (get_signalCode : t -> NodeJS.Signals.t_0 or_null) =
          fun (x134 : t) ->
            or_null_of_js NodeJS.Signals.t_0_of_js
        ...
        let (kill :
          t -> ?signal:NodeJS.Signals.t_0 or_number -> unit -> bool) =
          fun (x143 : t) ->
            fun ?signal:(x139 : NodeJS.Signals.t_0 or_number option) ->
              fun () ->
                Ojs.bool_of_js
        ...
        let (send :
          ...
          fun (x151 : t) ->
            fun ~message:(x145 : child_process_Serializable) ->
              fun ?callback:(x146 : (error:Error.t_0 or_null -> unit) option)
                ->
                fun () ->
                  Ojs.bool_of_js
          ...
          fun (x161 : t) ->
            fun ~message:(x153 : child_process_Serializable) ->
              fun ?sendHandle:(x154 : child_process_SendHandle option) ->
                fun
                  ?callback:(x155 : (error:Error.t_0 or_null -> unit) option)
                  ->
                  fun () ->
                    Ojs.bool_of_js
            ...
            fun ~message:(x163 : child_process_Serializable) ->
              fun ?sendHandle:(x164 : child_process_SendHandle option) ->
                fun ?options:(x165 : child_process_MessageOptions option) ->
                  fun
                    ?callback:(x166 :
                                (error:Error.t_0 or_null -> unit) option)
                    ->
                    fun () ->
                      Ojs.bool_of_js
          ...
          t ->
            event:[ `close ] ->
              listener:(code:float or_null ->
                          signal:NodeJS.Signals.t_0 or_null -> unit)
                -> t)
          =
          fun (x189 : t) ->
        ...
        let (emit' :
          t ->
            event:[ `close ] ->
              code:float or_null -> signal:NodeJS.Signals.t_0 or_null -> bool)
          =
          fun (x221 : t) ->
            fun ~event:(x216 : [ `close ]) ->
              fun ~code:(x217 : float or_null) ->
                fun ~signal:(x219 : NodeJS.Signals.t_0 or_null) ->
                  Ojs.bool_of_js
                    (Ojs.call (t_to_js x221) "emit"
                       [|((match x216 with
                           | `close -> Ojs.string_to_js "close"));(or_null_to_js
                                                                    Ojs.float_to_js
                                                                    x217);(
                         or_null_to_js NodeJS.Signals.t_0_to_js x219)|])
                         ...
                         (fun (x358 : Ojs.t) ->
                            fun (x359 : Ojs.t) ->
                              x357
                                ...
                                ~sendHandle:(child_process_SendHandle_of_js
                                               x359)))|])
        let (cast : t -> Events.EventEmitter.t_0) =
          fun (x361 : t) -> Events.EventEmitter.t_0_of_js (t_to_js x361)
      end
    module ChildProcessWithoutNullStreams =
      struct
        ...
        let (get_stdin : t -> Writable.t_0) =
          fun (x364 : t) ->
            Writable.t_0_of_js (Ojs.get_prop_ascii (t_to_js x364) "stdin")
        let (set_stdin : t -> Writable.t_0 -> unit) =
          fun (x365 : t) ->
            fun (x366 : Writable.t_0) ->
              Ojs.set_prop_ascii (t_to_js x365) "stdin"
                (Writable.t_0_to_js x366)
        let (get_stdout : t -> Readable.t_0) =
          fun (x367 : t) ->
            Readable.t_0_of_js (Ojs.get_prop_ascii (t_to_js x367) "stdout")
        let (set_stdout : t -> Readable.t_0 -> unit) =
          fun (x368 : t) ->
            fun (x369 : Readable.t_0) ->
              Ojs.set_prop_ascii (t_to_js x368) "stdout"
                (Readable.t_0_to_js x369)
        let (get_stderr : t -> Readable.t_0) =
          fun (x370 : t) ->
            Readable.t_0_of_js (Ojs.get_prop_ascii (t_to_js x370) "stderr")
        let (set_stderr : t -> Readable.t_0 -> unit) =
          fun (x371 : t) ->
            fun (x372 : Readable.t_0) ->
              Ojs.set_prop_ascii (t_to_js x371) "stderr"
                (Readable.t_0_to_js x372)
        let (get_stdio :
          t ->
            (Writable.t_0 * Readable.t_0 * Readable.t_0 * (Readable.t_0,
              Writable.t_0) union2 or_null_or_undefined * (Readable.t_0,
              Writable.t_0) union2 or_null_or_undefined))
          =
          fun (x373 : t) ->
            let x374 = Ojs.get_prop_ascii (t_to_js x373) "stdio" in
            ((Writable.t_0_of_js (Ojs.array_get x374 0)),
              (Readable.t_0_of_js (Ojs.array_get x374 1)),
              (Readable.t_0_of_js (Ojs.array_get x374 2)),
              (or_null_or_undefined_of_js
                 (fun (x375 : Ojs.t) ->
                    union2_of_js Readable.t_0_of_js Writable.t_0_of_js x375)
                 (Ojs.array_get x374 3)),
              (or_null_or_undefined_of_js
                 (fun (x378 : Ojs.t) ->
                    union2_of_js Readable.t_0_of_js Writable.t_0_of_js x378)
    ...
    module ChildProcessByStdio =
      struct
        ...
        let (get_stdio :
          ('I, 'O, 'E) t ->
            ('I * 'O * 'E * (Readable.t_0, Writable.t_0) union2
              or_null_or_undefined * (Readable.t_0, Writable.t_0) union2
              or_null_or_undefined))
          =
          fun (x417 : ('I, 'O, 'E) t) ->
            ...
            ((Obj.magic (Ojs.array_get x421 0)),
              ...
              (or_null_or_undefined_of_js
                 (fun (x422 : Ojs.t) ->
                    union2_of_js Readable.t_0_of_js Writable.t_0_of_js x422)
                 (Ojs.array_get x421 3)),
              (or_null_or_undefined_of_js
                 (fun (x425 : Ojs.t) ->
                    union2_of_js Readable.t_0_of_js Writable.t_0_of_js x425)
    ...
    module ProcessEnvOptions =
      struct
        ...
        let (get_env : t -> NodeJS.ProcessEnv.t_0) =
          fun (x457 : t) ->
            NodeJS.ProcessEnv.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x457) "env")
        let (set_env : t -> NodeJS.ProcessEnv.t_0 -> unit) =
          fun (x458 : t) ->
            fun (x459 : NodeJS.ProcessEnv.t_0) ->
              Ojs.set_prop_ascii (t_to_js x458) "env"
                (NodeJS.ProcessEnv.t_0_to_js x459)
      end
        ...
        fun ?options:(x548 : child_process_SpawnOptionsWithoutStdio option)
          ...
          fun () ->
            child_process_ChildProcessWithoutNullStreams_of_js
              (let x551 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (spawn :
      command:string ->
        options:(child_process_StdioPipe, child_process_StdioPipe,
          ...
          ->
          (Writable.t_0, Readable.t_0, Readable.t_0)
        ...
        fun
          ~options:(x553 :
                     (child_process_StdioPipe, child_process_StdioPipe,
                       ...
                       child_process_SpawnOptionsWithStdioTuple)
          ->
          child_process_ChildProcessByStdio_of_js Writable.t_0_of_js
            Readable.t_0_of_js Readable.t_0_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "child_process") "spawn"
    ...
    let (spawn :
      command:string ->
        options:(child_process_StdioPipe, child_process_StdioPipe,
          ...
          ->
          (Writable.t_0, Readable.t_0, never or_null)
            child_process_ChildProcessByStdio)
      =
    ...
    let (spawn :
      command:string ->
        options:(child_process_StdioPipe, child_process_StdioNull,
          child_process_StdioPipe) child_process_SpawnOptionsWithStdioTuple
          ->
          (Writable.t_0, never or_null, Readable.t_0)
            child_process_ChildProcessByStdio)
      =
    ...
    let (spawn :
      command:string ->
        options:(child_process_StdioNull, child_process_StdioPipe,
          child_process_StdioPipe) child_process_SpawnOptionsWithStdioTuple
          ->
          (never or_null, Readable.t_0, Readable.t_0)
            child_process_ChildProcessByStdio)
      =
    ...
    let (spawn :
      command:string ->
        options:(child_process_StdioPipe, child_process_StdioNull,
          child_process_StdioNull) child_process_SpawnOptionsWithStdioTuple
          ->
          (Writable.t_0, never or_null, never or_null)
            child_process_ChildProcessByStdio)
      =
    ...
    let (spawn :
      command:string ->
        options:(child_process_StdioNull, child_process_StdioPipe,
          child_process_StdioNull) child_process_SpawnOptionsWithStdioTuple
          ->
          (never or_null, Readable.t_0, never or_null)
            child_process_ChildProcessByStdio)
      =
    ...
    let (spawn :
      command:string ->
        options:(child_process_StdioNull, child_process_StdioNull,
          child_process_StdioPipe) child_process_SpawnOptionsWithStdioTuple
          ->
          (never or_null, never or_null, Readable.t_0)
            child_process_ChildProcessByStdio)
      =
      ...
      fun ~command:(x630 : string) ->
        fun ?args:(x631 : string list option) ->
          fun ?options:(x632 : child_process_SpawnOptionsWithoutStdio option)
            ...
            fun () ->
              child_process_ChildProcessWithoutNullStreams_of_js
                (let x637 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~command:(x638 : string) ->
        fun ~args:(x639 : string list) ->
          fun
            ...
            child_process_ChildProcessByStdio_of_js Writable.t_0_of_js
              Readable.t_0_of_js Readable.t_0_of_js
              (Ojs.call (Ojs.get_prop_ascii Ojs.global "child_process")
                 "spawn"
    ...
    module ExecOptions =
      struct
        ...
        let (get_killSignal : t -> NodeJS.Signals.t_0 or_number) =
          fun (x742 : t) ->
            or_number_of_js NodeJS.Signals.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x742) "killSignal")
        let (set_killSignal : t -> NodeJS.Signals.t_0 or_number -> unit) =
          fun (x744 : t) ->
            fun (x745 : NodeJS.Signals.t_0 or_number) ->
              Ojs.set_prop_ascii (t_to_js x744) "killSignal"
                (or_number_to_js NodeJS.Signals.t_0_to_js x745)
        let (cast : t -> child_process_CommonOptions) =
    ...
    module ExecOptionsWithBufferEncoding =
      struct
        ...
        let (set_encoding : t -> BufferEncoding.t_0 or_null -> unit) =
          fun (x758 : t) ->
            fun (x759 : BufferEncoding.t_0 or_null) ->
              Ojs.set_prop_ascii (t_to_js x758) "encoding"
                (or_null_to_js BufferEncoding.t_0_to_js x759)
        let (cast : t -> child_process_ExecOptions) =
    ...
    module ExecException =
      struct
        ...
        let (get_signal : t -> NodeJS.Signals.t_0) =
          fun (x773 : t) ->
            NodeJS.Signals.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x773) "signal")
        let (set_signal : t -> NodeJS.Signals.t_0 -> unit) =
          fun (x774 : t) ->
            fun (x775 : NodeJS.Signals.t_0) ->
              Ojs.set_prop_ascii (t_to_js x774) "signal"
                (NodeJS.Signals.t_0_to_js x775)
        let (cast : t -> Error.t_0) =
          fun (x776 : t) -> Error.t_0_of_js (t_to_js x776)
      end
    let (exec :
      command:string ->
      ...
      fun ~command:(x777 : string) ->
        fun
          ...
          fun () ->
            child_process_ChildProcess_of_js
              (let x785 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (exec :
      command:string ->
        options:(anonymous_interface_1, child_process_ExecOptions)
          intersection2 ->
          ?callback:(error:child_process_ExecException or_null ->
                       stdout:Buffer.t_0 -> stderr:Buffer.t_0 -> unit)
            -> unit -> child_process_ChildProcess)
      =
      fun ~command:(x786 : string) ->
        fun
          ...
          fun
            ...
            fun () ->
              child_process_ChildProcess_of_js
                (let x797 = Ojs.get_prop_ascii Ojs.global "child_process" in
                                                ...
                                                fun (x794 : Ojs.t) ->
                                                  x790
                                                    ~error:(or_null_of_js
                                                              child_process_ExecException_of_js
                                                              x791)
                                                    ~stdout:(Buffer.t_0_of_js
                                                               x793)
                                                    ~stderr:(Buffer.t_0_of_js
                                                               x794)))|])
                             | None -> ());
                            x789))|])
    let (exec :
      ...
      fun ~command:(x798 : string) ->
        fun
          ...
          fun
            ...
            fun () ->
              child_process_ChildProcess_of_js
                (let x809 = Ojs.get_prop_ascii Ojs.global "child_process" in
        ...
        options:(anonymous_interface_0, child_process_ExecOptions)
          ...
          ?callback:(error:child_process_ExecException or_null ->
                       stdout:Buffer.t_0 or_string ->
                         stderr:Buffer.t_0 or_string -> unit)
            -> unit -> child_process_ChildProcess)
      =
      fun ~command:(x810 : string) ->
        fun
          ...
          fun
            ...
            fun () ->
              child_process_ChildProcess_of_js
                (let x823 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~command:(x824 : string) ->
        fun ~options:(x825 : child_process_ExecOptions) ->
          fun
            ...
            fun () ->
              child_process_ChildProcess_of_js
                (let x833 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (exec :
      command:string ->
        options:(BaseEncodingOptions.t_0, child_process_ExecOptions)
      ...
      fun ~command:(x834 : string) ->
        fun
          ~options:(x835 :
                     (BaseEncodingOptions.t_0, child_process_ExecOptions)
                       intersection2 or_null_or_undefined)
          ->
          fun
            ?callback:(x836 :
            ...
            fun () ->
              child_process_ChildProcess_of_js
                (let x848 = Ojs.get_prop_ascii Ojs.global "child_process" in
        ...
        let (__promisify__ :
          ...
          fun ~command:(x861 : string) ->
            child_process_PromiseWithChild_of_js anonymous_interface_3_of_js
              (Ojs.call
                 (Ojs.get_prop_ascii
                    (Ojs.get_prop_ascii Ojs.global "child_process") "exec")
            ...
            fun
              ...
              fun () ->
                child_process_PromiseWithChild_of_js
                  ...
                  (let x883 =
                     Ojs.get_prop_ascii
                       (Ojs.get_prop_ascii Ojs.global "child_process") "exec" in
    ...
    module ExecFileOptions =
      struct
        ...
        let (set_killSignal : t -> NodeJS.Signals.t_0 or_number -> unit) =
          fun (x892 : t) ->
            fun (x893 : NodeJS.Signals.t_0 or_number) ->
              Ojs.set_prop_ascii (t_to_js x892) "killSignal"
                (or_number_to_js NodeJS.Signals.t_0_to_js x893)
        let (get_windowsVerbatimArguments : t -> bool) =
          fun (x895 : t) ->
            Ojs.bool_of_js
    ...
    module ExecFileOptionsWithStringEncoding =
      struct
        ...
        let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
          fun (x907 : t) ->
            fun (x908 : BufferEncoding.t_0) ->
              Ojs.set_prop_ascii (t_to_js x907) "encoding"
                (BufferEncoding.t_0_to_js x908)
    ...
    module ExecFileOptionsWithOtherEncoding =
      struct
        ...
        let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
          fun (x922 : t) ->
            fun (x923 : BufferEncoding.t_0) ->
              Ojs.set_prop_ascii (t_to_js x922) "encoding"
                (BufferEncoding.t_0_to_js x923)
        let (cast : t -> child_process_ExecFileOptions) =
          fun (x924 : t) ->
    ...
    let (execFile : file:string -> child_process_ChildProcess) =
      fun ~file:(x927 : string) ->
        child_process_ChildProcess_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "child_process")
             "execFile" [|(Ojs.string_to_js x927)|])
    let (execFile :
      file:string ->
        options:(BaseEncodingOptions.t_0, child_process_ExecFileOptions)
          intersection2 or_null_or_undefined -> child_process_ChildProcess)
      =
      fun ~file:(x928 : string) ->
        fun
          ~options:(x929 :
                     (BaseEncodingOptions.t_0, child_process_ExecFileOptions)
                       intersection2 or_null_or_undefined)
          ->
          child_process_ChildProcess_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "child_process")
    ...
    let (execFile :
      ...
      fun ~file:(x933 : string) ->
        fun ?args:(x934 : string list or_null option) ->
          fun () ->
            child_process_ChildProcess_of_js
              (let x939 = Ojs.get_prop_ascii Ojs.global "child_process" in
                                 ...
                                 fun (x1062 : Ojs.t) ->
                                   x1057
                                     ~error:(or_null_of_js
                                               ...
                                               x1058)
                                     ~stdout:(or_string_of_js
                                                Buffer.t_0_of_js x1060)
                                     ~stderr:(or_string_of_js
                                                Buffer.t_0_of_js x1062)))
                       x1056)|])
    module ExecFile =
      struct
        let (__promisify__ :
          ...
          fun ~file:(x1064 : string) ->
            child_process_PromiseWithChild_of_js anonymous_interface_3_of_js
              (Ojs.call
                 (Ojs.get_prop_ascii
                    (Ojs.get_prop_ascii Ojs.global "child_process")
                    "execFile") "__promisify__" [|(Ojs.string_to_js x1064)|])
        let (__promisify__ :
          file:string ->
            args:string list or_null_or_undefined ->
              anonymous_interface_3 child_process_PromiseWithChild)
        ...
        let (__promisify__ :
          file:string ->
            args:string list or_null_or_undefined ->
              options:(BaseEncodingOptions.t_0,
                child_process_ExecFileOptions) intersection2
                or_null_or_undefined ->
                anonymous_interface_4 child_process_PromiseWithChild)
          =
                         ...
                         (fun
                            (x1118 :
                              (BaseEncodingOptions.t_0,
                                child_process_ExecFileOptions) intersection2)
                            ->
                            intersection2_to_js BaseEncodingOptions.t_0_to_js
    ...
    let (fork :
      ...
      fun ~modulePath:(x1146 : string) ->
        fun ?options:(x1147 : child_process_ForkOptions option) ->
          fun () ->
            child_process_ChildProcess_of_js
              (let x1150 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~modulePath:(x1151 : string) ->
        fun ?args:(x1152 : string list option) ->
          fun ?options:(x1153 : child_process_ForkOptions option) ->
            fun () ->
              child_process_ChildProcess_of_js
                (let x1158 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    module SpawnSyncOptions =
      struct
        ...
        let (get_input : t -> NodeJS.ArrayBufferView.t_0 or_string) =
          fun (x1161 : t) ->
            or_string_of_js NodeJS.ArrayBufferView.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x1161) "input")
        let (set_input : t -> NodeJS.ArrayBufferView.t_0 or_string -> unit) =
          fun (x1163 : t) ->
            fun (x1164 : NodeJS.ArrayBufferView.t_0 or_string) ->
              Ojs.set_prop_ascii (t_to_js x1163) "input"
                (or_string_to_js NodeJS.ArrayBufferView.t_0_to_js x1164)
        let (get_killSignal : t -> NodeJS.Signals.t_0 or_number) =
          fun (x1166 : t) ->
            or_number_of_js NodeJS.Signals.t_0_of_js
        ...
        let (set_killSignal : t -> NodeJS.Signals.t_0 or_number -> unit) =
          fun (x1168 : t) ->
            fun (x1169 : NodeJS.Signals.t_0 or_number) ->
              Ojs.set_prop_ascii (t_to_js x1168) "killSignal"
                (or_number_to_js NodeJS.Signals.t_0_to_js x1169)
        let (get_maxBuffer : t -> float) =
          fun (x1171 : t) ->
        ...
        let (get_encoding :
          t -> (BufferEncoding.t_0, [ `buffer ]) or_enum or_null) =
          fun (x1174 : t) ->
            or_null_of_js
              (fun (x1175 : Ojs.t) ->
                 or_enum_of_js BufferEncoding.t_0_of_js
                   (fun (x1177 : Ojs.t) ->
                      let x1178 = x1177 in
        ...
        let (set_encoding :
          t -> (BufferEncoding.t_0, [ `buffer ]) or_enum or_null -> unit) =
          fun (x1179 : t) ->
            fun (x1180 : (BufferEncoding.t_0, [ `buffer ]) or_enum or_null)
              ->
              Ojs.set_prop_ascii (t_to_js x1179) "encoding"
                (or_null_to_js
                   (fun (x1181 : (BufferEncoding.t_0, [ `buffer ]) or_enum)
                      ->
                      or_enum_to_js BufferEncoding.t_0_to_js
                        (fun (x1183 : [ `buffer ]) ->
                           match x1183 with
    ...
    module SpawnSyncOptionsWithStringEncoding =
      struct
        ...
        let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
          fun (x1188 : t) ->
            fun (x1189 : BufferEncoding.t_0) ->
              Ojs.set_prop_ascii (t_to_js x1188) "encoding"
                (BufferEncoding.t_0_to_js x1189)
    ...
    module SpawnSyncReturns =
      struct
        ...
        let (get_signal : 'T t -> NodeJS.Signals.t_0 or_null) =
          fun (x1233 : 'T t) ->
            or_null_of_js NodeJS.Signals.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js Obj.magic x1233) "signal")
        let (set_signal : 'T t -> NodeJS.Signals.t_0 or_null -> unit) =
          fun (x1236 : 'T t) ->
            fun (x1237 : NodeJS.Signals.t_0 or_null) ->
              Ojs.set_prop_ascii (t_to_js Obj.magic x1236) "signal"
                (or_null_to_js NodeJS.Signals.t_0_to_js x1237)
        let (get_error : 'T t -> Error.t_0) =
          fun (x1240 : 'T t) ->
            Error.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js Obj.magic x1240) "error")
        let (set_error : 'T t -> Error.t_0 -> unit) =
          fun (x1242 : 'T t) ->
            fun (x1243 : Error.t_0) ->
              Ojs.set_prop_ascii (t_to_js Obj.magic x1242) "error"
                (Error.t_0_to_js x1243)
      end
    let (spawnSync :
      command:string -> Buffer.t_0 child_process_SpawnSyncReturns) =
      fun ~command:(x1245 : string) ->
        child_process_SpawnSyncReturns_of_js Buffer.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "child_process")
             "spawnSync" [|(Ojs.string_to_js x1245)|])
    let (spawnSync :
      command:string ->
        ...
        fun
          ...
          fun () ->
            child_process_SpawnSyncReturns_of_js Ojs.string_of_js
              (let x1251 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (spawnSync :
      command:string ->
        ?options:child_process_SpawnSyncOptionsWithBufferEncoding ->
          unit -> Buffer.t_0 child_process_SpawnSyncReturns)
      =
      fun ~command:(x1253 : string) ->
        fun
          ...
          fun () ->
            child_process_SpawnSyncReturns_of_js Buffer.t_0_of_js
              (let x1257 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (spawnSync :
      ...
      fun ~command:(x1259 : string) ->
        fun ?options:(x1260 : child_process_SpawnSyncOptions option) ->
          fun () ->
            child_process_SpawnSyncReturns_of_js Buffer.t_0_of_js
              (let x1263 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~command:(x1265 : string) ->
        fun ?args:(x1266 : string list option) ->
          fun
            ...
            fun () ->
              child_process_SpawnSyncReturns_of_js Ojs.string_of_js
                (let x1272 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~command:(x1274 : string) ->
        fun ?args:(x1275 : string list option) ->
          fun
            ...
            fun () ->
              child_process_SpawnSyncReturns_of_js Buffer.t_0_of_js
                (let x1281 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~command:(x1283 : string) ->
        fun ?args:(x1284 : string list option) ->
          fun ?options:(x1285 : child_process_SpawnSyncOptions option) ->
            fun () ->
              child_process_SpawnSyncReturns_of_js Buffer.t_0_of_js
                (let x1290 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    module ExecSyncOptions =
      struct
        ...
        let (set_killSignal : t -> NodeJS.Signals.t_0 or_number -> unit) =
          fun (x1307 : t) ->
            fun (x1308 : NodeJS.Signals.t_0 or_number) ->
              Ojs.set_prop_ascii (t_to_js x1307) "killSignal"
                (or_number_to_js NodeJS.Signals.t_0_to_js x1308)
        let (get_maxBuffer : t -> float) =
          fun (x1310 : t) ->
        ...
        let (set_encoding :
          t -> (BufferEncoding.t_0, [ `buffer ]) or_enum or_null -> unit) =
          fun (x1318 : t) ->
            fun (x1319 : (BufferEncoding.t_0, [ `buffer ]) or_enum or_null)
              ->
              Ojs.set_prop_ascii (t_to_js x1318) "encoding"
                (or_null_to_js
                   (fun (x1320 : (BufferEncoding.t_0, [ `buffer ]) or_enum)
                      ->
                      or_enum_to_js BufferEncoding.t_0_to_js
                        (fun (x1322 : [ `buffer ]) ->
                           match x1322 with
    ...
    module ExecSyncOptionsWithStringEncoding =
      struct
        ...
        let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
          fun (x1327 : t) ->
            fun (x1328 : BufferEncoding.t_0) ->
              Ojs.set_prop_ascii (t_to_js x1327) "encoding"
                (BufferEncoding.t_0_to_js x1328)
    ...
    let (execSync : command:string -> Buffer.t_0) =
      fun ~command:(x1339 : string) ->
        Buffer.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "child_process")
             "execSync" [|(Ojs.string_to_js x1339)|])
    let (execSync :
      command:string ->
      ...
      fun ~command:(x1340 : string) ->
        fun
          ...
          fun () ->
            Ojs.string_of_js
              (let x1344 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (execSync :
      ...
      fun ~command:(x1345 : string) ->
        fun
          ...
          fun () ->
            Buffer.t_0_of_js
              (let x1349 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (execSync :
      command:string ->
        ?options:child_process_ExecSyncOptions -> unit -> Buffer.t_0)
      =
      fun ~command:(x1350 : string) ->
        fun ?options:(x1351 : child_process_ExecSyncOptions option) ->
          fun () ->
            Buffer.t_0_of_js
              (let x1354 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    module ExecFileSyncOptions =
      struct
        ...
        let (set_input : t -> NodeJS.ArrayBufferView.t_0 or_string -> unit) =
          fun (x1359 : t) ->
            fun (x1360 : NodeJS.ArrayBufferView.t_0 or_string) ->
              Ojs.set_prop_ascii (t_to_js x1359) "input"
                (or_string_to_js NodeJS.ArrayBufferView.t_0_to_js x1360)
        let (get_stdio : t -> child_process_StdioOptions) =
          fun (x1362 : t) ->
            child_process_StdioOptions_of_js
        ...
        let (set_killSignal : t -> NodeJS.Signals.t_0 or_number -> unit) =
          fun (x1367 : t) ->
            fun (x1368 : NodeJS.Signals.t_0 or_number) ->
              Ojs.set_prop_ascii (t_to_js x1367) "killSignal"
                (or_number_to_js NodeJS.Signals.t_0_to_js x1368)
        let (get_maxBuffer : t -> float) =
          fun (x1370 : t) ->
        ...
        let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
          fun (x1374 : t) ->
            fun (x1375 : BufferEncoding.t_0) ->
              Ojs.set_prop_ascii (t_to_js x1374) "encoding"
                (BufferEncoding.t_0_to_js x1375)
        let (get_shell : t -> bool or_string) =
          fun (x1376 : t) ->
            or_string_of_js Ojs.bool_of_js
    ...
    module ExecFileSyncOptionsWithStringEncoding =
      struct
        ...
        let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
          fun (x1385 : t) ->
            fun (x1386 : BufferEncoding.t_0) ->
              Ojs.set_prop_ascii (t_to_js x1385) "encoding"
                (BufferEncoding.t_0_to_js x1386)
    ...
    module ExecFileSyncOptionsWithBufferEncoding =
      struct
        ...
        let (set_encoding : t -> BufferEncoding.t_0 -> unit) =
          fun (x1391 : t) ->
            fun (x1392 : BufferEncoding.t_0) ->
              Ojs.set_prop_ascii (t_to_js x1391) "encoding"
                (BufferEncoding.t_0_to_js x1392)
        let (cast : t -> child_process_ExecFileSyncOptions) =
          fun (x1393 : t) ->
            child_process_ExecFileSyncOptions_of_js (t_to_js x1393)
      end
    let (execFileSync : command:string -> Buffer.t_0) =
      fun ~command:(x1394 : string) ->
        Buffer.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "child_process")
             "execFileSync" [|(Ojs.string_to_js x1394)|])
    let (execFileSync :
      command:string ->
      ...
      fun ~command:(x1395 : string) ->
        fun
          ...
          fun () ->
            Ojs.string_of_js
              (let x1399 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (execFileSync :
      ...
      fun ~command:(x1400 : string) ->
        fun
          ...
          fun () ->
            Buffer.t_0_of_js
              (let x1404 = Ojs.get_prop_ascii Ojs.global "child_process" in
    ...
    let (execFileSync :
      command:string ->
        ?options:child_process_ExecFileSyncOptions -> unit -> Buffer.t_0)
      =
      fun ~command:(x1405 : string) ->
        fun ?options:(x1406 : child_process_ExecFileSyncOptions option) ->
          fun () ->
            Buffer.t_0_of_js
              (let x1409 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~command:(x1410 : string) ->
        fun ?args:(x1411 : string list option) ->
          fun
            ...
            fun () ->
              Ojs.string_of_js
                (let x1417 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~command:(x1418 : string) ->
        fun ?args:(x1419 : string list option) ->
          fun
            ...
            fun () ->
              Buffer.t_0_of_js
                (let x1425 = Ojs.get_prop_ascii Ojs.global "child_process" in
      ...
      fun ~command:(x1426 : string) ->
        fun ?args:(x1427 : string list option) ->
          fun ?options:(x1428 : child_process_ExecFileSyncOptions option) ->
            fun () ->
              Buffer.t_0_of_js
                (let x1433 = Ojs.get_prop_ascii Ojs.global "child_process" in
