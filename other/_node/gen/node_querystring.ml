...
open AnonymousInterfaces
open Types
module Node_querystring = struct  end
module Querystring =
  struct
        ...
        let (cast :
          t ->
            (string list, bool list, float list) union3 or_boolean or_string
              or_number or_null NodeJS.Dict.t_1)
          =
          fun (x20 : t) ->
            NodeJS.Dict.t_1_of_js
              (fun (x21 : Ojs.t) ->
        ...
        fun ?sep:(x33 : string option) ->
          fun ?eq:(x34 : string option) ->
            fun ?options:(x35 : querystring_StringifyOptions option) ->
              fun () ->
                Ojs.string_of_js
                  (let x41 = Ojs.get_prop_ascii Ojs.global "querystring" in
            ...
            fun ?options:(x45 : querystring_ParseOptions option) ->
              fun () ->
                querystring_ParsedUrlQuery_of_js
                  (let x50 = Ojs.get_prop_ascii Ojs.global "querystring" in
        ...
        fun ?sep:(x52 : string option) ->
          fun ?eq:(x53 : string option) ->
            fun ?options:(x54 : querystring_StringifyOptions option) ->
              fun () ->
                Ojs.string_of_js
                  (let x60 = Ojs.get_prop_ascii Ojs.global "querystring" in
        ...
        fun ?sep:(x62 : string option) ->
          fun ?eq:(x63 : string option) ->
            fun ?options:(x64 : querystring_ParseOptions option) ->
              fun () ->
                querystring_ParsedUrlQuery_of_js
                  (let x69 = Ojs.get_prop_ascii Ojs.global "querystring" in
    ...
    let (escape : str:string -> string) =
      fun ~str:(x70 : string) ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "querystring") "escape"
             [|(Ojs.string_to_js x70)|])
    let (unescape : str:string -> string) =
      fun ~str:(x71 : string) ->
        Ojs.string_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "querystring") "unescape"
