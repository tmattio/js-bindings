  ...
  struct
    ...
    module IncomingHttpHeaders =
      struct
        ...
        let (cast : t -> Http1IncomingHttpHeaders.t_0) =
          fun (x27 : t) -> Http1IncomingHttpHeaders.t_0_of_js (t_to_js x27)
      end
    ...
    module ServerStreamFileResponseOptions =
      struct
        ...
        let (statCheck :
          ...
          =
          fun (x83 : t) ->
            fun ~stats:(x80 : Fs.Stats.t_0) ->
              fun ~headers:(x81 : OutgoingHttpHeaders.t_0) ->
                fun ~statOptions:(x82 : http2_StatOptions) ->
                  or_boolean_of_js Ojs.unit_of_js
                    (Ojs.call (t_to_js x83) "statCheck"
                       [|(Fs.Stats.t_0_to_js x80);(OutgoingHttpHeaders.t_0_to_js
    ...
    module ServerStreamFileResponseOptionsWithError =
      struct
        ...
        let (onError : t -> err:NodeJS.ErrnoException.t_0 -> unit) =
          fun (x97 : t) ->
            fun ~err:(x96 : NodeJS.ErrnoException.t_0) ->
              ignore
                (Ojs.call (t_to_js x97) "onError"
                   [|(NodeJS.ErrnoException.t_0_to_js x96)|])
    ...
    module Http2Stream =
      struct
        ...
        let (get_sentHeaders : t -> OutgoingHttpHeaders.t_0) =
          fun (x109 : t) ->
            OutgoingHttpHeaders.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x109) "sentHeaders")
        let (get_sentInfoHeaders : t -> OutgoingHttpHeaders.t_0 list) =
          fun (x110 : t) ->
            Ojs.list_of_js OutgoingHttpHeaders.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x110) "sentInfoHeaders")
        let (get_sentTrailers : t -> OutgoingHttpHeaders.t_0) =
          fun (x112 : t) ->
            OutgoingHttpHeaders.t_0_of_js
                     ...
                     Ojs.call (Ojs.get_prop_ascii x129 "setTimeout") "apply"
                       [|x129;((let x126 =
                                ...
                                (match x125 with
                                 ...
                                 | None -> ());
                                x126))|])
        let (sendTrailers : t -> headers:OutgoingHttpHeaders.t_0 -> unit) =
          fun (x131 : t) ->
            fun ~headers:(x130 : OutgoingHttpHeaders.t_0) ->
              ignore
                (Ojs.call (t_to_js x131) "sendTrailers"
                   [|(OutgoingHttpHeaders.t_0_to_js x130)|])
        let (addListener :
        ...
        let (addListener'' :
          ...
          fun (x142 : t) ->
            fun ~event:(x138 : [ `data ]) ->
              fun ~listener:(x139 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x142) "addListener"
                     [|((match x138 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x140 : Ojs.t) ->
                            x139
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x140)))|])
        let (addListener''' :
        ...
        let (addListener'''''''' :
          ...
          fun (x164 : t) ->
            fun ~event:(x161 : [ `pipe ]) ->
              fun ~listener:(x162 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x164) "addListener"
                     [|((match x161 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x163 : Ojs.t) ->
                            x162 ~src:(Stream.Readable.t_0_of_js x163)))|])
        let (addListener''''''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x168 : t) ->
            fun ~event:(x165 : [ `unpipe ]) ->
              fun ~listener:(x166 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (emit'' :
          t -> event:[ `data ] -> chunk:Buffer.t_0 or_string -> bool) =
          fun (x197 : t) ->
            fun ~event:(x194 : [ `data ]) ->
              fun ~chunk:(x195 : Buffer.t_0 or_string) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x197) "emit"
                     [|((match x194 with | `data -> Ojs.string_to_js "data"));(
                       or_string_to_js Buffer.t_0_to_js x195)|])
        ...
        let (emit'''''''' :
          t -> event:[ `pipe ] -> src:Stream.Readable.t_0 -> bool) =
          fun (x213 : t) ->
            fun ~event:(x211 : [ `pipe ]) ->
              fun ~src:(x212 : Stream.Readable.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x213) "emit"
                     [|((match x211 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Stream.Readable.t_0_to_js x212)|])
        let (emit''''''''' :
          t -> event:[ `unpipe ] -> src:Stream.Readable.t_0 -> bool) =
          fun (x216 : t) ->
            fun ~event:(x214 : [ `unpipe ]) ->
              fun ~src:(x215 : Stream.Readable.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x216) "emit"
                     [|((match x214 with
                         | `unpipe -> Ojs.string_to_js "unpipe"));(Stream.Readable.t_0_to_js
                                                                    x215)|])
        let (emit'''''''''' :
        ...
        let (on'' :
          ...
          fun (x245 : t) ->
            fun ~event:(x241 : [ `data ]) ->
              fun ~listener:(x242 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x245) "on"
                     [|((match x241 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x243 : Ojs.t) ->
                            x242
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x243)))|])
        ...
        let (on'''''''' :
          ...
          fun (x267 : t) ->
            fun ~event:(x264 : [ `pipe ]) ->
              fun ~listener:(x265 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x267) "on"
                     [|((match x264 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x266 : Ojs.t) ->
                            x265 ~src:(Stream.Readable.t_0_of_js x266)))|])
        let (on''''''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x271 : t) ->
            fun ~event:(x268 : [ `unpipe ]) ->
              fun ~listener:(x269 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (once'' :
          ...
          fun (x303 : t) ->
            fun ~event:(x299 : [ `data ]) ->
              fun ~listener:(x300 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x303) "once"
                     [|((match x299 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x301 : Ojs.t) ->
                            x300
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x301)))|])
        ...
        let (once'''''''' :
          ...
          fun (x325 : t) ->
            fun ~event:(x322 : [ `pipe ]) ->
              fun ~listener:(x323 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x325) "once"
                     [|((match x322 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x324 : Ojs.t) ->
                            x323 ~src:(Stream.Readable.t_0_of_js x324)))|])
        let (once''''''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x329 : t) ->
            fun ~event:(x326 : [ `unpipe ]) ->
              fun ~listener:(x327 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (prependListener'' :
          ...
          fun (x361 : t) ->
            fun ~event:(x357 : [ `data ]) ->
              fun ~listener:(x358 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x361) "prependListener"
                     [|((match x357 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x359 : Ojs.t) ->
                            x358
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x359)))|])
        let (prependListener''' :
          t -> event:[ `drain ] -> listener:(unit -> unit) -> t) =
          fun (x364 : t) ->
        ...
        let (prependListener'''''''' :
          ...
          fun (x383 : t) ->
            fun ~event:(x380 : [ `pipe ]) ->
              fun ~listener:(x381 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x383) "prependListener"
                     [|((match x380 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x382 : Ojs.t) ->
                            x381 ~src:(Stream.Readable.t_0_of_js x382)))|])
        let (prependListener''''''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x387 : t) ->
            fun ~event:(x384 : [ `unpipe ]) ->
              fun ~listener:(x385 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (prependOnceListener'' :
          ...
          fun (x419 : t) ->
            fun ~event:(x415 : [ `data ]) ->
              fun ~listener:(x416 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x419) "prependOnceListener"
                     [|((match x415 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x417 : Ojs.t) ->
                            x416
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x417)))|])
        let (prependOnceListener''' :
          t -> event:[ `drain ] -> listener:(unit -> unit) -> t) =
          fun (x422 : t) ->
        ...
        let (prependOnceListener'''''''' :
          ...
          fun (x441 : t) ->
            fun ~event:(x438 : [ `pipe ]) ->
              fun ~listener:(x439 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x441) "prependOnceListener"
                     [|((match x438 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x440 : Ojs.t) ->
                            x439 ~src:(Stream.Readable.t_0_of_js x440)))|])
        let (prependOnceListener''''''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x445 : t) ->
            fun ~event:(x442 : [ `unpipe ]) ->
              fun ~listener:(x443 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                                                              ...
                                                              (fun (x464 : _)
                                                                 ...
                                                                 x463
                                                                   ...
                                                                   Ojs.list_of_js_from
                                                                    any_of_js
                                                                    x464 0)))|])
        let (cast : t -> Stream.Duplex.t_0) =
          fun (x467 : t) -> Stream.Duplex.t_0_of_js (t_to_js x467)
      end
    ...
    module ServerHttp2Stream =
      struct
        ...
        let (additionalHeaders :
          t -> headers:OutgoingHttpHeaders.t_0 -> unit) =
          fun (x641 : t) ->
            fun ~headers:(x640 : OutgoingHttpHeaders.t_0) ->
              ignore
                (Ojs.call (t_to_js x641) "additionalHeaders"
                   [|(OutgoingHttpHeaders.t_0_to_js x640)|])
        let (pushStream :
          t ->
            headers:OutgoingHttpHeaders.t_0 ->
              ?callback:(err:Error.t_0 or_null ->
                           pushStream:t ->
                             headers:OutgoingHttpHeaders.t_0 -> unit)
                -> unit -> unit)
          =
          fun (x650 : t) ->
            fun ~headers:(x642 : OutgoingHttpHeaders.t_0) ->
              fun
                ?callback:(x643 :
                    ...
                    (let x651 = t_to_js x650 in
                     Ojs.call (Ojs.get_prop_ascii x651 "pushStream") "apply"
                       [|x651;((let x644 =
                                ...
                                ignore
                                  (Ojs.call x644 "push"
                                     [|(OutgoingHttpHeaders.t_0_to_js x642)|]);
                                (match x643 with
                                 | Some x645 ->
                                     ignore
                                       (Ojs.call x644 "push"
                                                  ...
                                                  fun (x648 : Ojs.t) ->
                                                    fun (x649 : Ojs.t) ->
                                                      x645
                                                        ...
                                                        ~pushStream:(
                                                        t_of_js x648)
                                                        ~headers:(OutgoingHttpHeaders.t_0_of_js
                                                                    x649)))|])
                                 | None -> ());
                                x644))|])
        let (pushStream' :
          ...
          =
          fun (x662 : t) ->
            fun ~headers:(x652 : OutgoingHttpHeaders.t_0) ->
                      ...
                      (let x663 = t_to_js x662 in
                       Ojs.call (Ojs.get_prop_ascii x663 "pushStream")
                         ...
                         [|x663;((let x655 =
                                  ...
                                  ignore
                                    (Ojs.call x655 "push"
                                       [|(OutgoingHttpHeaders.t_0_to_js x652)|]);
                                  (match x653 with
                                   | Some x661 ->
                                       ignore
                                         (Ojs.call x655 "push"
        ...
        let (respond :
          ...
          =
          fun (x669 : t) ->
            fun ?headers:(x664 : OutgoingHttpHeaders.t_0 option) ->
        ...
        let (respondWithFD :
          ...
          =
          fun (x678 : t) ->
            fun ~fd:(x671 : Fs.Promises.FileHandle.t_0 or_number) ->
              fun ?headers:(x672 : OutgoingHttpHeaders.t_0 option) ->
                fun
                  ?options:(x673 :
                       ...
                       Ojs.call (Ojs.get_prop_ascii x679 "respondWithFD")
                         ...
                         [|x679;((let x674 =
                                  ...
                                  ignore
                                    (Ojs.call x674 "push"
                                       [|(or_number_to_js
                                            Fs.Promises.FileHandle.t_0_to_js
                                            x671)|]);
                                  (match x672 with
                                   | Some x676 ->
                                       ignore
        ...
        let (respondWithFile :
          ...
          fun (x686 : t) ->
            fun ~path:(x680 : string) ->
              fun ?headers:(x681 : OutgoingHttpHeaders.t_0 option) ->
                fun
                  ?options:(x682 :
                             http2_ServerStreamFileResponseOptionsWithError
                               option)
    ...
    module Http2Session =
      struct
        ...
        let (get_socket : t -> (Net.Socket.t_0, Tls.TLSSocket.t_0) union2) =
          fun (x770 : t) ->
            union2_of_js Net.Socket.t_0_of_js Tls.TLSSocket.t_0_of_js
                   ...
                   Ojs.call (Ojs.get_prop_ascii x779 "close") "apply"
                     [|x779;((let x776 =
                              ...
                              (match x775 with
                               ...
                               | None -> ());
                              x776))|])
        let (destroy : t -> ?error:Error.t_0 -> ?code:float -> unit -> unit)
          =
          fun (x785 : t) ->
            fun ?error:(x780 : Error.t_0 option) ->
        ...
        let (goaway :
          t ->
            ?code:float ->
              ?lastStreamID:float ->
                ?opaqueData:NodeJS.ArrayBufferView.t_0 -> unit -> unit)
          =
          fun (x794 : t) ->
            fun ?code:(x787 : float option) ->
              fun ?lastStreamID:(x788 : float option) ->
                fun ?opaqueData:(x789 : NodeJS.ArrayBufferView.t_0 option) ->
                  fun () ->
                    ignore
        ...
        let (ping :
          t ->
            callback:(err:Error.t_0 or_null ->
                        duration:float -> payload:Buffer.t_0 -> unit)
              -> bool)
          =
          fun (x801 : t) ->
            fun
                ...
                (Ojs.call (t_to_js x801) "ping"
                   [|(Ojs.fun_to_js 3
                        (fun (x797 : Ojs.t) ->
                           fun (x799 : Ojs.t) ->
                             fun (x800 : Ojs.t) ->
                               x796 ~err:(or_null_of_js Error.t_0_of_js x797)
                                 ~duration:(Ojs.float_of_js x799)
                                 ~payload:(Buffer.t_0_of_js x800)))|])
        let (ping' :
          t ->
          ...
          =
          fun (x808 : t) ->
            fun ~payload:(x802 : NodeJS.ArrayBufferView.t_0) ->
              fun
                ~callback:(x803 :
                            err:Error.t_0 or_null ->
                              duration:float -> payload:Buffer.t_0 -> unit)
                ...
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x808) "ping"
                     [|(NodeJS.ArrayBufferView.t_0_to_js x802);(Ojs.fun_to_js
                                                                  3
                                                                  (fun
                                                                    (x804 :
                                                                    Ojs.t) ->
          ...
          t ->
            event:[ `goaway ] ->
              listener:(errorCode:float ->
                          lastStreamID:float -> opaqueData:Buffer.t_0 -> unit)
                -> t)
          =
          fun (x839 : t) ->
        ...
        let (prependOnceListener' :
          ...
          fun (x1015 : t) ->
            fun ~event:(x1012 : [ `error ]) ->
              fun ~listener:(x1013 : err:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (cast : t -> EventEmitter.t_0) =
          fun (x1048 : t) -> EventEmitter.t_0_of_js (t_to_js x1048)
      end
    module ClientHttp2Session =
      struct
        ...
        let (request :
          ...
          =
          fun (x1056 : t) ->
            fun ?headers:(x1051 : OutgoingHttpHeaders.t_0 option) ->
          ...
          fun (x1075 : t) ->
            fun ~event:(x1069 : [ `connect ]) ->
              fun
                ~listener:(x1070 :
                            session:t ->
                              socket:(Net.Socket.t_0, Tls.TLSSocket.t_0)
                                union2 -> unit)
                ->
                t_of_js
                         ...
                         (fun (x1071 : Ojs.t) ->
                            fun (x1072 : Ojs.t) ->
                              x1070 ~session:(t_of_js x1071)
                                ~socket:(union2_of_js Net.Socket.t_0_of_js
                                           Tls.TLSSocket.t_0_of_js x1072)))|])
        let (addListener''' :
          t ->
            event:[ `stream ] ->
        ...
        let (emit'' :
          t ->
            event:[ `connect ] ->
              session:t ->
                socket:(Net.Socket.t_0, Tls.TLSSocket.t_0) union2 -> bool)
          =
          fun (x1104 : t) ->
            fun ~event:(x1099 : [ `connect ]) ->
              fun ~session:(x1100 : t) ->
                fun
                  ~socket:(x1101 :
                            (Net.Socket.t_0, Tls.TLSSocket.t_0) union2)
                  ->
                  Ojs.bool_of_js
                    (Ojs.call (t_to_js x1104) "emit"
                       [|((match x1099 with
                           | `connect -> Ojs.string_to_js "connect"));(
                         t_to_js x1100);(union2_to_js Net.Socket.t_0_to_js
                                           Tls.TLSSocket.t_0_to_js x1101)|])
        let (emit''' :
          t ->
            event:[ `stream ] ->
              stream:http2_ClientHttp2Stream ->
    ...
    module AlternativeServiceOptions =
      struct
        ...
        let (get_origin : t -> Url.URL.t_0 or_string or_number) =
          fun (x1250 : t) ->
            or_number_of_js
              (fun (x1251 : Ojs.t) -> or_string_of_js Url.URL.t_0_of_js x1251)
              (Ojs.get_prop_ascii (t_to_js x1250) "origin")
        let (set_origin : t -> Url.URL.t_0 or_string or_number -> unit) =
          fun (x1253 : t) ->
            fun (x1254 : Url.URL.t_0 or_string or_number) ->
              Ojs.set_prop_ascii (t_to_js x1253) "origin"
                (or_number_to_js
                   (fun (x1255 : Url.URL.t_0 or_string) ->
                      or_string_to_js Url.URL.t_0_to_js x1255) x1254)
      end
    module ServerHttp2Session =
      struct
        ...
        let (altsvc :
          t ->
            alt:string ->
              originOrStream:(http2_AlternativeServiceOptions, Url.URL.t_0)
              ...
              fun
                ~originOrStream:(x1263 :
                                  (http2_AlternativeServiceOptions,
                                    Url.URL.t_0) union2 or_string or_number)
                ->
                ignore
                ...
                fun
                  ...
                  Ojs.bool_of_js
                    (Ojs.call (t_to_js x1298) "emit"
                       [|((match x1293 with
                           | `connect -> Ojs.string_to_js "connect"));(
                         t_to_js x1294);(union2_to_js Net.Socket.t_0_to_js
                                           Tls.TLSSocket.t_0_to_js x1295)|])
        let (emit' :
          t ->
            event:[ `stream ] ->
              stream:http2_ServerHttp2Stream ->
    ...
    module SessionOptions =
      struct
        ...
        let (createConnection :
          t -> authority:Url.URL.t_0 -> option:t -> Stream.Duplex.t_0) =
          fun (x1419 : t) ->
            fun ~authority:(x1417 : Url.URL.t_0) ->
              fun ~option:(x1418 : t) ->
                Stream.Duplex.t_0_of_js
                  (Ojs.call (t_to_js x1419) "createConnection"
                     [|(Url.URL.t_0_to_js x1417);(t_to_js x1418)|])
      end
        ...
        let (createConnection :
          t ->
            authority:Url.URL.t_0 ->
              option:http2_SessionOptions -> Stream.Duplex.t_0)
          =
          fun (x1427 : t) ->
            fun ~authority:(x1425 : Url.URL.t_0) ->
              fun ~option:(x1426 : http2_SessionOptions) ->
                Stream.Duplex.t_0_of_js
                  (Ojs.call (t_to_js x1427) "createConnection"
                     [|(Url.URL.t_0_to_js x1425);(http2_SessionOptions_to_js
                                                    x1426)|])
    ...
    module SecureClientSessionOptions =
      struct
        ...
        let (cast' : t -> Tls.ConnectionOptions.t_0) =
          fun (x1451 : t) -> Tls.ConnectionOptions.t_0_of_js (t_to_js x1451)
      end
    module SecureServerSessionOptions =
      struct
        ...
        let (cast' : t -> Tls.TlsOptions.t_0) =
          fun (x1455 : t) -> Tls.TlsOptions.t_0_of_js (t_to_js x1455)
      end
    ...
    module Http2Server =
      struct
        ...
        let (addListener''' :
          t ->
            event:[ `sessionError ] -> listener:(err:Error.t_0 -> unit) -> t)
          =
          fun (x1489 : t) ->
            fun ~event:(x1486 : [ `sessionError ]) ->
              fun ~listener:(x1487 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1489) "addListener"
                     [|((match x1486 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1488 : Ojs.t) ->
                            x1487 ~err:(Error.t_0_of_js x1488)))|])
        let (addListener'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (emit''' : t -> event:[ `sessionError ] -> err:Error.t_0 -> bool)
          =
          fun (x1518 : t) ->
            fun ~event:(x1516 : [ `sessionError ]) ->
              fun ~err:(x1517 : Error.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x1518) "emit"
                     [|((match x1516 with
                         | `sessionError -> Ojs.string_to_js "sessionError"));(
                       Error.t_0_to_js x1517)|])
        let (emit'''' :
          t ->
            event:[ `stream ] ->
              stream:http2_ServerHttp2Stream ->
        ...
        let (on''' :
          ...
          fun (x1550 : t) ->
            fun ~event:(x1547 : [ `sessionError ]) ->
              fun ~listener:(x1548 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1550) "on"
                     [|((match x1547 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1549 : Ojs.t) ->
                            x1548 ~err:(Error.t_0_of_js x1549)))|])
        let (on'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (once''' :
          ...
          fun (x1583 : t) ->
            fun ~event:(x1580 : [ `sessionError ]) ->
              fun ~listener:(x1581 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1583) "once"
                     [|((match x1580 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1582 : Ojs.t) ->
                            x1581 ~err:(Error.t_0_of_js x1582)))|])
        let (once'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (prependListener''' :
          ...
          fun (x1616 : t) ->
            fun ~event:(x1613 : [ `sessionError ]) ->
              fun ~listener:(x1614 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1616) "prependListener"
                     [|((match x1613 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1615 : Ojs.t) ->
                            x1614 ~err:(Error.t_0_of_js x1615)))|])
        let (prependListener'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (prependOnceListener''' :
          ...
          fun (x1649 : t) ->
            fun ~event:(x1646 : [ `sessionError ]) ->
              fun ~listener:(x1647 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1649) "prependOnceListener"
                     [|((match x1646 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1648 : Ojs.t) ->
                            x1647 ~err:(Error.t_0_of_js x1648)))|])
        let (prependOnceListener'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (cast : t -> Net.Server.t_0) =
          fun (x1672 : t) -> Net.Server.t_0_of_js (t_to_js x1672)
      end
    module Http2SecureServer =
      struct
        ...
        let (addListener''' :
          ...
          fun (x1692 : t) ->
            fun ~event:(x1689 : [ `sessionError ]) ->
              fun ~listener:(x1690 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1692) "addListener"
                     [|((match x1689 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1691 : Ojs.t) ->
                            x1690 ~err:(Error.t_0_of_js x1691)))|])
        let (addListener'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (addListener'''''' :
          t ->
            event:[ `unknownProtocol ] ->
              listener:(socket:Tls.TLSSocket.t_0 -> unit) -> t)
          =
          fun (x1705 : t) ->
            fun ~event:(x1702 : [ `unknownProtocol ]) ->
              fun ~listener:(x1703 : socket:Tls.TLSSocket.t_0 -> unit) ->
                t_of_js
        ...
        let (emit''' : t -> event:[ `sessionError ] -> err:Error.t_0 -> bool)
          ...
          fun (x1725 : t) ->
            fun ~event:(x1723 : [ `sessionError ]) ->
              fun ~err:(x1724 : Error.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x1725) "emit"
                     [|((match x1723 with
                         | `sessionError -> Ojs.string_to_js "sessionError"));(
                       Error.t_0_to_js x1724)|])
        let (emit'''' :
          t ->
            event:[ `stream ] ->
              stream:http2_ServerHttp2Stream ->
              ...
              Ojs.bool_of_js
                (Ojs.call (t_to_js x1732) "emit"
                   [|((match x1731 with
                       | `timeout -> Ojs.string_to_js "timeout"))|])
        let (emit'''''' :
          t -> event:[ `unknownProtocol ] -> socket:Tls.TLSSocket.t_0 -> bool)
          =
          fun (x1735 : t) ->
            fun ~event:(x1733 : [ `unknownProtocol ]) ->
              fun ~socket:(x1734 : Tls.TLSSocket.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x1735) "emit"
                     [|((match x1733 with
                         | `unknownProtocol ->
                             Ojs.string_to_js "unknownProtocol"));(Tls.TLSSocket.t_0_to_js
                                                                    x1734)|])
        let (emit''''''' :
          t -> event:symbol or_string -> args:any list -> bool) =
          fun (x1741 : t) ->
        ...
        let (on''' :
          ...
          fun (x1760 : t) ->
            fun ~event:(x1757 : [ `sessionError ]) ->
              fun ~listener:(x1758 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1760) "on"
                     [|((match x1757 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1759 : Ojs.t) ->
                            x1758 ~err:(Error.t_0_of_js x1759)))|])
        let (on'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (on'''''' :
          ...
          fun (x1773 : t) ->
            fun ~event:(x1770 : [ `unknownProtocol ]) ->
              fun ~listener:(x1771 : socket:Tls.TLSSocket.t_0 -> unit) ->
                t_of_js
        ...
        let (once''' :
          ...
          fun (x1797 : t) ->
            fun ~event:(x1794 : [ `sessionError ]) ->
              fun ~listener:(x1795 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1797) "once"
                     [|((match x1794 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1796 : Ojs.t) ->
                            x1795 ~err:(Error.t_0_of_js x1796)))|])
        let (once'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (once'''''' :
          ...
          fun (x1810 : t) ->
            fun ~event:(x1807 : [ `unknownProtocol ]) ->
              fun ~listener:(x1808 : socket:Tls.TLSSocket.t_0 -> unit) ->
                t_of_js
        ...
        let (prependListener''' :
          ...
          fun (x1834 : t) ->
            fun ~event:(x1831 : [ `sessionError ]) ->
              fun ~listener:(x1832 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1834) "prependListener"
                     [|((match x1831 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1833 : Ojs.t) ->
                            x1832 ~err:(Error.t_0_of_js x1833)))|])
        let (prependListener'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (prependListener'''''' :
          ...
          fun (x1847 : t) ->
            fun ~event:(x1844 : [ `unknownProtocol ]) ->
              fun ~listener:(x1845 : socket:Tls.TLSSocket.t_0 -> unit) ->
                t_of_js
        ...
        let (prependOnceListener''' :
          ...
          fun (x1871 : t) ->
            fun ~event:(x1868 : [ `sessionError ]) ->
              fun ~listener:(x1869 : err:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1871) "prependOnceListener"
                     [|((match x1868 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x1870 : Ojs.t) ->
                            x1869 ~err:(Error.t_0_of_js x1870)))|])
        let (prependOnceListener'''' :
          t ->
            event:[ `stream ] ->
              listener:(stream:http2_ServerHttp2Stream ->
        ...
        let (prependOnceListener'''''' :
          ...
          fun (x1884 : t) ->
            fun ~event:(x1881 : [ `unknownProtocol ]) ->
              fun ~listener:(x1882 : socket:Tls.TLSSocket.t_0 -> unit) ->
                t_of_js
        ...
        let (cast : t -> Tls.Server.t_0) =
          fun (x1898 : t) -> Tls.Server.t_0_of_js (t_to_js x1898)
      end
    module Http2ServerRequest =
      struct
        ...
        let (get_connection :
          t -> (Net.Socket.t_0, Tls.TLSSocket.t_0) union2) =
          fun (x1908 : t) ->
            union2_of_js Net.Socket.t_0_of_js Tls.TLSSocket.t_0_of_js
                     ...
                     Ojs.call (Ojs.get_prop_ascii x1933 "setTimeout") "apply"
                       [|x1933;((let x1930 =
                                 ...
                                 (match x1929 with
                                  ...
                                  | None -> ());
                                 x1930))|])
        let (read : t -> ?size:float -> unit -> Buffer.t_0 or_string or_null)
          =
          fun (x1937 : t) ->
            fun ?size:(x1934 : float option) ->
              fun () ->
                or_null_of_js
                  (fun (x1939 : Ojs.t) ->
                     or_string_of_js Buffer.t_0_of_js x1939)
        ...
        let (addListener'' :
          ...
          fun (x1953 : t) ->
            fun ~event:(x1949 : [ `data ]) ->
              fun ~listener:(x1950 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x1953) "addListener"
                     [|((match x1949 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x1951 : Ojs.t) ->
                            x1950
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x1951)))|])
        let (addListener''' :
          t -> event:[ `end_ ] -> listener:(unit -> unit) -> t) =
          fun (x1956 : t) ->
        ...
        let (addListener''''' :
          ...
          fun (x1963 : t) ->
            fun ~event:(x1960 : [ `error ]) ->
              fun ~listener:(x1961 : err:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (emit'' :
          ...
          fun (x1979 : t) ->
            fun ~event:(x1976 : [ `data ]) ->
              fun ~chunk:(x1977 : Buffer.t_0 or_string) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x1979) "emit"
                     [|((match x1976 with | `data -> Ojs.string_to_js "data"));(
                       or_string_to_js Buffer.t_0_to_js x1977)|])
        let (emit''' : t -> event:[ `end_ ] -> bool) =
          fun (x1981 : t) ->
        ...
        let (emit''''' : t -> event:[ `error ] -> err:Error.t_0 -> bool) =
          fun (x1986 : t) ->
            fun ~event:(x1984 : [ `error ]) ->
              fun ~err:(x1985 : Error.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x1986) "emit"
                     [|((match x1984 with
                         | `error -> Ojs.string_to_js "error"));(Error.t_0_to_js
                                                                   x1985)|])
        let (emit'''''' :
          t -> event:symbol or_string -> args:any list -> bool) =
          fun (x1992 : t) ->
        ...
        let (on'' :
          ...
          fun (x2006 : t) ->
            fun ~event:(x2002 : [ `data ]) ->
              fun ~listener:(x2003 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2006) "on"
                     [|((match x2002 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x2004 : Ojs.t) ->
                            x2003
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x2004)))|])
        let (on''' : t -> event:[ `end_ ] -> listener:(unit -> unit) -> t) =
          fun (x2009 : t) ->
        ...
        let (on''''' :
          ...
          fun (x2016 : t) ->
            fun ~event:(x2013 : [ `error ]) ->
              fun ~listener:(x2014 : err:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (once'' :
          ...
          fun (x2035 : t) ->
            fun ~event:(x2031 : [ `data ]) ->
              fun ~listener:(x2032 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2035) "once"
                     [|((match x2031 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x2033 : Ojs.t) ->
                            x2032
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x2033)))|])
        let (once''' : t -> event:[ `end_ ] -> listener:(unit -> unit) -> t)
          =
          fun (x2038 : t) ->
        ...
        let (once''''' :
          ...
          fun (x2045 : t) ->
            fun ~event:(x2042 : [ `error ]) ->
              fun ~listener:(x2043 : err:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (prependListener'' :
          ...
          fun (x2064 : t) ->
            fun ~event:(x2060 : [ `data ]) ->
              fun ~listener:(x2061 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2064) "prependListener"
                     [|((match x2060 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x2062 : Ojs.t) ->
                            x2061
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x2062)))|])
        let (prependListener''' :
          t -> event:[ `end_ ] -> listener:(unit -> unit) -> t) =
          fun (x2067 : t) ->
        ...
        let (prependListener''''' :
          ...
          fun (x2074 : t) ->
            fun ~event:(x2071 : [ `error ]) ->
              fun ~listener:(x2072 : err:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (prependOnceListener'' :
          ...
          fun (x2093 : t) ->
            fun ~event:(x2089 : [ `data ]) ->
              fun ~listener:(x2090 : chunk:Buffer.t_0 or_string -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2093) "prependOnceListener"
                     [|((match x2089 with | `data -> Ojs.string_to_js "data"));(
                       Ojs.fun_to_js 1
                         (fun (x2091 : Ojs.t) ->
                            x2090
                              ~chunk:(or_string_of_js Buffer.t_0_of_js x2091)))|])
        let (prependOnceListener''' :
          t -> event:[ `end_ ] -> listener:(unit -> unit) -> t) =
          fun (x2096 : t) ->
        ...
        let (prependOnceListener''''' :
          ...
          fun (x2103 : t) ->
            fun ~event:(x2100 : [ `error ]) ->
              fun ~listener:(x2101 : err:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (cast : t -> Stream.Readable.t_0) =
          fun (x2110 : t) -> Stream.Readable.t_0_of_js (t_to_js x2110)
      end
      ...
      struct
        ...
        let (create : stream:http2_ServerHttp2Stream -> t) =
          fun ~stream:(x2113 : http2_ServerHttp2Stream) ->
            t_of_js
              (Ojs.new_obj
                 (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "http2")
                    "Http2ServerResponse")
        ...
        let (addTrailers : t -> trailers:OutgoingHttpHeaders.t_0 -> unit) =
          fun (x2134 : t) ->
            fun ~trailers:(x2133 : OutgoingHttpHeaders.t_0) ->
              ignore
                (Ojs.call (t_to_js x2134) "addTrailers"
                   [|(OutgoingHttpHeaders.t_0_to_js x2133)|])
        ...
        let (end_'' :
          ...
          fun (x2153 : t) ->
            fun ~data:(x2147 : Uint8Array.t or_string) ->
              fun ~encoding:(x2148 : BufferEncoding.t_0) ->
                      ...
                      (let x2154 = t_to_js x2153 in
                       Ojs.call (Ojs.get_prop_ascii x2154 "end") "apply"
                         [|x2154;((let x2150 =
                                   ...
                                   ignore
                                     (Ojs.call x2150 "push"
                                        [|(BufferEncoding.t_0_to_js x2148)|]);
                                   (match x2149 with
                                    | Some x2151 ->
                                        ignore
                                          (Ojs.call x2150 "push"
        ...
        let (getHeaders : t -> OutgoingHttpHeaders.t_0) =
          fun (x2159 : t) ->
            OutgoingHttpHeaders.t_0_of_js
        ...
        let (write :
          t ->
            chunk:Uint8Array.t or_string ->
              ?callback:(err:Error.t_0 -> unit) -> unit -> bool)
          =
          fun (x2182 : t) ->
            fun ~chunk:(x2176 : Uint8Array.t or_string) ->
              fun ?callback:(x2177 : (err:Error.t_0 -> unit) option) ->
                fun () ->
                  Ojs.bool_of_js
        ...
        let (write' :
          ...
          fun (x2191 : t) ->
            fun ~chunk:(x2184 : Uint8Array.t or_string) ->
              fun ~encoding:(x2185 : BufferEncoding.t_0) ->
                fun ?callback:(x2186 : (err:Error.t_0 -> unit) option) ->
                  fun () ->
                    Ojs.bool_of_js
                      (let x2192 = t_to_js x2191 in
                       Ojs.call (Ojs.get_prop_ascii x2192 "write") "apply"
                         [|x2192;((let x2187 =
                                   ...
                                   ignore
                                     (Ojs.call x2187 "push"
                                        [|(BufferEncoding.t_0_to_js x2185)|]);
                                   (match x2186 with
                                    | Some x2188 ->
                                        ignore
                                          (Ojs.call x2187 "push"
        ...
        let (writeHead :
          t ->
            statusCode:float -> ?headers:OutgoingHttpHeaders.t_0 -> unit -> t)
          =
          fun (x2198 : t) ->
            fun ~statusCode:(x2194 : float) ->
              fun ?headers:(x2195 : OutgoingHttpHeaders.t_0 option) ->
                fun () ->
                  t_of_js
          ...
          t ->
            statusCode:float ->
              statusMessage:string ->
                ?headers:OutgoingHttpHeaders.t_0 -> unit -> t)
          =
          fun (x2205 : t) ->
            fun ~statusCode:(x2200 : float) ->
              fun ~statusMessage:(x2201 : string) ->
                fun ?headers:(x2202 : OutgoingHttpHeaders.t_0 option) ->
                  fun () ->
                    t_of_js
        ...
        let (createPushResponse :
          t ->
            headers:OutgoingHttpHeaders.t_0 ->
              callback:(err:Error.t_0 or_null -> res:t -> unit) -> unit)
          =
          fun (x2212 : t) ->
            fun ~headers:(x2207 : OutgoingHttpHeaders.t_0) ->
              fun ~callback:(x2208 : err:Error.t_0 or_null -> res:t -> unit)
                ->
                ignore
                  (Ojs.call (t_to_js x2212) "createPushResponse"
                     [|(OutgoingHttpHeaders.t_0_to_js x2207);(Ojs.fun_to_js 2
                                                                (fun
                                                                   (x2209 :
                                                                    Ojs.t)
                                                                   ->
        ...
        let (addListener'' :
          ...
          fun (x2222 : t) ->
            fun ~event:(x2219 : [ `error ]) ->
              fun ~listener:(x2220 : error:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (addListener'''' :
          ...
          fun (x2229 : t) ->
            fun ~event:(x2226 : [ `pipe ]) ->
              fun ~listener:(x2227 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2229) "addListener"
                     [|((match x2226 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x2228 : Ojs.t) ->
                            x2227 ~src:(Stream.Readable.t_0_of_js x2228)))|])
        let (addListener''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x2233 : t) ->
            fun ~event:(x2230 : [ `unpipe ]) ->
              fun ~listener:(x2231 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (emit'' : t -> event:[ `error ] -> error:Error.t_0 -> bool) =
          fun (x2246 : t) ->
            fun ~event:(x2244 : [ `error ]) ->
              fun ~error:(x2245 : Error.t_0) ->
                Ojs.bool_of_js
        ...
        let (emit'''' :
          ...
          fun (x2251 : t) ->
            fun ~event:(x2249 : [ `pipe ]) ->
              fun ~src:(x2250 : Stream.Readable.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x2251) "emit"
                     [|((match x2249 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Stream.Readable.t_0_to_js x2250)|])
        let (emit''''' :
          t -> event:[ `unpipe ] -> src:Stream.Readable.t_0 -> bool) =
          fun (x2254 : t) ->
            fun ~event:(x2252 : [ `unpipe ]) ->
              fun ~src:(x2253 : Stream.Readable.t_0) ->
                Ojs.bool_of_js
        ...
        let (on'' :
          ...
          fun (x2271 : t) ->
            fun ~event:(x2268 : [ `error ]) ->
              fun ~listener:(x2269 : error:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (on'''' :
          ...
          fun (x2278 : t) ->
            fun ~event:(x2275 : [ `pipe ]) ->
              fun ~listener:(x2276 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2278) "on"
                     [|((match x2275 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x2277 : Ojs.t) ->
                            x2276 ~src:(Stream.Readable.t_0_of_js x2277)))|])
        let (on''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x2282 : t) ->
            fun ~event:(x2279 : [ `unpipe ]) ->
              fun ~listener:(x2280 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (once'' :
          ...
          fun (x2298 : t) ->
            fun ~event:(x2295 : [ `error ]) ->
              fun ~listener:(x2296 : error:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (once'''' :
          ...
          fun (x2305 : t) ->
            fun ~event:(x2302 : [ `pipe ]) ->
              fun ~listener:(x2303 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2305) "once"
                     [|((match x2302 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x2304 : Ojs.t) ->
                            x2303 ~src:(Stream.Readable.t_0_of_js x2304)))|])
        let (once''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x2309 : t) ->
            fun ~event:(x2306 : [ `unpipe ]) ->
              fun ~listener:(x2307 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (prependListener'' :
          ...
          fun (x2325 : t) ->
            fun ~event:(x2322 : [ `error ]) ->
              fun ~listener:(x2323 : error:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (prependListener'''' :
          ...
          fun (x2332 : t) ->
            fun ~event:(x2329 : [ `pipe ]) ->
              fun ~listener:(x2330 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2332) "prependListener"
                     [|((match x2329 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x2331 : Ojs.t) ->
                            x2330 ~src:(Stream.Readable.t_0_of_js x2331)))|])
        let (prependListener''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x2336 : t) ->
            fun ~event:(x2333 : [ `unpipe ]) ->
              fun ~listener:(x2334 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (prependOnceListener'' :
          ...
          fun (x2352 : t) ->
            fun ~event:(x2349 : [ `error ]) ->
              fun ~listener:(x2350 : error:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (prependOnceListener'''' :
          ...
          fun (x2359 : t) ->
            fun ~event:(x2356 : [ `pipe ]) ->
              fun ~listener:(x2357 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x2359) "prependOnceListener"
                     [|((match x2356 with | `pipe -> Ojs.string_to_js "pipe"));(
                       Ojs.fun_to_js 1
                         (fun (x2358 : Ojs.t) ->
                            x2357 ~src:(Stream.Readable.t_0_of_js x2358)))|])
        let (prependOnceListener''''' :
          t ->
            event:[ `unpipe ] ->
              listener:(src:Stream.Readable.t_0 -> unit) -> t)
          ...
          fun (x2363 : t) ->
            fun ~event:(x2360 : [ `unpipe ]) ->
              fun ~listener:(x2361 : src:Stream.Readable.t_0 -> unit) ->
                t_of_js
        ...
        let (cast : t -> Stream.Writable.t_0) =
          fun (x2370 : t) -> Stream.Writable.t_0_of_js (t_to_js x2370)
      end
    module Constants =
      struct
        ...
        let (hTTP2_HEADER_SET_COOKIE : string) =
          Ojs.string_of_js
            (Ojs.get_prop_ascii
               (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "http2")
                  "constants") "HTTP2_HEADER_SET_COOKIE")
        ...
        let (hTTP_STATUS_NON_AUTHORITATIVE_INFORMATION : float) =
          Ojs.float_of_js
            (Ojs.get_prop_ascii
               (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "http2")
                  "constants") "HTTP_STATUS_NON_AUTHORITATIVE_INFORMATION")
        ...
        let (hTTP_STATUS_UNAVAILABLE_FOR_LEGAL_REASONS : float) =
          Ojs.float_of_js
            (Ojs.get_prop_ascii
               (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "http2")
                  "constants") "HTTP_STATUS_UNAVAILABLE_FOR_LEGAL_REASONS")
    ...
    let (getDefaultSettings : unit -> http2_Settings) =
      fun () ->
        http2_Settings_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "http2")
             "getDefaultSettings" [||])
    let (getPackedSettings : settings:http2_Settings -> Buffer.t_0) =
      fun ~settings:(x2371 : http2_Settings) ->
        Buffer.t_0_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "http2")
             "getPackedSettings" [|(http2_Settings_to_js x2371)|])
    let (getUnpackedSettings : buf:Uint8Array.t -> http2_Settings) =
      fun ~buf:(x2372 : Uint8Array.t) ->
        http2_Settings_of_js
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "http2")
             "getUnpackedSettings" [|(Uint8Array.t_to_js x2372)|])
    let (createServer :
      ...
      fun
        ...
        fun () ->
          http2_Http2Server_of_js
            (let x2378 = Ojs.get_prop_ascii Ojs.global "http2" in
    ...
    let (createServer :
      ...
      fun ~options:(x2379 : http2_ServerOptions) ->
        fun
          ...
          fun () ->
            http2_Http2Server_of_js
              (let x2385 = Ojs.get_prop_ascii Ojs.global "http2" in
      ...
      fun
        ...
        fun () ->
          http2_Http2SecureServer_of_js
            (let x2391 = Ojs.get_prop_ascii Ojs.global "http2" in
    ...
    let (createSecureServer :
      ...
      fun ~options:(x2392 : http2_SecureServerOptions) ->
        fun
          ...
          fun () ->
            http2_Http2SecureServer_of_js
              (let x2398 = Ojs.get_prop_ascii Ojs.global "http2" in
    ...
    let (connect :
      authority:Url.URL.t_0 or_string ->
        listener:(session:http2_ClientHttp2Session ->
                    socket:(Net.Socket.t_0, Tls.TLSSocket.t_0) union2 -> unit)
          -> http2_ClientHttp2Session)
      =
      fun ~authority:(x2399 : Url.URL.t_0 or_string) ->
        fun
          ~listener:(x2401 :
          ...
          http2_ClientHttp2Session_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "http2") "connect"
               [|(or_string_to_js Url.URL.t_0_to_js x2399);(Ojs.fun_to_js 2
                                                              (fun
                                                                 (x2402 :
                                                                   Ojs.t)
                                                                 ->
    ...
    let (connect :
      ...
      =
      fun ~authority:(x2406 : Url.URL.t_0 or_string) ->
        fun
          ?options:(x2407 :
                     [
                       `U_s15_http_ of
          ...
          fun
            ...
            fun () ->
              http2_ClientHttp2Session_of_js
                (let x2423 = Ojs.get_prop_ascii Ojs.global "http2" in
                 Ojs.call (Ojs.get_prop_ascii x2423 "connect") "apply"
                   [|x2423;((let x2409 =
                             ...
                             ignore
                               (Ojs.call x2409 "push"
                                  [|(or_string_to_js Url.URL.t_0_to_js x2406)|]);
                             (match x2407 with
                              | Some x2415 ->
                                  ignore
                                    (Ojs.call x2409 "push"
