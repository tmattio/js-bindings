...
module AnonymousInterface0 =
  struct
    ...
    let (get_options : t -> InspectOptions.t_0) =
      fun (x3 : t) ->
        InspectOptions.t_0_of_js (Ojs.get_prop_ascii (t_to_js x3) "options")
    let (set_options : t -> InspectOptions.t_0 -> unit) =
      fun (x4 : t) ->
        fun (x5 : InspectOptions.t_0) ->
          Ojs.set_prop_ascii (t_to_js x4) "options"
            (InspectOptions.t_0_to_js x5)
  end
module Node_repl = struct  end
module Repl =
  struct
    module ReplOptions =
      struct
        ...
        let (get_input : t -> NodeJS.ReadableStream.t_0) =
          fun (x11 : t) ->
            NodeJS.ReadableStream.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x11) "input")
        let (set_input : t -> NodeJS.ReadableStream.t_0 -> unit) =
          fun (x12 : t) ->
            fun (x13 : NodeJS.ReadableStream.t_0) ->
              Ojs.set_prop_ascii (t_to_js x12) "input"
                (NodeJS.ReadableStream.t_0_to_js x13)
        let (get_output : t -> NodeJS.WritableStream.t_0) =
          fun (x14 : t) ->
            NodeJS.WritableStream.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x14) "output")
        let (set_output : t -> NodeJS.WritableStream.t_0 -> unit) =
          fun (x15 : t) ->
            fun (x16 : NodeJS.WritableStream.t_0) ->
              Ojs.set_prop_ascii (t_to_js x15) "output"
                (NodeJS.WritableStream.t_0_to_js x16)
        ...
        let (get_completer : t -> (AsyncCompleter.t_0, Completer.t_0) union2)
          =
          fun (x38 : t) ->
            union2_of_js AsyncCompleter.t_0_of_js Completer.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x38) "completer")
        let (set_completer :
          t -> (AsyncCompleter.t_0, Completer.t_0) union2 -> unit) =
          fun (x41 : t) ->
            fun (x42 : (AsyncCompleter.t_0, Completer.t_0) union2) ->
              Ojs.set_prop_ascii (t_to_js x41) "completer"
                (union2_to_js AsyncCompleter.t_0_to_js Completer.t_0_to_js
                   x42)
          ...
          t ->
            this:repl_REPLServer ->
              evalCmd:string ->
                context:Context.t_0 ->
                  file:string ->
                    cb:(err:Error.t_0 or_null -> result:any -> unit) -> unit)
          =
          fun (x61 : t) ->
            fun ~this:(x53 : repl_REPLServer) ->
              fun ~evalCmd:(x54 : string) ->
                fun ~context:(x55 : Context.t_0) ->
                  fun ~file:(x56 : string) ->
                    fun
                      ~cb:(x57 : err:Error.t_0 or_null -> result:any -> unit)
                      ->
                      ignore
                        (Ojs.apply (t_to_js x61)
                           [|(repl_REPLServer_to_js x53);(Ojs.string_to_js
                                                            x54);(Context.t_0_to_js
                                                                    x55);(
    ...
    let (writer : (repl_REPLWriter, anonymous_interface_0) intersection2) =
      intersection2_of_js repl_REPLWriter_of_js anonymous_interface_0_of_js
        (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "repl") "writer")
    ...
    module REPLServer =
      struct
        ...
        let (get_context : t -> Context.t_0) =
          fun (x84 : t) ->
            Context.t_0_of_js (Ojs.get_prop_ascii (t_to_js x84) "context")
        let (get_inputStream : t -> NodeJS.ReadableStream.t_0) =
          fun (x85 : t) ->
            NodeJS.ReadableStream.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x85) "inputStream")
        let (get_outputStream : t -> NodeJS.WritableStream.t_0) =
          fun (x86 : t) ->
            NodeJS.WritableStream.t_0_of_js
        ...
        let (get_input : t -> NodeJS.ReadableStream.t_0) =
          fun (x87 : t) ->
            NodeJS.ReadableStream.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x87) "input")
        let (get_output : t -> NodeJS.WritableStream.t_0) =
          fun (x88 : t) ->
            NodeJS.WritableStream.t_0_of_js
              (Ojs.get_prop_ascii (t_to_js x88) "output")
        let (get_commands : t -> repl_REPLCommand NodeJS.ReadOnlyDict.t_1) =
          fun (x89 : t) ->
            NodeJS.ReadOnlyDict.t_1_of_js repl_REPLCommand_of_js
        ...
        let (create : unit -> t) =
          fun () ->
            t_of_js
              (Ojs.new_obj
                 (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "repl")
                    "REPLServer") [||])
        let (defineCommand :
          t ->
            keyword:string ->
        ...
        let (setupHistory :
          t ->
            path:string ->
              cb:(err:Error.t_0 or_null -> repl:t -> unit) -> unit)
          =
          fun (x121 : t) ->
            fun ~path:(x116 : string) ->
              fun ~cb:(x117 : err:Error.t_0 or_null -> repl:t -> unit) ->
                ignore
        ...
        let (addListener''''''''' :
          t ->
            event:[ `reset ] -> listener:(context:Context.t_0 -> unit) -> t)
          =
          fun (x155 : t) ->
            fun ~event:(x152 : [ `reset ]) ->
              fun ~listener:(x153 : context:Context.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x155) "addListener"
                     [|((match x152 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x154 : Ojs.t) ->
                            x153 ~context:(Context.t_0_of_js x154)))|])
        ...
        let (on''''''''' :
          ...
          fun (x216 : t) ->
            fun ~event:(x213 : [ `reset ]) ->
              fun ~listener:(x214 : context:Context.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x216) "on"
                     [|((match x213 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x215 : Ojs.t) ->
                            x214 ~context:(Context.t_0_of_js x215)))|])
        let (once :
          t -> event:string -> listener:(args:any list -> unit) -> t) =
          fun (x221 : t) ->
        ...
        let (once''''''''' :
          ...
          fun (x250 : t) ->
            fun ~event:(x247 : [ `reset ]) ->
              fun ~listener:(x248 : context:Context.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x250) "once"
                     [|((match x247 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x249 : Ojs.t) ->
                            x248 ~context:(Context.t_0_of_js x249)))|])
        let (prependListener :
          t -> event:string -> listener:(args:any list -> unit) -> t) =
          fun (x255 : t) ->
        ...
        let (prependOnceListener''''''''' :
          ...
          fun (x318 : t) ->
            fun ~event:(x315 : [ `reset ]) ->
              fun ~listener:(x316 : context:Context.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x318) "prependOnceListener"
                     [|((match x315 with | `reset -> Ojs.string_to_js "reset"));(
                       Ojs.fun_to_js 1
                         (fun (x317 : Ojs.t) ->
                            x316 ~context:(Context.t_0_of_js x317)))|])
        let (cast : t -> Interface.t_0) =
          fun (x319 : t) -> Interface.t_0_of_js (t_to_js x319)
      end
      ...
      fun ?options:(x320 : repl_ReplOptions or_string option) ->
        fun () ->
          repl_REPLServer_of_js
            (let x324 = Ojs.get_prop_ascii Ojs.global "repl" in
    ...
    module Recoverable =
      struct
        ...
        let (get_err : t -> Error.t_0) =
          fun (x327 : t) ->
            Error.t_0_of_js (Ojs.get_prop_ascii (t_to_js x327) "err")
        let (set_err : t -> Error.t_0 -> unit) =
          fun (x328 : t) ->
            fun (x329 : Error.t_0) ->
              Ojs.set_prop_ascii (t_to_js x328) "err" (Error.t_0_to_js x329)
        let (create : err:Error.t_0 -> t) =
          fun ~err:(x330 : Error.t_0) ->
            t_of_js
              (Ojs.new_obj
                 (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "repl")
                    "Recoverable") [|(Error.t_0_to_js x330)|])
        let (cast : t -> SyntaxError.t_0) =
          fun (x331 : t) -> SyntaxError.t_0_of_js (t_to_js x331)
      end
  end
