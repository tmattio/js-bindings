...
module V8 : sig
  ...
  module Serializer : sig
    ...
    val writeRawBytes : t -> buffer:NodeJS.TypedArray.t -> unit
  ...
  module Deserializer : sig
    ...
    val create : data:NodeJS.TypedArray.t -> t [@@js.create]
    ...
    val readRawBytes : t -> length:float -> Buffer.t_0
      [@@js.call "readRawBytes"]
  end
