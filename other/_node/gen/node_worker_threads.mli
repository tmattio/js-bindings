...
module Internal : sig
  ...
  module Types : sig
    ...
    and worker_threads_TransferListItem =
      (ArrayBuffer.t, FileHandle.t_0, worker_threads_MessagePort) union3
...
module Worker_threads : sig
  ...
  module Worker : sig
    ...
    val getHeapSnapshot : t -> Readable.t_0 Promise.t
