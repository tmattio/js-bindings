...
module Http : sig
  ...
  module ClientRequest : sig
    ...
    val addListener'''''
      ...
      -> listener:(socket:Socket.t_0 -> unit)
      -> t
      [@@js.call "addListener"]
  ...
  module Agent : sig
    ...
    val get_freeSockets : t -> Socket.t_0 list NodeJS.ReadOnlyDict.t_1
      [@@js.get "freeSockets"]

    val get_sockets : t -> Socket.t_0 list NodeJS.ReadOnlyDict.t_1
      [@@js.get "sockets"]

    val get_requests : t -> http_IncomingMessage list NodeJS.ReadOnlyDict.t_1
      [@@js.get "requests"]
