    ...
    module Types =
      struct
        ...
        and worker_threads_TransferListItem_of_js :
          ...
          fun (x5 : Ojs.t) ->
            union3_of_js ArrayBuffer.t_of_js FileHandle.t_0_of_js
              worker_threads_MessagePort_of_js x5
        and worker_threads_TransferListItem_to_js :
          worker_threads_TransferListItem -> Ojs.t =
          fun
            (x1 :
              (ArrayBuffer.t, FileHandle.t_0, worker_threads_MessagePort)
                union3)
            ->
            union3_to_js ArrayBuffer.t_to_js FileHandle.t_0_to_js
...
module Node_worker_threads = struct  end
module Worker_threads =
  struct
    let (isMainThread : bool) =
      Ojs.bool_of_js
        (Ojs.get_prop_ascii (Ojs.get_prop_ascii Ojs.global "worker_threads")
           "isMainThread")
    ...
    module MessagePort =
      struct
        ...
        let (addListener'' :
          t ->
            event:[ `messageerror ] ->
              listener:(error:Error.t_0 -> unit) -> t)
          =
          fun (x44 : t) ->
            fun ~event:(x41 : [ `messageerror ]) ->
              fun ~listener:(x42 : error:Error.t_0 -> unit) ->
                t_of_js
                ...
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x55) "emit"
                     [|((match x53 with
                       ...
                       any_to_js x54)|])
        let (emit'' :
          t -> event:[ `messageerror ] -> error:Error.t_0 -> bool) =
          fun (x58 : t) ->
            fun ~event:(x56 : [ `messageerror ]) ->
              fun ~error:(x57 : Error.t_0) ->
                Ojs.bool_of_js
        ...
        let (on'' :
          ...
          fun (x76 : t) ->
            fun ~event:(x73 : [ `messageerror ]) ->
              fun ~listener:(x74 : error:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (once'' :
          ...
          fun (x93 : t) ->
            fun ~event:(x90 : [ `messageerror ]) ->
              fun ~listener:(x91 : error:Error.t_0 -> unit) ->
                t_of_js
        ...
        let (prependListener'' :
          ...
          fun (x110 : t) ->
            fun ~event:(x107 : [ `messageerror ]) ->
              fun ~listener:(x108 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x110) "prependListener"
                     [|((match x107 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x109 : Ojs.t) ->
                            x108 ~error:(Error.t_0_of_js x109)))|])
        let (prependListener''' :
          t ->
            event:symbol or_string -> listener:(args:any list -> unit) -> t)
          =
        ...
        let (prependOnceListener'' :
          ...
          fun (x127 : t) ->
            fun ~event:(x124 : [ `messageerror ]) ->
              fun ~listener:(x125 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x127) "prependOnceListener"
                     [|((match x124 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x126 : Ojs.t) ->
                            x125 ~error:(Error.t_0_of_js x126)))|])
        let (prependOnceListener''' :
          t ->
            event:symbol or_string -> listener:(args:any list -> unit) -> t)
          =
        ...
        let (removeListener'' :
          ...
          fun (x144 : t) ->
            fun ~event:(x141 : [ `messageerror ]) ->
              fun ~listener:(x142 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x144) "removeListener"
                     [|((match x141 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x143 : Ojs.t) ->
                            x142 ~error:(Error.t_0_of_js x143)))|])
        let (removeListener''' :
          t ->
            event:symbol or_string -> listener:(args:any list -> unit) -> t)
          =
        ...
        let (off'' :
          ...
          fun (x161 : t) ->
            fun ~event:(x158 : [ `messageerror ]) ->
              fun ~listener:(x159 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x161) "off"
                     [|((match x158 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x160 : Ojs.t) ->
                            x159 ~error:(Error.t_0_of_js x160)))|])
        let (off''' :
          t ->
            event:symbol or_string -> listener:(args:any list -> unit) -> t)
          =
        ...
        let (cast : t -> EventEmitter.t_0) =
          fun (x168 : t) -> EventEmitter.t_0_of_js (t_to_js x168)
      end
    module WorkerOptions =
      struct
        ...
        let (get_env : t -> (string NodeJS.Dict.t_1, any) union2) =
          fun (x176 : t) ->
            union2_of_js
              (fun (x177 : Ojs.t) ->
                 NodeJS.Dict.t_1_of_js Ojs.string_of_js x177) any_of_js
              (Ojs.get_prop_ascii (t_to_js x176) "env")
        let (set_env : t -> (string NodeJS.Dict.t_1, any) union2 -> unit) =
          fun (x180 : t) ->
            fun (x181 : (string NodeJS.Dict.t_1, any) union2) ->
              Ojs.set_prop_ascii (t_to_js x180) "env"
                (union2_to_js
                   (fun (x182 : string NodeJS.Dict.t_1) ->
                      NodeJS.Dict.t_1_to_js Ojs.string_to_js x182) any_to_js
                   x181)
        let (get_eval : t -> bool) =
          fun (x185 : t) ->
    ...
    module Worker =
      struct
        ...
        let (get_stdout : t -> Readable.t_0) =
          fun (x234 : t) ->
            Readable.t_0_of_js (Ojs.get_prop_ascii (t_to_js x234) "stdout")
        let (get_stderr : t -> Readable.t_0) =
          fun (x235 : t) ->
            Readable.t_0_of_js (Ojs.get_prop_ascii (t_to_js x235) "stderr")
        ...
        let (create :
          ...
          =
          fun ~filename:(x238 : URL.t_0 or_string) ->
            fun ?options:(x239 : worker_threads_WorkerOptions option) ->
              fun () ->
                t_of_js
                  (Ojs.new_obj_arr
                     (Ojs.get_prop_ascii
                        (Ojs.get_prop_ascii Ojs.global "worker_threads")
                        "Worker")
                     (let x240 =
                      ...
                      ignore
                        (Ojs.call x240 "push"
                           [|(or_string_to_js URL.t_0_to_js x238)|]);
                      (match x239 with
                       | Some x241 ->
                           ignore
                             (Ojs.call x240 "push"
        ...
        let (addListener''' :
          ...
          fun (x271 : t) ->
            fun ~event:(x268 : [ `messageerror ]) ->
              fun ~listener:(x269 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x271) "addListener"
                     [|((match x268 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x270 : Ojs.t) ->
                            x269 ~error:(Error.t_0_of_js x270)))|])
        let (addListener'''' :
        ...
        let (emit''' :
          ...
          fun (x292 : t) ->
            fun ~event:(x290 : [ `messageerror ]) ->
              fun ~error:(x291 : Error.t_0) ->
                Ojs.bool_of_js
                  (Ojs.call (t_to_js x292) "emit"
                     [|((match x290 with
                         | `messageerror -> Ojs.string_to_js "messageerror"));(
                       Error.t_0_to_js x291)|])
        ...
        let (on''' :
          ...
          fun (x317 : t) ->
            fun ~event:(x314 : [ `messageerror ]) ->
              fun ~listener:(x315 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x317) "on"
                     [|((match x314 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x316 : Ojs.t) ->
                            x315 ~error:(Error.t_0_of_js x316)))|])
        ...
        let (once''' :
          ...
          fun (x342 : t) ->
            fun ~event:(x339 : [ `messageerror ]) ->
              fun ~listener:(x340 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x342) "once"
                     [|((match x339 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x341 : Ojs.t) ->
                            x340 ~error:(Error.t_0_of_js x341)))|])
        let (once'''' :
          t -> event:[ `online ] -> listener:(unit -> unit) -> t) =
          fun (x345 : t) ->
        ...
        let (prependListener''' :
          ...
          fun (x367 : t) ->
            fun ~event:(x364 : [ `messageerror ]) ->
              fun ~listener:(x365 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x367) "prependListener"
                     [|((match x364 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x366 : Ojs.t) ->
                            x365 ~error:(Error.t_0_of_js x366)))|])
        let (prependListener'''' :
          t -> event:[ `online ] -> listener:(unit -> unit) -> t) =
          fun (x370 : t) ->
        ...
        let (prependOnceListener''' :
          ...
          fun (x392 : t) ->
            fun ~event:(x389 : [ `messageerror ]) ->
              fun ~listener:(x390 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x392) "prependOnceListener"
                     [|((match x389 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x391 : Ojs.t) ->
                            x390 ~error:(Error.t_0_of_js x391)))|])
        let (prependOnceListener'''' :
          t -> event:[ `online ] -> listener:(unit -> unit) -> t) =
          fun (x395 : t) ->
        ...
        let (removeListener''' :
          ...
          fun (x417 : t) ->
            fun ~event:(x414 : [ `messageerror ]) ->
              fun ~listener:(x415 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x417) "removeListener"
                     [|((match x414 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x416 : Ojs.t) ->
                            x415 ~error:(Error.t_0_of_js x416)))|])
        let (removeListener'''' :
          t -> event:[ `online ] -> listener:(unit -> unit) -> t) =
          fun (x420 : t) ->
        ...
        let (off''' :
          ...
          fun (x442 : t) ->
            fun ~event:(x439 : [ `messageerror ]) ->
              fun ~listener:(x440 : error:Error.t_0 -> unit) ->
                t_of_js
                  (Ojs.call (t_to_js x442) "off"
                     [|((match x439 with
                       ...
                       Ojs.fun_to_js 1
                         (fun (x441 : Ojs.t) ->
                            x440 ~error:(Error.t_0_of_js x441)))|])
        let (off'''' :
          t -> event:[ `online ] -> listener:(unit -> unit) -> t) =
          fun (x445 : t) ->
                                                              ...
                                                              (fun (x449 : _)
                                                                 ...
                                                                 x448
                                                                   ...
                                                                   Ojs.list_of_js_from
                                                                    ...
                                                                    x449 0)))|])
        let (cast : t -> EventEmitter.t_0) =
          fun (x452 : t) -> EventEmitter.t_0_of_js (t_to_js x452)
      end
    let (markAsUntransferable : object_:untyped_object -> unit) =
      fun ~object_:(x453 : untyped_object) ->
        ignore
          (Ojs.call (Ojs.get_prop_ascii Ojs.global "worker_threads")
             "markAsUntransferable" [|(untyped_object_to_js x453)|])
    let (moveMessagePortToContext :
      port:worker_threads_MessagePort ->
        context:Context.t_0 -> worker_threads_MessagePort)
      =
      fun ~port:(x454 : worker_threads_MessagePort) ->
        fun ~context:(x455 : Context.t_0) ->
          worker_threads_MessagePort_of_js
            (Ojs.call (Ojs.get_prop_ascii Ojs.global "worker_threads")
               "moveMessagePortToContext"
               [|(worker_threads_MessagePort_to_js x454);(Context.t_0_to_js
                                                            x455)|])
