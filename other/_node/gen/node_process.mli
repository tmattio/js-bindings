  ...
  module Global : sig
    ...
    module NodeJS : sig
      ...
      module Socket : sig
        ...
        val set_isTTY : t -> ([ `L_b_true ][@js.enum]) -> unit
          [@@js.set "isTTY"]
      ...
      module ProcessReport : sig
        ...
        val getReport : t -> ?err:Error.t_0 -> unit -> string
          [@@js.call "getReport"]
        ...
        val writeReport' : t -> ?error:Error.t_0 -> unit -> string
          [@@js.call "writeReport"]
      ...
      module ResourceUsage : sig
        ...
        val set_sharedMemorySize : t -> float -> unit
          [@@js.set "sharedMemorySize"]
        ...
        val set_unsharedDataSize : t -> float -> unit
          [@@js.set "unsharedDataSize"]
      ...
      module Process : sig
        ...
        val get_stdin
          :  t
          -> ( process_global_NodeJS_ReadStream
             , anonymous_interface_3 )
             intersection2
          [@@js.get "stdin"]
        ...
        val openStdin : t -> process_global_NodeJS_Socket
          [@@js.call "openStdin"]
        ...
        val set_env : t -> process_global_NodeJS_ProcessEnv -> unit
          [@@js.set "env"]
        ...
        val get_platform : t -> process_global_NodeJS_Platform
          [@@js.get "platform"]
        ...
        val set_features : t -> anonymous_interface_6 -> unit
          [@@js.set "features"]
        ...
        val get_allowedNodeEnvironmentFlags : t -> string ReadonlySet.t_1
          [@@js.get "allowedNodeEnvironmentFlags"]

        val set_allowedNodeEnvironmentFlags
          :  t
          -> string ReadonlySet.t_1
          -> unit
        ...
        val set_traceDeprecation : t -> bool -> unit
          [@@js.set "traceDeprecation"]
