...
module Url : sig
  ...
  module UrlObject : sig
    ...
    val get_query : t -> ParsedUrlQueryInput.t_0 or_string or_null
      [@@js.get "query"]

    val set_query : t -> ParsedUrlQueryInput.t_0 or_string or_null -> unit
      [@@js.set "query"]
  end
  [@@js.scope "UrlObject"]
  ...
  module Url : sig
    ...
    val set_query : t -> ParsedUrlQuery.t_0 or_string or_null -> unit
      [@@js.set "query"]
  end
  [@@js.scope "Url"]
  ...
  module URLSearchParams : sig
    ...
    val create
      :  ?init:
           ...
           , string list or_string NodeJS.Dict.t_1
           , (string * string) list )
           union4
           or_string
      -> unit
